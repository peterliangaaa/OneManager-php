! function(e, t) {
	...
	function p(e) {
		var t = !!e && "length" in e && e.length,
			n = Ue.type(e);
		return "function" !== n && !Ue.isWindow(e) && ("array" === n || 0 === t || "number" == typeof t && 0 < t && t - 1 in
			e)
	}
	...
	function O(t, n, o, a) {
		var i;
		try {
			t && Ue.isFunction(i = t.promise) ? i.call(t).done(n).fail(o) : t && Ue.isFunction(i = t.then) ? i.call(t, n, o) :
	...
	function _(t, n, a, o) {
		...
		return a && (p = +p || +d || 0, u = a[1] ? p + (a[1] + 1) * a[2] : +a[2], o && (o.unit = i, o.start = p, o.end = u)),
			u
	}
	...
	function ne(t) {
		var n = t.ownerDocument,
			...
			o = J[a],
			i;
		return o ? o : (i = n.body.appendChild(n.createElement(a)), o = Ue.css(i, "display"), i.parentNode.removeChild(i),
			"none" === o && (o = "block"), J[a] = o, o)
	}

	function ae(t, n) {
		for (var a = [], e = 0, o = t.length, i, s; e < o; e++) s = t[e], s.style && (i = s.style.display, n ? ("none" ===
			i && (a[e] = z.get(s, "display") || null, a[e] || (s.style.display = "")), "" === s.style.display && G(s) && (a[e] =
				ne(s))) : "none" !== i && (a[e] = "none", z.set(s, "display", i)));
	...
	function oe(e, t) {
		var n;
		return n = "undefined" == typeof e.getElementsByTagName ? "undefined" == typeof e.querySelectorAll ? [] : e.querySelectorAll(
			t || "*") : e.getElementsByTagName(t || "*"), void 0 === t || t && w(e, t) ? Ue.merge([e], n) : n
	}
	...
	function se(t, a, s, r, d) {
		for (var e = a.createDocumentFragment(), l = [], c = 0, p = t.length, o, u, m, b, y, v; c < p; c++)
			...
			for (u = u || e.appendChild(a.createElement("div")), m = (Ke.exec(o) || ["", ""])[1].toLowerCase(), b = Ge[m] || Ge
				._default, u.innerHTML = b[1] + Ue.htmlPrefilter(o) + b[2], v = b[0]; v--;) u = u.lastChild;
	...
	function ce(t, n, a, o, i, s) {
		...
		if (null == o && null == i ? (i = a, o = a = void 0) : null == i && ("string" == typeof a ? (i = o, o = void 0) : (i =
				o, o = a, a = void 0)), !1 === i) i = le;
		else if (!i) return t;
	...
	function he(t, a, o, r) {
		...
		if (c && (s = se(a, t[0].ownerDocument, !1, t, r), g = s.firstChild, 1 === s.childNodes.length && (s = g), g || r)) {
			for (m = Ue.map(oe(s, "script"), ue), y = m.length; d < c; d++) v = s, d != c - 1 && (v = Ue.clone(v, !0, !0), y &&
				Ue.merge(m, oe(v, "script"))), o.call(t[d], v, d);
			if (y)
				for (x = m[m.length - 1].ownerDocument, Ue.map(m, ge), d = 0; d < y; d++) v = m[d], Qe.test(v.type || "") && !z.access(
					v, "globalEval") && Ue.contains(x, v) && (v.src ? Ue._evalUrl && Ue._evalUrl(v.src) : b(v.textContent.replace(rt,
					""), x))
		}
		return t
	}
	...
	function be(t, n, a) {
		for (var o = n ? Ue.filter(n, t) : t, e = 0, i; null != (i = o[e]); e++) a || 1 !== i.nodeType || Ue.cleanData(oe(i)),
			i.parentNode && (a && Ue.contains(i.ownerDocument, i) && ie(oe(i, "script")), i.parentNode.removeChild(i));
		return t
	}
	...
	function ye(t, a, o) {
		var i = t.style,
			s, r, l, p;
		return o = o || ct(t), o && (p = o.getPropertyValue(a) || o[a], "" !== p || Ue.contains(t.ownerDocument, t) || (p =
				Ue.style(t, a)), !n.pixelMarginRight() && dt.test(p) && lt.test(a) && (s = i.width, r = i.minWidth, l = i.maxWidth,
				i.minWidth = i.maxWidth = i.width = p, p = o.width, i.width = s, i.minWidth = r, i.maxWidth = l)), void 0 === p ?
			p : p + ""
	}
	...
	function Ce(t, n, a, o, i) {
		var e = 0,
			s;
		for (s = a === (o ? "border" : "content") ? 4 : "width" === n ? 1 : 0; 4 > s; s += 2) "margin" === a && (e += Ue.css(
			t, a + Q[s], !0, i)), o ? ("content" === a && (e -= Ue.css(t, "padding" + Q[s], !0, i)), "margin" !== a && (e -=
			Ue.css(t, "border" + Q[s] + "Width", !0, i))) : (e += Ue.css(t, "padding" + Q[s], !0, i), "padding" !== a && (e +=
			Ue.css(t, "border" + Q[s] + "Width", !0, i)));
		return e
	}
	...
	function Te(t, a, o) {
		var i = ct(t),
			...
			r;
		return dt.test(e) ? e : (r = s && (n.boxSizingReliable() || e === t.style[a]), "auto" === e && (e = t["offset" + a[0]
			.toUpperCase() + a.slice(1)]), e = parseFloat(e) || 0, e + Ce(t, a, o || (s ? "border" : "content"), r, i) + "px")
	}
	...
	function Se() {
		xt && (!1 === Fe.hidden && ee.requestAnimationFrame ? ee.requestAnimationFrame(Se) : ee.setTimeout(Se, Ue.fx.interval),
			Ue.fx.tick())
	}
	...
	function De(t, a, s) {
		var r = "width" in a || "height" in a,
			...
			u = z.get(t, "fxshow"),
			m, b, y, v, x, _, w, C;
		for (m in s.queue || (v = Ue._queueHooks(t, "fx"), null == v.unqueued && (v.unqueued = 0, x = v.empty.fire, v.empty.fire =
				function() {
					v.unqueued || x()
			...
			for (m in r && 1 === t.nodeType && (s.overflow = [n.overflow, n.overflowX, n.overflowY], w = u && u.display, null ==
					w && (w = z.get(t, "display")), C = Ue.css(t, "display"), "none" === C && (w ? C = w : (ae([t], !0), w = t.style.display ||
						w, C = Ue.css(t, "display"), ae([t]))), ("inline" === C || "inline-block" === C && null != w) && "none" === Ue.css(
						t, "float") && (_ || (l.done(function() {
						n.display = w
					}), null == w && (C = n.display, w = "none" === C ? "" : C)), n.display = "inline-block")), s.overflow && (n.overflow =
	...
	function Le(t, n) {
		var a, o, i, s, r;
		for (a in t)
			if (o = Ue.camelCase(a), i = n[o], s = t[a], Array.isArray(s) && (i = s[1], s = t[a] = s[0]), a !== o && (t[o] = s,
					delete t[a]), r = Ue.cssHooks[o], r && "expand" in r)
	...
	function Pe(t, n, a) {
		var o = 0,
			...
			l = function() {
				if (u) return !1;
				for (var e = vt || ke(), n = Math.max(0, p.startTime + p.duration - e), a = n / p.duration || 0, o = 1 - a, s = 0,
						l = p.tweens.length; s < l; s++) p.tweens[s].run(o);
		...
		for (Le(i, p.opts.specialEasing); o < s; o++)
			if (c = Pe.prefilters[o].call(p, t, i, p.opts)) return Ue.isFunction(c.stop) && (Ue._queueHooks(p.elem, p.opts.queue)
				.stop = Ue.proxy(c.stop, c)), c;
		return Ue.map(i, Ie, p), Ue.isFunction(p.opts.start) && p.opts.start.call(t, p), p.progress(p.opts.progress).done(p.opts
			.done, p.opts.complete).fail(p.opts.fail).always(p.opts.always), Ue.fx.timer(Ue.extend(l, {
			elem: t,
			anim: p,
			queue: p.opts.queue
		})), p
	...
	function $e(t) {
		return function(n, a) {
			...
			var o = 0,
				...
				s;
			if (Ue.isFunction(a))
				for (; s = i[o++];) "+" === s[0] ? (s = s.slice(1) || "*", (t[s] = t[s] || []).unshift(a)) : (t[s] = t[s] || []).push(
					a)
		}
	}
	...
	function ze(t, n, a, o) {
		...
		for (d = r.shift(); d;)
			if (t.responseFields[d] && (a[t.responseFields[d]] = n), !u && o && t.dataFilter && (n = t.dataFilter(n, t.dataType)),
				u = d, d = r.shift())
				if ("*" === d) d = u;
				else if ("*" !== u && u !== d) {
			if (c = s[u + " " + d] || s["* " + d], !c)
	...
	Ue.fn = Ue.prototype = {
		...
		var t = arguments[0] || {},
			...
			i = !1,
			s, r, l, p, u, m;
		for ("boolean" == typeof t && (i = t, t = arguments[n] || {}, n++), "object" == typeof t || Ue.isFunction(t) || (t = {}),
			n === o && (t = this, n--); n < o; n++)
			if (null != (s = arguments[n]))
				for (r in s) l = t[r], p = s[r], t !== p && (i && p && (Ue.isPlainObject(p) || (u = Array.isArray(p))) ? (u ? (u = !
						1, m = l && Array.isArray(l) ? l : []) : m = l && Ue.isPlainObject(l) ? l : {}, t[r] = Ue.extend(i, m, p)) :
					void 0 !== p && (t[r] = p));
		return t
	}, Ue.extend({
		...
		isPlainObject: function(e) {
			var t, n;
			return e && "[object Object]" === g.call(e) && (!(t = d(e)) || (n = Xe.call(t, "constructor") && t.constructor,
				"function" == typeof n && l.call(n) === f))
		},
		...
		proxy: function(t, n) {
			var o, i, s;
			if ("string" == typeof n && (o = t[n], n = t, t = o), Ue.isFunction(t)) return i = Be.call(arguments, 2), s =
				function() {
		...
		now: Date.now,
		support: n
	}), "function" == typeof Symbol && (Ue.fn[Symbol.iterator] = Me[Symbol.iterator]), Ue.each(["Boolean", "Number",
		"String", "Function", "Array", "Date", "RegExp", "Object", "Error", "Symbol"
	], function(e, t) {
	...
	var u = function(L) {
			...
			if (!i && ((n ? n.ownerDocument || n : u) !== We && He(n), n = n || We, ze)) {
				if (11 !== c && (v = Y.exec(t)))
					if (!(p = v[1])) {
						...
						if ((p = v[3]) && ke.getElementsByClassName && n.getElementsByClassName) return F.apply(a, n.getElementsByClassName(
							p)), a
					} else if (9 === c) {
				...
				if (ke.qsa && !z[t + " "] && (!Me || !Me.test(t))) {
					if (1 !== c) e = n, _ = t;
						...
						for ((y = n.getAttribute("id")) ? y = y.replace(we, Ce) : n.setAttribute("id", y = me), x = Le(t), g = x.length; g--;)
							x[g] = "#" + y + " " + re(x[g]);
		...
		function ae(e) {
			return function(t) {
				return "form" in t ? t.parentNode && !1 === t.disabled ? "label" in t ? "label" in t.parentNode ? t.parentNode.disabled ===
					e : t.disabled === e : t.isDisabled === e || t.isDisabled !== !e && Ee(t) === e : t.disabled === e : "label" in
					t && t.disabled === e
			}
		}
		...
		function le(t, n, a) {
			...
			return n.first ? function(n, a, i) {
				...
				if (c) {
					...
					for (; n = n[o];)
						if (1 === n.nodeType || r)
							if (g = n[me] || (n[me] = {}), u = g[n.uniqueID] || (g[n.uniqueID] = {}), s && s === n.nodeName.toLowerCase())
								n = n[o] || n;
							else {
		...
		function pe(t, n, a, o, s) {
			for (var e = [], r = 0, l = t.length, i; r < l; r++)(i = t[r]) && (a && !a(i, o, s) || (e.push(i), null != n && n.push(
				r)));
			return e
		}
		...
		var me = "sizzle" + 1 * new Date,
			...
			_ = function(e, t, n) {
				var a = "0x" + t - 65536;
				return a != a || n ? t : 0 > a ? String.fromCharCode(a + 65536) : String.fromCharCode(55296 | a >> 10, 56320 |
					1023 & a)
			},
		...
		for (Se in ke = N.support = {}, De = N.isXML = function(e) {
				...
				var n = t ? t.ownerDocument || t : u,
					a, o;
				return n !== We && 9 === n.nodeType && n.documentElement ? (We = n, Re = We.documentElement, ze = !De(We), u !==
					We && (o = We.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", Te, !1) : o.attachEvent &&
						o.attachEvent("onunload", Te)), ke.attributes = K(function(e) {
						...
						return "undefined" == typeof t.getElementsByTagName ? ke.qsa ? t.querySelectorAll(e) : void 0 : t.getElementsByTagName(
							e)
					} : function(t, n) {
						var a = [],
							o = 0,
						...
						Re.appendChild(e).innerHTML = "<a id='" + me + "'></a><select id='" + me +
							"-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll(
								"[msallowcapture^='']").length && Me.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")"), e.querySelectorAll(
								"[selected]").length || Me.push(
								"\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)"
							), e.querySelectorAll("[id~=" + me + "-]").length || Me.push("~="), e.querySelectorAll(":checked").length ||
							Me.push(":checked"), e.querySelectorAll("a#" + me + "+*").length || Me.push(".#.+[+~]")
					}), K(function(e) {
						...
						t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]")
							.length && Me.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && Me
							.push(":enabled", ":disabled"), Re.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length &&
							Me.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), Me.push(",.*:")
					})), (ke.matchesSelector = X.test(Be = Re.matches || Re.webkitMatchesSelector || Re.mozMatchesSelector || Re.oMatchesSelector ||
						Re.msMatchesSelector)) && K(function(e) {
						ke.disconnectedMatch = Be.call(e, "*"), Be.call(e, "[s!='']:x"), Fe.push("!=",
							":((?:\\\\.|[\\w-]|[^\0-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\0-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\0-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)"
						)
					}), Me = Me.length && new RegExp(Me.join("|")), Fe = Fe.length && new RegExp(Fe.join("|")), a = X.test(Re.compareDocumentPosition),
					qe = a || X.test(Re.contains) ? function(e, t) {
						var n = 9 === e.nodeType ? e.documentElement : e,
							a = t && t.parentNode;
						return e === a || a && 1 === a.nodeType && (n.contains ? n.contains(a) : e.compareDocumentPosition && 16 & e.compareDocumentPosition(
							a))
					} : function(e, t) {
						if (t)
							for (; t = t.parentNode;)
						...
						return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 &
							n || !ke.sortDetached && t.compareDocumentPosition(e) === n ? e === We || e.ownerDocument === u && qe(u, e) ?
							-1 : t === We || t.ownerDocument === u && qe(u, t) ? 1 : je ? H(je, e) - H(je, t) : 0 : 4 & n ? -1 : 1)
					} : function(t, n) {
						if (t === n) return $e = !0, 0;
						var a = 0,
							o = t.parentNode,
				...
				if ((e.ownerDocument || e) !== We && He(e), t = t.replace(R, "='$1']"), ke.matchesSelector && ze && !z[t + " "] &&
					(!Fe || !Fe.test(t)) && (!Me || !Me.test(t))) try {
					var n = Be.call(e, t);
				...
				return void 0 === e ? ke.attributes || !ze ? t.getAttribute(n) : (e = t.getAttributeNode(n)) && e.specified ? e.value :
					null : e
			}, N.escape = function(e) {
				...
				preFilter: {
					ATTR: function(e) {
						return e[1] = e[1].replace(_e, _), e[3] = (e[3] || e[4] || e[5] || "").replace(_e, _), "~=" === e[2] && (e[3] =
							" " + e[3] + " "), e.slice(0, 4)
					},
					CHILD: function(e) {
						return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || N.error(e[0]), e[4] = +(e[4] ? e[5] +
								(e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && N
							.error(e[0]), e
					},
					PSEUDO: function(e) {
						var t = !e[6] && e[2],
							n;
						return U.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : t && S.test(t) && (n = Le(t, !0)) && (n =
							t.indexOf(")", t.length - n) - t.length) && (e[0] = e[0].slice(0, n), e[2] = t.slice(0, n)), e.slice(0, 3))
					}
				},
				filter: {
					TAG: function(e) {
					...
					ATTR: function(t, n, a) {
						return function(o) {
							var i = N.attr(o, t);
							return null == i ? "!=" === n : !n || (i += "", "=" === n ? i === a : "!=" === n ? i !== a : "^=" === n ? a &&
								0 === i.indexOf(a) : "*=" === n ? a && -1 < i.indexOf(a) : "$=" === n ? a && i.slice(-a.length) === a :
								"~=" === n ? -1 < (" " + i.replace(I, " ") + " ").indexOf(a) : "|=" == n && (i === a || i.slice(0, a.length +
									1) === a + "-"))
						}
					},
						...
						return 1 === a && 0 === d ? function(e) {
							...
							if (y) {
								...
								if (E = [u ? y.firstChild : y.lastChild], u && r) {
									for (C = y, w = C[me] || (C[me] = {}), _ = w[C.uniqueID] || (w[C.uniqueID] = {}), x = _[i] || [], T = x[0] ===
										he && x[1], s = T && x[2], C = T && y.childNodes[T]; C = ++T && C && C[b] || (s = T = 0) || E.pop();)
										if (1 === C.nodeType && ++s && C === f) {
											_[i] = [he, T, s];
											break
										}
								} else if (r && (C = f, w = C[me] || (C[me] = {}), _ = w[C.uniqueID] || (w[C.uniqueID] = {}), x = _[i] || [],
										T = x[0] === he && x[1], s = T), !1 === s)
									for (;
										(C = ++T && C && C[b] || (s = T = 0) || E.pop()) && !((g ? C.nodeName.toLowerCase() === v : 1 === C.nodeType) &&
											++s && (r && (w = C[me] || (C[me] = {}), _ = w[C.uniqueID] || (w[C.uniqueID] = {}), _[i] = [he, s]), C ===
												f)););
					...
					PSEUDO: function(t, n) {
						var o = Ae.pseudos[t] || Ae.setFilters[t.toLowerCase()] || N.error("unsupported pseudo: " + t),
							e;
						return o[me] ? o(n) : 1 < o.length ? (e = [t, t, "", n], Ae.setFilters.hasOwnProperty(t.toLowerCase()) ? M(
							function(e, t) {
					...
					lang: M(function(e) {
						return T.test(e || "") || N.error("unsupported lang: " + e), e = e.replace(_e, _).toLowerCase(),
							function(t) {
								var n;
								do
									if (n = ze ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return n = n.toLowerCase(), n ===
		...
		return se.prototype = Ae.filters = Ae.pseudos, Ae.setFilters = new se, Le = N.tokenize = function(t, n) {
			...
			for (d = t, p = [], u = Ae.preFilter; d;) {
				for (l in o && !(s = P.exec(d)) || (s && (d = d.slice(s[0].length) || d), p.push(r = [])), o = !1, (s = Q.exec(d)) &&
					(o = s.shift(), r.push({
						value: o,
						type: s[0].replace(O, " ")
			...
			var d = "function" == typeof t && t,
				...
				n, u, g, m, h;
			if (s = s || [], 1 === p.length) {
				if (u = p[0] = p[0].slice(0), 2 < u.length && "ID" === (g = u[0]).type && 9 === o.nodeType && ze && Ae.relative[
						u[1].type]) {
		...
		}, ke.sortStable = me.split("").sort(A).join("") === me, ke.detectDuplicates = !!$e, He(), ke.sortDetached = K(
			function(e) {
	...
	Ue.find = u, Ue.expr = u.selectors, Ue.expr[":"] = Ue.expr.pseudos, Ue.uniqueSort = Ue.unique = u.uniqueSort, Ue.text =
		u.getText, Ue.isXMLDoc = u.isXML, Ue.contains = u.contains, Ue.escapeSelector = u.escape;
	...
	Ue.filter = function(e, t, n) {
		var o = t[0];
		return n && (e = ":not(" + e + ")"), 1 === t.length && 1 === o.nodeType ? Ue.find.matchesSelector(o, e) ? [o] : [] :
	...
	var C = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
		k = Ue.fn.init = function(t, n, a) {
			...
			if (a = a || A, "string" == typeof t) {
				if (o = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : C.exec(t), !o || !o[1] && n)
					return !n || n.jquery ? (n || a).find(t) : this.constructor(n).find(t);
				if (o[1]) {
					if (n = n instanceof Ue ? n[0] : n, Ue.merge(this, Ue.parseHTML(o[1], n && n.nodeType ? n.ownerDocument || n : Fe,
							!0)), v.test(o[1]) && Ue.isPlainObject(n))
						for (o in n) Ue.isFunction(this[o]) ? this[o](n[o]) : this.attr(o, n[o]);
					return this
				}
				return i = Fe.getElementById(o[2]), i && (this[0] = i, this.length = 1), this
			}
			return t.nodeType ? (this[0] = t, this.length = 1, this) : Ue.isFunction(t) ? void 0 === a.ready ? t(Ue) : a.ready(
				t) : Ue.makeArray(t, this)
		},
		A;
	...
	Ue.fn.extend({
		...
		index: function(t) {
			return t ? "string" == typeof t ? e.call(Ue(t), this[0]) : e.call(this, t.jquery ? t[0] : t) : this[0] && this[0]
		...
		Ue.fn[t] = function(a, o) {
			...
			return "Until" !== t.slice(-5) && (o = a), o && "string" == typeof o && (i = Ue.filter(o, i)), 1 < this.length &&
				(I[t] || Ue.uniqueSort(i), D.test(t) && i.reverse()), this.pushStack(i)
		}
	});
	var H = /[^\x20\t\r\n\f]+/g;
	Ue.Callbacks = function(t) {
				...
				o = {
						...
						return Ue.Deferred(function(o) {
							Ue.each(n, function(n, s) {
								...
								i[s[1]](function() {
									...
									e && Ue.isFunction(e.promise) ? e.promise().progress(o.notify).done(o.resolve).fail(o.reject) : o[s[
										0] + "With"](this, r ? [e] : arguments)
								})
							}), t = null
						}).promise()
					},
					then: function(t, o, i) {
								...
								var e = this,
									...
									a = function() {
										...
										if (!(t < r)) {
											...
											c = i && ("object" == typeof i || "function" == typeof i) && i.then, Ue.isFunction(c) ? l ? c.call(i,
													s(r, n, M, l), s(r, n, N, l)) : (r++, c.call(i, s(r, n, M, l), s(r, n, N, l), s(r, n, M, n.notifyWith))) :
												(o !== M && (e = void 0, d = [i]), (l || n.resolveWith)(e, d))
										}
									},
									c = l ? a : function() {
										try {
											...
											Ue.Deferred.exceptionHook && Ue.Deferred.exceptionHook(i, c.stackTrace), t + 1 >= r && (o !== N && (e =
												void 0, d = [i]), n.rejectWith(e, d))
										}
									};
						...
						return Ue.Deferred(function(e) {
							n[0][3].add(s(0, e, Ue.isFunction(i) ? i : M, e.notifyWith)), n[1][3].add(s(0, e, Ue.isFunction(t) ? t :
								M)), n[2][3].add(s(0, e, Ue.isFunction(o) ? o : N))
						}).promise()
					},
					promise: function(e) {
		...
		when: function(t) {
			...
			if (1 >= n && (O(t, e.done(s(a)).resolve, e.reject, !n), "pending" === e.state() || Ue.isFunction(i[a] && i[a].then)))
				return e.then();
	...
	Ue.Deferred.exceptionHook = function(e, t) {
		ee.console && ee.console.warn && e && L.test(e.name) && ee.console.warn("jQuery.Deferred exception: " + e.message,
			e.stack, t)
	...
	Ue.fn.ready = function(e) {
			...
			readyWait: 1,
			ready: function(e) {
				(!0 === e ? --Ue.readyWait : Ue.isReady) || (Ue.isReady = !0, !0 !== e && 0 < --Ue.readyWait || j.resolveWith(Fe,
					[Ue]))
			}
		}), Ue.ready.then = j.then, "complete" !== Fe.readyState && ("loading" === Fe.readyState || Fe.documentElement.doScroll) ?
		(Fe.addEventListener("DOMContentLoaded", P), ee.addEventListener("load", P)) : ee.setTimeout(Ue.ready);
	var R = function(t, n, a, o, s, r, l) {
			...
			else if (void 0 !== o && (s = !0, Ue.isFunction(o) || (l = !0), i && (l ? (n.call(t, o), n = null) : (i = n, n =
					function(e, t, n) {
	...
	S.uid = 1, S.prototype = {
		...
		remove: function(e, t) {
			...
			if (void 0 !== n) {
				if (void 0 !== t)
					for (Array.isArray(t) ? t = t.map(Ue.camelCase) : (t = Ue.camelCase(t), t = (t in n) ? [t] : t.match(H) || []),
						a = t.length; a--;) delete n[t[a]];
	...
	Ue.extend({
		...
		data: function(t, n) {
			...
			if (void 0 === t) {
				if (this.length && (r = W.get(a), 1 === a.nodeType && !z.get(a, "hasDataAttrs"))) {
					for (i = o.length; i--;) o[i] && (s = o[i].name, 0 === s.indexOf("data-") && (s = Ue.camelCase(s.slice(5)), te(
						a, s, r[s])));
		...
		queue: function(e, t, n) {
			var a;
			if (e) return t = (t || "fx") + "queue", a = z.get(e, t), n && (!a || Array.isArray(n) ? a = z.access(e, t, Ue.makeArray(
				n)) : a.push(n)), a || []
		},
		dequeue: function(t, n) {
			...
			"inprogress" === i && (i = a.shift(), o--), i && ("fx" === n && a.unshift("inprogress"), delete s.stop, i.call(t,
				r, s)), !o && s && s.empty.fire()
		},
		...
		queue: function(e, t) {
			var n = 2;
			return "string" != typeof e && (t = e, e = "fx", n--), arguments.length < n ? Ue.queue(this[0], e) : void 0 ===
		...
		promise: function(t, n) {
			var o = 1,
				...
				l;
			for ("string" != typeof t && (n = t, t = void 0), t = t || "fx"; s--;) l = z.get(e[s], t + "queueHooks"), l && l
				.empty && (o++, l.empty.add(r));
	...
	var X = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		G = function(e, t) {
			return e = t || e, "none" === e.style.display || "" === e.style.display && Ue.contains(e.ownerDocument, e) &&
	...
	! function() {
		...
		a.setAttribute("type", "radio"), a.setAttribute("checked", "checked"), a.setAttribute("name", "t"), t.appendChild(a),
			n.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = "<textarea>x</textarea>", n.noCloneChecked = !
	...
	Ue.event = {
		...
		add: function(t, a, s, r, d) {
			...
			if (u)
				for (s.handler && (y = s, s = y.handler, d = y.selector), d && Ue.find.matchesSelector(Je, d), s.guid || (s.guid =
						Ue.guid++), (_ = u.events) || (_ = u.events = {}), (v = u.handle) || (v = u.handle = function(e) {
						return "undefined" != typeof Ue && Ue.event.triggered !== e.type ? Ue.event.dispatch.apply(t, arguments) :
							void 0
					}), a = (a || "").match(H) || [""], w = a.length; w--;) x = nt.exec(a[w]) || [], S = I = x[1], A = (x[2] || "")
					.split(".").sort(), S && (T = Ue.event.special[S] || {}, S = (d ? T.delegateType : T.bindType) || S, T = Ue.event
						.special[S] || {}, C = Ue.extend({
							type: S,
							origType: I,
							data: r,
							handler: s,
							...
							namespace: A.join(".")
						}, y), (E = _[S]) || (E = _[S] = [], E.delegateCount = 0, T.setup && !1 !== T.setup.call(t, r, A, v) || t.addEventListener &&
							t.addEventListener(S, v)), T.add && (T.add.call(t, C), C.handler.guid || (C.handler.guid = s.guid)), d ? E.splice(
							E.delegateCount++, 0, C) : E.push(C), Ue.event.global[S] = !0)
		},
			...
			if (e && (v = e.events)) {
				for (a = (a || "").match(H) || [""], x = a.length; x--;)
					if (y = nt.exec(a[x]) || [], T = S = y[1], E = (y[2] || "").split(".").sort(), T) {
						for (w = Ue.event.special[T] || {}, T = (r ? w.delegateType : w.bindType) || T, C = v[T] || [], y = y[2] &&
							new RegExp("(^|\\.)" + E.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = c = C.length; c--;) _ = C[c], !d && S !== _.origType ||
							s && s.guid !== _.guid || y && !y.test(_.namespace) || r && r !== _.selector && ("**" !== r || !_.selector) ||
							(C.splice(c, 1), _.selector && C.delegateCount--, w.remove && w.remove.call(t, _));
						u && !C.length && (w.teardown && !1 !== w.teardown.call(t, E, e.handle) || Ue.removeEvent(t, T, e.handle),
							delete v[T])
					} else
			...
			if (n.delegateTarget = this, !i.preDispatch || !1 !== i.preDispatch.call(this, n)) {
				for (m = Ue.event.handlers.call(this, n, o), s = 0;
					...
					for (n.currentTarget = p.elem, r = 0;
						(u = p.handlers[r++]) && !n.isImmediatePropagationStopped();) n.rnamespace && !n.rnamespace.test(u.namespace) ||
						(n.handleObj = u, n.data = u.data, l = ((Ue.event.special[u.origType] || {}).handle || u.handler).apply(p.elem,
							a), void 0 !== l && !1 === (n.result = l) && (n.preventDefault(), n.stopPropagation()));
			...
			if (o && i.nodeType && !("click" === t.type && 1 <= t.button))
				for (; i !== this; i = i.parentNode || this)
					if (1 === i.nodeType && ("click" !== t.type || !0 !== i.disabled)) {
						for (p = [], u = {}, s = 0; s < o; s++) r = n[s], l = r.selector + " ", void 0 === u[l] && (u[l] = r.needsContext ?
							-1 < Ue(l, this).index(i) : Ue.find(l, this, null, [i]).length), u[l] && p.push(r);
						p.length && a.push({
							elem: i,
							handlers: p
						})
		...
		return this instanceof Ue.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented =
			e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? re : le, this.target = e.target &&
			3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget =
			e.relatedTarget) : this.type = e, t && Ue.extend(this, t), this.timeStamp = e && e.timeStamp || Ue.now(), void(
			this[Ue.expando] = !0)) : new Ue.Event(e, t)
	}, Ue.Event.prototype = {
		...
		which: function(e) {
			var t = e.button;
			return null == e.which && et.test(e.type) ? null == e.charCode ? e.keyCode : e.charCode : !e.which && void 0 !==
				t && tt.test(e.type) ? 1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0 : e.which
		}
		...
		Ue.event.special[e] = {
			...
			handle: function(n) {
				var a = this,
					...
					e = n.handleObj,
					i;
				return o && (o === a || Ue.contains(a, o)) || (n.type = e.origType, i = e.handler.apply(this, arguments), n.type =
					t), i
			}
		}
	}), Ue.fn.extend({
		...
		off: function(t, n, a) {
			var o, i;
			if (t && t.preventDefault && t.handleObj) return o = t.handleObj, Ue(t.delegateTarget).off(o.namespace ? o.origType +
	...
	Ue.extend({
		...
		Ue.fn[e] = function(n) {
			for (var a = [], o = Ue(n), e = o.length - 1, i = 0, s; i <= e; i++) s = i == e ? this : this.clone(!0), Ue(o[i])[
				t](s), Ye.apply(a, s.get());
	...
	! function() {
		function t() {
			if (o) {
				o.style.cssText =
					"box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", o.innerHTML =
					"", Je.appendChild(a);
				var e = ee.getComputedStyle(o);
				s = "1%" !== e.top, d = "2px" === e.marginLeft, r = "4px" === e.width, o.style.marginRight = "50%", l = "4px" ===
					e.marginRight, Je.removeChild(a), o = null
			}
		}
		var a = Fe.createElement("div"),
			o = Fe.createElement("div"),
			s, r, l, d;
		o.style && (o.style.backgroundClip = "content-box", o.cloneNode(!0).style.backgroundClip = "", n.clearCloneStyle =
			"content-box" === o.style.backgroundClip, a.style.cssText =
			"border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", a.appendChild(o), Ue.extend(
				n, {
	...
	Ue.extend({
		...
		style: function(t, a, o, s) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				var r = Ue.camelCase(a),
					...
					i = t.style,
					d, p, u;
				return l || (a = _e(r)), u = Ue.cssHooks[a] || Ue.cssHooks[r], void 0 === o ? u && "get" in u && void 0 !== (d =
					u.get(t, !1, s)) ? d : i[a] : (p = typeof o, "string" === p && (d = U.exec(o)) && d[1] && (o = _(t, a, d), p =
					"number"), null != o && o === o && ("number" === p && (o += d && d[3] || (Ue.cssNumber[r] ? "" : "px")), n.clearCloneStyle ||
					"" !== o || 0 !== a.indexOf("background") || (i[a] = "inherit"), u && "set" in u && void 0 === (o = u.set(t,
						o, s)) || (l ? i.setProperty(a, o) : i[a] = o)), void 0)
			}
		},
		css: function(t, n, a, o) {
			var s = Ue.camelCase(n),
				r = ut.test(n),
				i, l, d;
			return r || (n = _e(s)), d = Ue.cssHooks[n] || Ue.cssHooks[s], d && "get" in d && (i = d.get(t, !0, a)), void 0 ===
				i && (i = ye(t, n, o)), "normal" === i && n in ft && (i = ft[n]), "" === a || a ? (l = parseFloat(i), !0 === a ||
					isFinite(l) ? l || 0 : i) : i
		}
	}), Ue.each(["height", "width"], function(e, t) {
		Ue.cssHooks[t] = {
			get: function(e, n, a) {
				if (n) return !pt.test(Ue.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ?
					Te(e, t, a) : Z(e, gt, function() {
						return Te(e, t, a)
					})
			},
			set: function(n, a, o) {
		...
		Ue.cssHooks[t + n] = {
			expand: function(a) {
				for (var o = 0, i = {}, e = "string" == typeof a ? a.split(" ") : [a]; 4 > o; o++) i[t + Q[o] + n] = e[o] || e[
					o - 2] || e[0];
				return i
			}
		...
		init: function(t, n, a, o, i, e) {
			this.elem = t, this.prop = a, this.easing = i || Ue.easing._default, this.options = n, this.start = this.now =
				this.cur(), this.end = o, this.unit = e || (Ue.cssNumber[a] ? "" : "px")
		},
		cur: function() {
		...
		run: function(e) {
			var t = Ee.propHooks[this.prop],
				n;
			return this.pos = this.options.duration ? n = Ue.easing[this.easing](e, this.options.duration * e, 0, 1, this.options
					.duration) : n = e, this.now = (this.end - this.start) * n + this.start, this.options.step && this.options.step
				.call(this.elem, this.now, this), t && t.set ? t.set(this) : Ee.propHooks._default.set(this), this
		}
		...
		_default: {
			get: function(e) {
				...
				return 1 !== e.elem.nodeType || null != e.elem[e.prop] && null == e.elem.style[e.prop] ? e.elem[e.prop] : (t =
					Ue.css(e.elem, e.prop, ""), t && "auto" !== t ? t : 0)
			},
			set: function(e) {
				Ue.fx.step[e.prop] ? Ue.fx.step[e.prop](e) : 1 === e.elem.nodeType && (null != e.elem.style[Ue.cssProps[e.prop]] ||
					Ue.cssHooks[e.prop]) ? Ue.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now
			}
		}
	...
	Ue.Animation = Ue.extend(Pe, {
			...
			tweener: function(t, n) {
				...
				for (var o = 0, i = t.length, e; o < i; o++) e = t[o], Pe.tweeners[e] = Pe.tweeners[e] || [], Pe.tweeners[e].unshift(
					n)
			},
			prefilters: [De],
			...
			return Ue.fx.off ? a.duration = 0 : "number" != typeof a.duration && (a.duration in Ue.fx.speeds ? a.duration = Ue.fx
					.speeds[a.duration] : a.duration = Ue.fx.speeds._default), null != a.queue && !0 !== a.queue || (a.queue = "fx"),
				a.old = a.complete, a.complete = function() {
			...
			stop: function(t, e, n) {
				...
				return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(
					function() {
						...
						for (i = s.length; i--;) s[i].elem !== this || null != t && s[i].queue !== t || (s[i].anim.stop(n), a = !1, s
							.splice(i, 1));
			...
			finish: function(t) {
				return !1 !== t && (t = t || "fx"), this.each(function() {
					var n = z.get(this),
						...
						i = a ? a.length : 0,
						s;
					for (n.finish = !0, Ue.queue(this, t, []), o && o.stop && o.stop.call(this, !0), s = e.length; s--;) e[s].elem ===
						this && e[s].queue === t && (e[s].anim.stop(!0), e.splice(s, 1));
		...
		function() {
			...
			e.type = "checkbox", n.checkOn = "" !== e.value, n.optSelected = o.selected, e = Fe.createElement("input"), e.value =
				"t", e.type = "radio", n.radioValue = "t" === e.value
		}();
	...
	Ue.fn.extend({
		...
		attr: function(t, n, a) {
			var o = t.nodeType,
				i, s;
			if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof t.getAttribute ? Ue.prop(t, n, a) : (1 === o &&
				Ue.isXMLDoc(t) || (s = Ue.attrHooks[n.toLowerCase()] || (Ue.expr.match.bool.test(n) ? wt : void 0)), void 0 ===
				a ? s && "get" in s && null !== (i = s.get(t, n)) ? i : (i = Ue.find.attr(t, n), null == i ? void 0 : i) :
				null === a ? void Ue.removeAttr(t, n) : s && "set" in s && void 0 !== (i = s.set(t, a, n)) ? i : (t.setAttribute(
					n, a + ""), a))
		},
		attrHooks: {
			type: {
	...
	Ue.fn.extend({
		...
		prop: function(t, n, a) {
			var o = t.nodeType,
				i, s;
			if (3 !== o && 8 !== o && 2 !== o) return 1 === o && Ue.isXMLDoc(t) || (n = Ue.propFix[n] || n, s = Ue.propHooks[
					n]), void 0 === a ? s && "get" in s && null !== (i = s.get(t, n)) ? i : t[n] : s && "set" in s && void 0 !==
				(i = s.set(t, a, n)) ? i : t[n] = a
		},
		propHooks: {
			tabIndex: {
				get: function(e) {
	...
	}), Ue.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap",
		...
		toggleClass: function(t, e) {
			var n = typeof t;
			return "boolean" == typeof e && "string" == n ? e ? this.addClass(t) : this.removeClass(t) : Ue.isFunction(t) ?
				this.each(function(n) {
					...
					else void 0 !== t && "boolean" != n || (a = Ne(this), a && z.set(this, "__className__", a), this.setAttribute &&
						this.setAttribute("class", a || !1 === t ? "" : z.get(this, "__className__") || ""))
				})
		},
		hasClass: function(e) {
			var t = 0,
		...
		val: function(t) {
			var n = this[0],
				...
				if (arguments.length) return o = Ue.isFunction(t), this.each(function(n) {
					var i;
					1 === this.nodeType && (i = o ? t.call(this, n, Ue(this).val()) : t, null == i ? i = "" : "number" ==
						typeof i ? i += "" : Array.isArray(i) && (i = Ue.map(i, function(e) {
							return null == e ? "" : e + ""
						})), a = Ue.valHooks[this.type] || Ue.valHooks[this.nodeName.toLowerCase()], a && "set" in a && void 0 !==
						a.set(this, i, "value") || (this.value = i))
				});
				if (n) return a = Ue.valHooks[n.type] || Ue.valHooks[n.nodeName.toLowerCase()], a && "get" in a && void 0 !==
					(e = a.get(n, "value")) ? e : (e = n.value, "string" == typeof e ? e.replace(Et, "") : null == e ? "" : e)
			}
		}
	}), Ue.extend({
		valHooks: {
			...
			select: {
				get: function(t) {
					...
					for (l = 0 > e ? s : a ? e : 0; l < s; l++)
						if (r = n[l], (r.selected || l === e) && !r.disabled && (!r.parentNode.disabled || !w(r.parentNode,
								"optgroup"))) {
				...
				set: function(t, n) {
					for (var a = t.options, e = Ue.makeArray(n), o = a.length, i, s; o--;) s = a[o], (s.selected = -1 < Ue.inArray(
						Ue.valHooks.option.get(s), e)) && (i = !0);
					return i, e
				}
			}
		}
	...
	Ue.extend(Ue.event, {
		trigger: function(t, a, s, r) {
			var l = [s || Fe],
				...
				u, f, y, v, x, _, w;
			if (f = y = s = s || Fe, 3 !== s.nodeType && 8 !== s.nodeType && !St.test(o + Ue.event.triggered) && (-1 < o.indexOf(
						".") && (d = o.split("."), o = d.shift(), d.sort()), x = 0 > o.indexOf(":") && "on" + o, t = t[Ue.expando] ?
					t : new Ue.Event(o, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = d.join("."), t.rnamespace =
					t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target ||
					(t.target = s), a = null == a ? [t] : Ue.makeArray(a, [t]), w = Ue.event.special[o] || {}, r || !w.trigger ||
				...
				for (u = 0;
					(f = l[u++]) && !t.isPropagationStopped();) t.type = 1 < u ? v : w.bindType || o, _ = (z.get(f, "events") || {})[
					t.type] && z.get(f, "handle"), _ && _.apply(f, a), _ = x && f[x], _ && _.apply && T(f) && (t.result = _.apply(
					f, a), !1 === t.result && t.preventDefault());
				return t.type = o, r || t.isDefaultPrevented() || w._default && !1 !== w._default.apply(l.pop(), a) || !T(s) ||
					x && Ue.isFunction(s[o]) && !Ue.isWindow(s) && (y = s[x], y && (s[x] = null), Ue.event.triggered = o, s[o](),
						Ue.event.triggered = void 0, y && (s[x] = y)), t.result
			}
		},
	...
	}), Ue.each(["blur", "focus", "focusin", "focusout", "resize", "scroll", "click", "dblclick", "mousedown", "mouseup",
		"mousemove", "mouseover", "mouseout", "mouseenter", "mouseleave", "change", "select", "submit", "keydown",
		"keypress", "keyup", "contextmenu"
	], function(e, t) {
	...
	Ue.param = function(t, n) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !Ue(this).is(":disabled") && Ot.test(this.nodeName) && !Pt.test(e) && (this.checked || !
					Ve.test(e))
			}).map(function(e, t) {
				var n = Ue(this).val();
	...
	qt.href = kt.href, Ue.extend({
		...
		ajax: function(a, r) {
			function d(e, a, i, r) {
				var l = a,
					d, c, u, g, f;
				P || (P = !0, D && ee.clearTimeout(D), y = void 0, A = r || "", E.readyState = 0 < e ? 4 : 0, d = 200 <= e &&
					300 > e || 304 === e, i && (g = Re(_, E, i)), g = ze(_, g, E, d), d ? (_.ifModified && (f = E.getResponseHeader(
							"Last-Modified"), f && (Ue.lastModified[S] = f), f = E.getResponseHeader("etag"), f && (Ue.etag[S] = f)),
						204 === e || "HEAD" === _.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = g.state, c = g.data,
							u = g.error, d = !u)) : (u = l, !e && l || (l = "error", 0 > e && (e = 0))), E.status = e, E.statusText = (
						a || l) + "", d ? C.resolveWith(o, [c, l, E]) : C.rejectWith(o, [E, l, u]), E.statusCode(t), t = void 0, O &&
					p.trigger(d ? "ajaxSuccess" : "ajaxError", [E, _, d ? c : u]), s.fireWith(o, [E, l]), O && (p.trigger(
			...
			var _ = Ue.ajaxSetup({}, r),
				...
				y, S, A, I, D, L, P, O, N, W;
			if (C.promise(E), _.url = ((a || _.url || kt.href) + "").replace(zt, kt.protocol + "//"), _.type = r.method || r
				.type || _.method || _.type, _.dataTypes = (_.dataType || "*").toLowerCase().match(H) || [""], null == _.crossDomain
			) {
			...
			if (_.data && _.processData && "string" != typeof _.data && (_.data = Ue.param(_.data, _.traditional)), He(Mt, _,
					r, E), P) return E;
			for (N in O = Ue.event && _.global, O && 0 == Ue.active++ && Ue.event.trigger("ajaxStart"), _.type = _.type.toUpperCase(),
				_.hasContent = !Rt.test(_.type), S = _.url.replace(jt, ""), _.hasContent ? _.data && _.processData && 0 === (_.contentType ||
					"").indexOf("application/x-www-form-urlencoded") && (_.data = _.data.replace(Nt, "+")) : (W = _.url.slice(S.length),
					_.data && (S += (It.test(S) ? "&" : "?") + _.data, delete _.data), !1 === _.cache && (S = S.replace($t, "$1"),
						W = (It.test(S) ? "&" : "?") + "_=" + At++ + W), _.url = S + W), _.ifModified && (Ue.lastModified[S] && E.setRequestHeader(
					"If-Modified-Since", Ue.lastModified[S]), Ue.etag[S] && E.setRequestHeader("If-None-Match", Ue.etag[S])), (_.data &&
					_.hasContent && !1 !== _.contentType || r.contentType) && E.setRequestHeader("Content-Type", _.contentType), E
				.setRequestHeader("Accept", _.dataTypes[0] && _.accepts[_.dataTypes[0]] ? _.accepts[_.dataTypes[0]] + ("*" ===
					_.dataTypes[0] ? "" : ", */*; q=0.01") : _.accepts["*"]), _.headers) E.setRequestHeader(N, _.headers[N]);
		...
		wrapAll: function(e) {
			var t;
			return this[0] && (Ue.isFunction(e) && (e = e.call(this[0])), t = Ue(e, this[0].ownerDocument).eq(0).clone(!0),
	...
	n.cors = !!Xt && "withCredentials" in Xt, n.ajax = Xt = !!Xt, Ue.ajaxTransport(function(t) {
		...
		if (n.cors || Xt && !t.crossDomain) return {
			send: function(n, e) {
				...
				for (a in t.mimeType && s.overrideMimeType && s.overrideMimeType(t.mimeType), t.crossDomain || n[
						"X-Requested-With"] || (n["X-Requested-With"] = "XMLHttpRequest"), n) s.setRequestHeader(a, n[a]);
				o = function(t) {
					return function() {
						o && (o = i = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === t ? s.abort() :
							"error" === t ? "number" == typeof s.status ? e(s.status, s.statusText) : e(0, "error") : e(Yt[s.status] ||
	...
	Ue.ajaxSetup({
			...
			var o = !1 !== t.jsonp && (Vt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf(
					"application/x-www-form-urlencoded") && Vt.test(t.data) && "data"),
				i, s, r;
			if (o || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = Ue.isFunction(t.jsonpCallback) ? t.jsonpCallback() :
				t.jsonpCallback, o ? t[o] = t[o].replace(Vt, "$1" + i) : !1 !== t.jsonp && (t.url += (It.test(t.url) ? "&" : "?") +
					t.jsonp + "=" + i), t.converters["script json"] = function() {
					return r || Ue.error(i + " was not called"), r[0]
				}, t.dataTypes[0] = "json", s = ee[i], ee[i] = function() {
					r = arguments
				}, a.always(function() {
					void 0 === s ? Ue(ee).removeProp(i) : ee[i] = s, t[i] && (t.jsonpCallback = n.jsonpCallback, Ut.push(i)), r &&
						Ue.isFunction(s) && s(r[0]), r = s = void 0
				}), "script"
			...
			var i, s, r;
			return a || (n.createHTMLDocument ? (a = Fe.implementation.createHTMLDocument(""), i = a.createElement("base"), i.href =
				Fe.location.href, a.head.appendChild(i)) : a = Fe), s = v.exec(t), r = !o && [], s ? [a.createElement(s[1])] : (s =
				se([t], a, r), r && r.length && Ue(r).remove(), Ue.merge([], s.childNodes))
		}, Ue.fn.load = function(t, n, o) {
			var i = this,
				s = t.indexOf(" "),
				r, l, p;
			return -1 < s && (r = Oe(t.slice(s)), t = t.slice(0, s)), Ue.isFunction(n) ? (o = n, n = void 0) : n && "object" ==
				typeof n && (l = "POST"), 0 < i.length && Ue.ajax({
					url: t,
					type: l || "GET",
					dataType: "html",
					data: n
			...
			setOffset: function(t, n, a) {
				var o = Ue.css(t, "position"),
					...
					r = {},
					l, c, p, u, m, y, v;
				"static" === o && (t.style.position = "relative"), m = s.offset(), p = Ue.css(t, "top"), y = Ue.css(t, "left"), v =
					("absolute" === o || "fixed" === o) && -1 < (p + y).indexOf("auto"), v ? (l = s.position(), u = l.top, c = l.left) :
					(u = parseFloat(p) || 0, c = parseFloat(y) || 0), Ue.isFunction(n) && (n = n.call(t, a, Ue.extend({}, m))), null !=
					n.top && (r.top = n.top - m.top + u), null != n.left && (r.left = n.left - m.left + c), "using" in n ? n.using.call(
						t, r) : s.css(r)
			}
		}, Ue.fn.extend({
			offset: function(t) {
				...
				var n = this[0],
					a, o, i, s;
				if (n) return n.getClientRects().length ? (i = n.getBoundingClientRect(), a = n.ownerDocument, o = a.documentElement,
					s = a.defaultView, {
			...
			position: function() {
				if (this[0]) {
					var e = this[0],
						...
						n, o;
					return "fixed" === Ue.css(e, "position") ? o = e.getBoundingClientRect() : (n = this.offsetParent(), o = this.offset(),
						w(n[0], "html") || (t = n.offset()), t = {
			...
			Ue.fn[e] = function(a) {
				return R(this, function(o, a, i) {
					var e;
					return Ue.isWindow(o) ? e = o : 9 === o.nodeType && (e = o.defaultView), void 0 === i ? e ? e[t] : o[a] :
						void(e ? e.scrollTo(n ? e.pageXOffset : i, n ? i : e.pageYOffset) : o[a] = i)
			...
			Ue.each({
				...
				Ue.fn[o] = function(i, e) {
					...
					return R(this, function(n, a, i) {
						var e;
						return Ue.isWindow(n) ? 0 === o.indexOf("outer") ? n["inner" + t] : n.document.documentElement["client" +
							t] : 9 === n.nodeType ? (e = n.documentElement, Math.max(n.body["scroll" + t], e["scroll" + t], n.body[
							"offset" + t], e["offset" + t], e["client" + t])) : void 0 === i ? Ue.css(n, a, r) : Ue.style(n, a, i, r)
					}, n, s ? i : void 0, s)
				}
			})
		}), Ue.fn.extend({
		...
		}, Ue.isArray = Array.isArray, Ue.parseJSON = JSON.parse, Ue.nodeName = w, "function" == typeof define && define.amd &&
	...
	function y() {
		if (I.fn.ajaxSubmit.debug) {
			...
			window.console && window.console.log ? window.console.log(e) : window.opera && window.opera.postError && window.opera
				.postError(e)
		}
	}
	var i = {
	...
	I.fn.attr2 = function() {
		...
		function e(e) {
			...
			function n() {
				...
				u.setAttribute("target", m), _ && !/post/i.test(_) || u.setAttribute("method", "POST"), t != T.url && u.setAttribute(
					"action", T.url), T.skipEncodingOverride || _ && !/post/i.test(_) || N.attr({
				...
				try {
					if (T.extraData)
						for (var o in T.extraData) T.extraData.hasOwnProperty(o) && (I.isPlainObject(T.extraData[o]) && T.extraData[o].hasOwnProperty(
							"name") && T.extraData[o].hasOwnProperty("value") ? a.push(I("<input type=\"hidden\" name=\"" + T.extraData[
							o].name + "\">").val(T.extraData[o].value).appendTo(u)[0]) : a.push(I("<input type=\"hidden\" name=\"" + o +
							"\">").val(T.extraData[o]).appendTo(u)[0]));
					T.iframeTarget || O.appendTo("body"), j.attachEvent ? j.attachEvent("onload", w) : j.addEventListener("load", w,
						!1), setTimeout(function n() {
						try {
					...
					u.setAttribute("action", t), u.setAttribute("enctype", n), e ? u.setAttribute("target", e) : N.removeAttr(
						"target"), I(a).remove()
				}
			}
			...
			function w(e) {
				if (!H.aborted && !K) {
					if ((V = i(j)) || (y("cannot access response document"), e = 2), e === 1 && H) return H.abort("timeout"), void S
						.reject(H, "timeout");
					...
					if (V && V.location.href != T.iframeSrc || z) {
						...
						try {
							...
							if (y("isXml=" + c), !c && window.opera && (null === V.body || !V.body.innerHTML) && --k) return y(
								"requeing onLoad callback, DOM not available"), void setTimeout(w, 250);
							var n = V.body ? V.body : V.documentElement;
							H.responseText = n ? n.innerHTML : null, H.responseXML = V.XMLDocument ? V.XMLDocument : V, c && (T.dataType =
								"xml"), H.getResponseHeader = function(t) {
								return {
							...
							if (s || T.textarea) {
								...
								if (p) H.responseText = p.value, H.status = +p.getAttribute("status") || H.status, H.statusText = p.getAttribute(
									"statusText") || H.statusText;
								else if (s) {
									var u = V.getElementsByTagName("pre")[0],
										g = V.getElementsByTagName("body")[0];
									u ? H.responseText = u.textContent ? u.textContent : u.innerText : g && (H.responseText = g.textContent ? g.textContent :
										g.innerText)
								}
						...
						H.aborted && (y("upload aborted"), l = null), H.status && (l = 200 <= H.status && 300 > H.status || 304 === H.status ?
								"success" : "error"), "success" === l ? (T.success && T.success.call(T.context, U, "success", H), S.resolve(H
								.responseText, "success", H), A && I.event.trigger("ajaxSuccess", [H, T])) : l && (void 0 === d && (d = H.statusText),
								T.error && T.error.call(T.context, H, l, d), S.reject(H, "error", d), A && I.event.trigger("ajaxError", [H, T,
									d
								])), A && I.event.trigger("ajaxComplete", [H, T]), A && !--I.active && I.event.trigger("ajaxStop"), T.complete &&
							T.complete.call(T.context, H, l), K = !0, T.timeout && clearTimeout(B), setTimeout(function() {
			...
			if ((T = I.extend(!0, {}, I.ajaxSettings, P)).context = T.context || T, m = "jqFormIO" + new Date().getTime(), T.iframeTarget ?
				(R = (O = I(T.iframeTarget)).attr2("name")) ? m = R : O.attr2("name", m) : (O = I("<iframe name=\"" + m +
					"\" src=\"" + T.iframeSrc + "\" />")).css({
					position: "absolute",
					top: "-1000px",
					left: "-1000px"
					...
					abort: function(e) {
						...
						O.attr("src", T.iframeSrc), H.error = t, T.error && T.error.call(T.context, H, t, e), A && I.event.trigger(
							"ajaxError", [H, T, t]), T.complete && T.complete.call(T.context, H, t)
					}
				}, (A = T.global) && 0 == I.active++ && I.event.trigger("ajaxStart"), A && I.event.trigger("ajaxSend", [H, T]), T
				.beforeSend && !1 === T.beforeSend.call(T.context, H, T)) return T.global && I.active--, S.reject(), S;
			if (H.aborted) return S.reject(), S;
			(W = u.clk) && (R = W.name) && !W.disabled && (T.extraData = T.extraData || {}, T.extraData[R] = W.value, "image" ==
				W.type && (T.extraData[R + ".x"] = u.clk_x, T.extraData[R + ".y"] = u.clk_y));
			...
			var k = 50,
				Y = I.parseXML || function(n, e) {
					return window.ActiveXObject ? ((e = new ActiveXObject("Microsoft.XMLDOM")).async = "false", e.loadXML(n)) : e =
						new DOMParser().parseFromString(n, "text/xml"), e && e.documentElement && "parsererror" != e.documentElement.nodeName ?
						e : null
				},
				...
				C = function(e, t, s) {
					...
					return n && "parsererror" === i.documentElement.nodeName && I.error && I.error("parsererror"), s && s.dataFilter &&
						(i = s.dataFilter(i, t)), "string" == typeof i && ("json" === t || !t && 0 <= a.indexOf("json") ? i = X(i) : (
							"script" === t || !t && 0 <= a.indexOf("javascript")) && I.globalEval(i)), i
				},
				U, V, K;
			return S
		}
		...
		"function" == typeof P ? P = {
			success: P
		} : void 0 === P && (P = {}), _ = P.type || this.attr2("method"), (u = (u = "string" == typeof(r = P.url || this.attr2(
			"action")) ? I.trim(r) : "") || window.location.href || "") && (u = (u.match(/^([^#]+)/) || [])[1]), P = I.extend(
			!0, {
				url: u,
		...
		var E = [],
			...
			d;
		if (P.data && (P.extraData = P.data, d = I.param(P.data, c)), P.beforeSubmit && !1 === P.beforeSubmit(m, this, P))
			return y("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
		...
		var S = I.param(m, c);
		d && (S = S ? S + "&" + d : d), "GET" == P.type.toUpperCase() ? (P.url += (0 <= P.url.indexOf("?") ? "&" : "?") + S,
			P.data = null) : P.data = S;
		var k = [];
			...
			if (P.extraData) {
				var a = function(e) {
					var t = I.param(e, P.traditional).split("&"),
						...
						o = [],
						i, s;
					for (i = 0; i < a; i++) t[i] = t[i].replace(/\+/g, " "), s = t[i].split("="), o.push([decodeURIComponent(s[0]),
		...
		return n.delegation ? (I(document).off("submit.form-plugin", this.selector, e).off("click.form-plugin", this.selector,
				a).on("submit.form-plugin", this.selector, n, e).on("click.form-plugin", this.selector, n, a), this) : this.ajaxFormUnbind()
			.bind("submit.form-plugin", n, e).bind("click.form-plugin", n, a)
		...
		var n = this[0],
			...
			p, b, y, _, w, C, T, E;
		if (d && !/MSIE [678]/.test(navigator.userAgent) && (d = I(d).get()), r && (p = I(":input[form=\"" + r + "\"]").get())
			.length && (d = (d || []).concat(p)), !d || !d.length) return a;
		...
		for (var t = [], s = 0, r = this.length; s < r; s++) {
			var n = this[s],
				i = I.fieldValue(n, e);
			null !== i && void 0 !== i && (i.constructor != Array || i.length) && (i.constructor == Array ? I.merge(t, i) : t.push(
				i))
		}
		return t
		...
		if (void 0 === t && (t = !0), t && (!p || e.disabled || "reset" == a || "button" == a || ("checkbox" == a ||
					"radio" == a) && !e.checked || ("submit" == a || "image" == a) && e.form && e.form.clk != e || "select" == n &&
				-1 == e.selectedIndex)) return null;
		if ("select" == n) {
		...
		return this.each(function() {
			...
			t.test(o) || "textarea" == a ? this.value = "" : "checkbox" == o || "radio" == o ? this.checked = !1 : "select" ==
				a ? this.selectedIndex = -1 : "file" == o ? /MSIE/.test(navigator.userAgent) ? I(this).replaceWith(I(this).clone(
					!0)) : I(this).val("") : e && (!0 === e && /hidden/.test(o) || "string" == typeof e && I(this).is(e)) && (this
					.value = "")
		})
	...
	function t(_) {
		function g(e, c) {
			...
			if (c = _.extend({}, _.blockUI.defaults, c || {}), !c.ignoreIfBlocked || !_(e).data("blockUI.isBlocked")) {
				if (c.overlayCSS = _.extend({}, _.blockUI.defaults.overlayCSS, c.overlayCSS || {}), b = _.extend({}, _.blockUI.defaults
						.css, c.css || {}), c.onOverlayClick && (c.overlayCSS.cursor = "pointer"), k = _.extend({}, _.blockUI.defaults.themedCSS,
						c.themedCSS || {}), o = void 0 === o ? c.message : o, p && u && A(window, {
						fadeOut: 0
					}), o && "string" != typeof o && (o.parentNode || o.jquery)) {
					var P = o.jquery ? o[0] : o,
						m = {};
					_(e).data("blockUI.history", m), m.el = P, m.parent = P.parentNode, m.display = P.style.display, m.position = P.style
						.position, m.parent && m.parent.removeChild(P)
				}
				_(e).data("blockUI.onUnblock", c.onUnblock);
				var v = c.baseZ,
					N, R, F, q;
				N = _(l || c.forceIframe ? "<iframe class=\"blockUI\" style=\"z-index:" + v++ +
						";display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0\" src=\"" + c
						.iframeSrc + "\"></iframe>" : "<div class=\"blockUI\" style=\"display:none\"></div>"), R = _(c.theme ?
						"<div class=\"blockUI blockOverlay ui-widget-overlay\" style=\"z-index:" + v++ + ";display:none\"></div>" :
						"<div class=\"blockUI blockOverlay\" style=\"z-index:" + v++ +
						";display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0\"></div>"), c.theme && p ? (q =
						"<div class=\"blockUI " + c.blockMsgClass + " blockPage ui-dialog ui-widget ui-corner-all\" style=\"z-index:" + (
							v + 10) + ";display:none;position:fixed\">", c.title && (q +=
							"<div class=\"ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle\">" + (c.title || "&nbsp;") +
							"</div>"), q += "<div class=\"ui-widget-content ui-dialog-content\"></div>", q += "</div>") : c.theme ? (q =
						"<div class=\"blockUI " + c.blockMsgClass + " blockElement ui-dialog ui-widget ui-corner-all\" style=\"z-index:" +
						(v + 10) + ";display:none;position:absolute\">", c.title && (q +=
							"<div class=\"ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle\">" + (c.title || "&nbsp;") +
							"</div>"), q += "<div class=\"ui-widget-content ui-dialog-content\"></div>", q += "</div>") : q = p ?
					"<div class=\"blockUI " + c.blockMsgClass + " blockPage\" style=\"z-index:" + (v + 10) +
					";display:none;position:fixed\"></div>" : "<div class=\"blockUI " + c.blockMsgClass +
					" blockElement\" style=\"z-index:" + (v + 10) + ";display:none;position:absolute\"></div>", F = _(q), o && (c.theme ?
						(F.css(k), F.addClass("ui-widget-content")) : F.css(b)), c.theme || R.css(c.overlayCSS), R.css("position", p ?
				...
				if (r || S) {
					if (p && c.allowBodyStretch && _.support.boxModel && _("html,body").css("height", "100%"), (r || !_.support.boxModel) &&
						!p) var O = a(e, "borderTopWidth"),
					...
					_.each(Y, function(n, e) {
						...
						if (t.position = "absolute", 2 > n) p ? t.setExpression("height",
							"Math.max(document.body.scrollHeight, document.body.offsetHeight) - (jQuery.support.boxModel?0:" + c.quirksmodeOffsetHack +
							") + \"px\"") : t.setExpression("height", "this.parentNode.offsetHeight + \"px\""), p ? t.setExpression(
							"width",
							"jQuery.support.boxModel && document.documentElement.clientWidth || document.body.clientWidth + \"px\"") : t.setExpression(
							"width", "this.parentNode.offsetWidth + \"px\""), M && t.setExpression("left", M), T && t.setExpression("top",
							T);
				...
				if (o && (c.theme ? F.find(".ui-widget-content").append(o) : F.append(o), (o.jquery || o.nodeType) && _(o).show()),
					(l || c.forceIframe) && c.showOverlay && N.show(), c.fadeIn) {
				...
				if (D(1, e, c), p ? (u = F[0], f = _(c.focusableElements, u), c.focusInput && setTimeout(L, 20)) : i(F[0], c.centerX,
						c.centerY), c.timeout) {
		...
		function A(n, t) {
			var i = n == window,
				...
				c;
			d && (clearTimeout(d), l.removeData("blockUI.timeout")), t = _.extend({}, _.blockUI.defaults, t || {}), D(0, n, t),
				null === t.onUnblock && (t.onUnblock = l.data("blockUI.onUnblock"), l.removeData("blockUI.onUnblock"));
			var p;
			p = i ? _("body").children().filter(".blockUI").add("body > .blockUI") : l.find(">.blockUI"), t.cursorReset && (1 <
				p.length && (p[1].style.cursor = t.cursorReset), 2 < p.length && (p[2].style.cursor = t.cursorReset)), i && (u = f =
				null), t.fadeOut ? (c = p.length, p.stop().fadeOut(t.fadeOut, function() {
				0 == --c && e(p, a, t, n)
			})) : e(p, a, t, n)
		}
		...
		function e(e, t, o, n) {
			...
			if (!i.data("blockUI.isBlocked")) {
				e.each(function() {
					...
					t.parent && t.parent.appendChild(t.el), i.removeData("blockUI.history")), i.data("blockUI.static") && i.css(
					"position", "static"), "function" == typeof o.onUnblock && o.onUnblock(n, o);
		...
		function D(e, t, a) {
			var n = t == window,
				i = _(t);
			if ((e || (!n || u) && (n || i.data("blockUI.isBlocked"))) && (i.data("blockUI.isBlocked", e), n && a.bindEvents &&
					(!e || a.showOverlay))) {
				e ? _(document).bind("mousedown mouseup keydown keypress keyup touchstart touchend touchmove", a, o) : _(document).unbind(
					"mousedown mouseup keydown keypress keyup touchstart touchend touchmove", o)
			}
		}
		...
		function o(e) {
			...
			var i = e.data,
				s = _(e.target);
			return s.hasClass("blockOverlay") && i.onOverlayClick && i.onOverlayClick(e), !!(0 < s.parents("div." + i.blockMsgClass)
				.length) || 0 === s.parents().children().filter("div.blockUI").length
		}
		...
		_.blockUI = function(t) {
			...
			return this.each(function() {
				...
				"static" == _.css(this, "position") && (this.style.position = "relative", _(this).data("blockUI.static", !0)),
					this.style.zoom = 1, g(this, e)
			})
...
function(n, e) {
	...
	function s(n, e, t, a) {
		return _(e["offset" + n], e["scroll" + n], t["client" + n], t["offset" + n], t["scroll" + n], G() ? t["offset" + n] +
			a["margin" + ("Height" === n ? "Top" : "Left")] + a["margin" + ("Height" === n ? "Bottom" : "Right")] : 0)
	}
	...
	function g(n, e, d, i) {
		...
		if ("viewport" === i) r = o(g);
			...
			var s;
			"scrollParent" === i ? (s = ge(t(n)), "BODY" === s.nodeName && (s = window.document.documentElement)) : "window" ===
				i ? s = window.document.documentElement : s = i;
			var b = c(s, g);
	...
	function C(a, s, t) {
		...
		return i.forEach(function(e) {
			...
			e.enabled && ce(t) && (s.offsets.popper = ve(s.offsets.popper), s.offsets.reference = ve(s.offsets.reference), s =
				t(s, e))
		}), s
	}
	...
	function b() {
		if (!this.state.isDestroyed) {
			...
			t.offsets.reference = m(this.state, this.popper, this.reference), t.placement = f(this.options.placement, t.offsets
					.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip
					.padding), t.originalPlacement = t.placement, t.offsets.popper = x(this.popper, t.offsets.reference, t.placement),
				t.offsets.popper.position = "absolute", t = C(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) :
	...
	function w() {
		return this.state.isDestroyed = !0, y(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
			this.popper.style.left = "", this.popper.style.position = "", this.popper.style.top = "", this.popper.style[T(
	...
	function P(n, e) {
		Object.keys(e).forEach(function(t) {
			var a = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && I(e[t]) && (a = "px"), n.style[
				t] = e[t] + a
		})
	}
	...
	function W(l, e, t, o) {
		...
		if ("vh" === r || "vw" === r) {
			var d;
			return d = "vh" === r ? _(document.documentElement.clientHeight, window.innerHeight || 0) : _(document.documentElement
				.clientWidth, window.innerWidth || 0), d / 100 * n
		}
		return n
	}
	...
	function R(l, c, t, e) {
		...
		return r = r.map(function(a, e) {
			...
			return a.reduce(function(a, e) {
				return "" === a[a.length - 1] && -1 !== ["+", "-"].indexOf(e) ? (a[a.length - 1] = e, n = !0, a) : n ? (a[a.length -
					1] += e, n = !1, a) : a.concat(e)
			}, []).map(function(n) {
				return W(n, i, c, t)
			})
	...
	function M(a, e) {
		var t = e.offset,
			...
			s = i.split("-")[0],
			d;
		return d = I(+t) ? [+t, 0] : R(t, r, l, s), "left" === s ? (r.top += d[0], r.left -= d[1]) : "right" === s ? (r.top +=
			d[0], r.left += d[1]) : "top" === s ? (r.left += d[0], r.top -= d[1]) : "bottom" === s && (r.left += d[0], r.top +=
			d[1]), a.popper = r, a
	}
	for (var z = Math.min, F = Math.floor, _ = Math.max, B = ["native code", "[object MutationObserverConstructor]"], q =
			function(n) {
		...
		J = function() {
			function n(a, e) {
				for (var t = 0, i; t < e.length; t++) i = e[t], i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in
					i && (i.writable = !0), Object.defineProperty(a, i.key, i)
			}
		...
		re = function() {
			function a(e, t) {
				...
				Z(this, a), this.scheduleUpdate = function() {
					...
					isCreated: !1,
					scrollParents: []
				}, this.reference = e.jquery ? e[0] : e, this.popper = t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(
					oe({}, a.Defaults.modifiers, n.modifiers)).forEach(function(t) {
		...
		modifiers: {
						...
						n = {
							...
							secondary: function(a) {
								var e = "right" === a ? "left" : "top",
									o = l[e];
								return l[a] > t[a] && !r.escapeWithReference && (o = z(l[e], t[a] - ("right" === a ? l.width : l.height))),
									ne({}, e, o)
							}
						};
			...
			keepTogether: {
				...
				fn: function(l) {
					var e = l.offsets,
						...
						s = r ? "left" : "top",
						d = r ? "width" : "height";
					return t[c] < n(o[s]) && (l.offsets.popper[s] = n(o[s]) - t[d]), t[s] > n(o[c]) && (l.offsets.popper[s] = n(o[c])),
						l
				}
			},
			arrow: {
				...
				fn: function(t, e) {
					...
					var v = t.placement.split("-")[0],
						...
						m = s ? "bottom" : "right",
						c = h(o)[d];
					p[m] - c < r[l] && (t.offsets.popper[l] -= r[l] - (p[m] - c)), p[l] + c > r[m] && (t.offsets.popper[l] += p[l] +
						c - r[m]);
					var g = p[l] + p[d] / 2 - c / 2,
						u = ue(t.instance.popper, "margin" + a).replace("px", ""),
						b = g - ve(t.offsets.popper)[l] - u;
					return b = _(z(r[d] - c, b), 0), t.arrowElement = o, t.offsets.arrow = {}, t.offsets.arrow[l] = Math.round(b),
						t.offsets.arrow[f] = "", t
				},
				element: "[x-arrow]"
			},
				...
				fn: function(_, T) {
					...
					return k.forEach(function(e, n) {
						...
						var i = _.offsets.popper,
							...
							s = F,
							r = "left" === o && s(i.right) > s(a.left) || "right" === o && s(i.left) < s(a.right) || "top" === o && s(i
								.bottom) > s(a.top) || "bottom" === o && s(i.top) < s(a.bottom),
							l = s(i.left) < s(t.left),
							...
							f = !!T.flipVariations && (g && "start" === S && l || g && "end" === S && d || !g && "start" === S && c ||
								!g && "end" === S && p);
						(r || u || f) && (_.flipped = !0, (r || u) && (o = k[n + 1]), f && (S = H(S)), _.placement = o + (S ? "-" +
								S : ""), _.offsets.popper = oe({}, _.offsets.popper, x(_.instance.popper, _.offsets.reference, _.placement)),
							_ = C(_.instance.modifiers, _, "flip"))
					}), _
				},
				behavior: "flip",
				padding: 5,
			...
			inner: {
				...
				fn: function(a) {
					...
					return i[r ? "left" : "top"] = n[t] - (l ? i[r ? "width" : "height"] : 0), a.placement = v(e), a.offsets.popper =
						ve(i), a
				}
			},
			hide: {
			...
			computeStyle: {
				...
				fn: function(r, e) {
					...
					var p = void 0 === n ? e.gpuAcceleration : n,
						...
						u = T("transform"),
						h, b;
					if (b = "bottom" == c ? -l.height + f.bottom : f.top, h = "right" == m ? -l.width + f.right : f.left, p && u) g[
						u] = "translate3d(" + h + "px, " + b + "px, 0)", g[c] = 0, g[m] = 0, g.willChange = "transform";
					else {
						var v = "bottom" == c ? -1 : 1,
							y = "right" == m ? -1 : 1;
					...
					return r.attributes = oe({}, x, r.attributes), r.styles = oe({}, g, r.styles), r.arrowStyles = oe({}, r.offsets
						.arrow, r.arrowStyles), r
				},
				gpuAcceleration: !0,
				x: "bottom",
				y: "right"
			...
			applyStyle: {
				...
				enabled: !0,
				fn: function(t) {
					return P(t.instance.popper, t.styles), O(t.instance.popper, t.attributes), t.arrowElement && Object.keys(t.arrowStyles)
						.length && P(t.arrowElement, t.arrowStyles), t
				},
	...
	"object" == typeof exports && "undefined" != typeof module ? t(exports, require("jquery"), require("popper.js")) :
		"function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], t) : t(n.bootstrap = {}, n.jQuery,
			n.Popper)
}(this, function(xn, t, Ln) {
	"use strict";

	function jn(a, t) {
		for (var e = 0, o; e < t.length; e++) o = t[e], o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o &&
			(o.writable = !0), Object.defineProperty(a, o.key, o)
	}
	...
	function o(a) {
		for (var n = 1; n < arguments.length; n++) {
			var o = null == arguments[n] ? {} : arguments[n],
				i = Object.keys(o);
			"function" == typeof Object.getOwnPropertySymbols && (i = i.concat(Object.getOwnPropertySymbols(o).filter(function(
				e) {
	...
	var Hn = function(a) {
				...
				typeCheckConfig: function(l, t, e) {
					for (var n in e)
						if (Object.prototype.hasOwnProperty.call(e, n)) {
							...
							if (!new RegExp(i).test(s)) throw new Error(l.toUpperCase() + ": Option \"" + n + "\" provided type \"" + s +
								"\" but expected type \"" + i + "\".")
						} var o
				}
			};
		...
		i = (On = "alert", Wn = "." + (Nn = "bs.alert"), Rn = (Pn = t).fn[On], zn = {
			...
			}(), Pn(document).on(zn.CLICK_DATA_API, "[data-dismiss=\"alert\"]", qn._handleDismiss(new qn)), Pn.fn[On] = qn._jQueryInterface,
			Pn.fn[On].Constructor = qn, Pn.fn[On].noConflict = function() {
				return Pn.fn[On] = Rn, qn._jQueryInterface
			}, qn),
		h = (Xn = "button", Vn = "." + (Un = "bs.button"), Kn = ".data-api", Qn = (Yn = t).fn[Xn], Gn = "active", Zn = "btn",
			ea = "[data-toggle^=\"button\"]", ta = "[data-toggle=\"buttons\"]", na = "input", aa = ".active", oa = ".btn", ia = {
				...
				return e.toggle = function() {
					...
					if (s) {
						...
						if (n) {
							if ("radio" === n.type)
								...
								if (n.hasAttribute("disabled") || s.hasAttribute("disabled") || n.classList.contains("disabled") || s.classList
					...
					o && this._element.setAttribute("aria-pressed", !Yn(this._element).hasClass(Gn)), a && Yn(this._element).toggleClass(
						Gn)
				}, e.dispose = function() {
		...
		Cn = (la = "carousel", ca = "." + (da = "bs.carousel"), pa = ".data-api", ua = (ra = t).fn[la], ga = {
			...
			}, xa = "carousel", _a = "active", wa = "slide", Ca = "carousel-item-right", Ta = "carousel-item-left", Ea =
			"carousel-item-next", Sa = "carousel-item-prev", ka = {
				ACTIVE: ".active",
				...
				function a(n, t) {
					this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1,
						this.touchTimeout = null, this._config = this._getConfig(t), this._element = ra(n)[0], this._indicatorsElement =
						ra(this._element).find(ka.INDICATORS)[0], this._addEventListeners()
				}
				var e = a.prototype;
				return e.next = function() {
					this._isSliding || this._slide(ma)
				}, e.nextWhenVisible = function() {
					!document.hidden && ra(this._element).is(":visible") && "hidden" !== ra(this._element).css("visibility") && this
						.next()
				}, e.prev = function() {
					this._isSliding || this._slide(ha)
				}, e.pause = function(e) {
					e || (this._isPaused = !0), ra(this._element).find(ka.NEXT_PREV)[0] && (Hn.triggerTransitionEnd(this._element),
					...
					ra(this._element).off(ca), ra.removeData(this._element, da), this._items = null, this._config = null, this._element =
					...
					var e = this,
						...
						p = !!this._interval,
						c, g, m;
					if (d === ma ? (c = Ta, g = Ea, m = ba) : (c = Ca, g = Sa, m = ya), a && ra(a).hasClass(_a)) this._isSliding = !
						1;
						...
						if (ra(this._element).hasClass(wa)) {
							...
							ra(s).one(Hn.TRANSITION_END, function() {
								ra(a).removeClass(c + " " + g).addClass(_a), ra(s).removeClass(_a + " " + g + " " + c), e._isSliding = !1,
									setTimeout(function() {
			...
			}(), ra(document).on(va.CLICK_DATA_API, ka.DATA_SLIDE, Aa._dataApiClickHandler), ra(window).on(va.LOAD_DATA_API,
				function() {
		...
		An = (Da = "collapse", Pa = "." + (La = "bs.collapse"), Oa = (Ia = t).fn[Da], Na = {
			...
			function l(a, t) {
				this._isTransitioning = !1, this._element = a, this._config = this._getConfig(t), this._triggerArray = Ia.makeArray(
					Ia("[data-toggle=\"collapse\"][href=\"#" + a.id + "\"],[data-toggle=\"collapse\"][data-target=\"#" + a.id +
						"\"]"));
			...
			return e.toggle = function() {
				...
				var a = this,
					n, d;
				if (!this._isTransitioning && !Ia(this._element).hasClass(Ha) && (this._parent && 0 === (n = Ia.makeArray(Ia(
							this._parent).find(Ba.ACTIVES).filter("[data-parent=\"" + this._config.parent + "\"]"))).length && (n = null),
						!(n && (d = Ia(n).not(this._selector).data(La)) && d._isTransitioning))) {
					...
					if (Ia(this._element).trigger(c), !c.isDefaultPrevented()) {
						...
						Ia(this._element).removeClass(Wa).addClass(Ra), (this._element.style[i] = 0) < this._triggerArray.length && Ia(
							this._triggerArray).removeClass(za).attr("aria-expanded", !0), this.setTransitioning(!0);
						...
						Ia(this._element).one(Hn.TRANSITION_END, function() {
							Ia(a._element).removeClass(Ra).addClass(Wa).addClass(Ha), a._element.style[i] = "", a.setTransitioning(!1),
								Ia(a._element).trigger($a.SHOWN)
				...
				if (!this._isTransitioning && Ia(this._element).hasClass(Ha)) {
					...
					if (Ia(this._element).trigger(t), !t.isDefaultPrevented()) {
						...
						if (this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", Hn.reflow(this._element), Ia(
								this._element).addClass(Ra).removeClass(Wa).removeClass(Ha), 0 < this._triggerArray.length)
				...
				Ia.removeData(this._element, La), this._config = null, this._parent = null, this._element = null, this._triggerArray =
				...
				var a = this,
					n = null;
				Hn.isElement(this._config.parent) ? (n = this._config.parent, "undefined" != typeof this._config.parent.jquery &&
					(n = this._config.parent[0])) : n = Ia(this._config.parent)[0];
				...
				return this.each(function() {
					...
					if (!t && s.toggle && /show|hide/.test(a) && (s.toggle = !1), t || (t = new l(this, s), i.data(La, t)),
						"string" == typeof a) {
		...
		bn = (Xa = "dropdown", Va = "." + (Ua = "bs.dropdown"), Ka = ".data-api", Qa = (Ya = t).fn[Xa], Ga = /38|40|27/, Za = {
			...
			}, Ja = "disabled", eo = "show", to = "dropup", no = "dropright", ao = "dropleft", oo = "dropdown-menu-right", io =
			"position-static", so = "[data-toggle=\"dropdown\"]", ro = ".dropdown form", lo = ".dropdown-menu", co =
			".navbar-nav", po = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", uo = "top-start", go = "top-end",
			fo = "bottom-start", mo = "bottom-end", ho = "right-start", bo = "left-start", yo = {
				offset: 0,
				flip: !0,
				...
				function d(n, t) {
					this._element = n, this._popper = null, this._config = this._getConfig(t), this._menu = this._getMenuElement(),
				...
				return e.toggle = function() {
						...
						if (d._clearMenus(), !t) {
							...
							if (Ya(a).trigger(n), !n.isDefaultPrevented()) {
								if (!this._inNavbar) {
									...
									var o = this._element;
									"parent" === this._config.reference ? o = a : Hn.isElement(this._config.reference) && (o = this._config.reference,
											"undefined" != typeof this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !==
										this._config.boundary && Ya(a).addClass(io), this._popper = new Ln(o, this._menu, this._getPopperConfig())
								}
								"ontouchstart" in document.documentElement && 0 === Ya(a).closest(co).length && Ya(document.body).children().on(
									"mouseover", null, Ya.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), Ya(
									this._menu).toggleClass(eo), Ya(a).toggleClass(eo).trigger(Ya.Event(Za.SHOWN, e))
							}
						}
					}
				}, e.dispose = function() {
					Ya.removeData(this._element, Ua), Ya(this._element).off(Va), this._element = null, (this._menu = null) !== this._popper &&
					...
					return e = o({}, this.constructor.Default, Ya(this._element).data(), e), Hn.typeCheckConfig(Xa, e, this.constructor
						.DefaultType), e
					...
					var n = Ya(this._element).parent(),
						t = fo;
					return n.hasClass(to) ? (t = uo, Ya(this._menu).hasClass(oo) && (t = go)) : n.hasClass(no) ? t = ho : n.hasClass(
						ao) ? t = bo : Ya(this._menu).hasClass(oo) && (t = mo), t
					...
					if (!l || 3 !== l.which && ("keyup" !== l.type || 9 === l.which))
						for (var t = Ya.makeArray(Ya(so)), e = 0; e < t.length; e++) {
							...
							if (i) {
								var s = i._menu;
								if (Ya(c).hasClass(eo) && !(l && ("click" === l.type && /input|textarea/i.test(l.target.tagName) || "keyup" ===
										l.type && 9 === l.which) && Ya.contains(c, l.target))) {
									var o = Ya.Event(Za.HIDE, r);
									Ya(c).trigger(o), o.isDefaultPrevented() || ("ontouchstart" in document.documentElement && Ya(document.body)
										.children().off("mouseover", null, Ya.noop), t[e].setAttribute("aria-expanded", "false"), Ya(s).removeClass(
											eo), Ya(c).removeClass(eo).trigger(Ya.Event(Za.HIDDEN, r)))
								}
							}
						}
					...
					if ((/input|textarea/i.test(a.target.tagName) ? !(32 === a.which || 27 !== a.which && (40 !== a.which && 38 !==
							a.which || Ya(a.target).closest(lo).length)) : Ga.test(a.which)) && (a.preventDefault(), a.stopPropagation(),
							!this.disabled && !Ya(this).hasClass(Ja))) {
			...
			}(), Ya(document).on(Za.KEYDOWN_DATA_API, so, xo._dataApiKeydownHandler).on(Za.KEYDOWN_DATA_API, lo, xo._dataApiKeydownHandler)
			.on(Za.CLICK_DATA_API + " " + Za.KEYUP_DATA_API, xo._clearMenus).on(Za.CLICK_DATA_API, so, function(e) {
		...
		Sn = (wo = "modal", To = "." + (Co = "bs.modal"), Eo = (_o = t).fn[wo], So = {
			...
			function a(n, t) {
				this._config = this._getConfig(t), this._element = n, this._dialog = _o(n).find(No.DIALOG)[0], this._backdrop =
					null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._scrollbarWidth = 0
			}
			var e = a.prototype;
			return e.toggle = function(e) {
				...
				if (!this._isTransitioning && !this._isShown) {
					...
					_o(this._element).trigger(e), this._isShown || e.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(),
						this._setScrollbar(), this._adjustDialog(), _o(document.body).addClass(Lo), this._setEscapeEvent(), this._setResizeEvent(),
						_o(this._element).on(Ao.CLICK_DISMISS, No.DATA_DISMISS, function(e) {
							return o.hide(e)
				...
				if (a && a.preventDefault(), !this._isTransitioning && this._isShown) {
					...
					if (_o(this._element).trigger(e), this._isShown && !e.isDefaultPrevented()) {
						...
						if (t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), _o(document).off(Ao.FOCUSIN),
							_o(this._element).removeClass(Oo), _o(this._element).off(Ao.CLICK_DISMISS), _o(this._dialog).off(Ao.MOUSEDOWN_DISMISS),
							t) {
				...
				_o.removeData(this._element, Co), _o(window, document, this._element, this._backdrop).off(To), this._config =
				...
				this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(
					...
					.scrollTop = 0, e && Hn.reflow(this._element), _o(this._element).addClass(Oo), this._config.focus && this._enforceFocus();
				...
				if (this._isShown && this._config.backdrop) {
					if (this._backdrop = document.createElement("div"), this._backdrop.className = Do, e && _o(this._backdrop).addClass(
							e), _o(this._backdrop).appendTo(document.body), _o(this._element).on(Ao.CLICK_DISMISS, function(e) {
							o._ignoreBackdropClick ? o._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === o._config
								.backdrop ? o._element.focus() : o.hide())
		...
		wn = (Ho = "tooltip", Ro = "." + (Wo = "bs.tooltip"), zo = ($o = t).fn[Ho], Mo = "bs-tooltip", Fo = new RegExp(
				"(^|\\s)" + Mo + "\\S+", "g"), Yo = {
				animation: !0,
			...
			}, Ko = "fade", Qo = "show", Go = ".tooltip-inner", Zo = ".arrow", Jo = "hover", ei = "focus", ti = "click", ni =
			"manual", ai = function() {
				function e(n, t) {
					...
					this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._popper = null,
						this.element = n, this.config = this._getConfig(t), this.tip = null, this._setListeners()
				}
				var n = e.prototype;
				return n.enable = function() {
					...
					if (this._isEnabled)
						if (a) {
							...
							e || (e = new this.constructor(a.currentTarget, this._getDelegateConfig()), $o(a.currentTarget).data(t, e)), e
								._activeTrigger.click = !e._activeTrigger.click, e._isWithActiveTrigger() ? e._enter(null, e) : e._leave(null,
									e)
						} else {
					...
					clearTimeout(this._timeout), $o.removeData(this.element, this.constructor.DATA_KEY), $o(this.element).off(this.constructor
							.EVENT_KEY), $o(this.element).closest(".modal").off("hide.bs.modal"), this.tip && $o(this.tip).remove(), this._isEnabled =
					...
					if (this.isWithContent() && this._isEnabled) {
						...
						n.setAttribute("id", i), this.element.setAttribute("aria-describedby", i), this.setContent(), this.config.animation &&
							$o(n).addClass(Ko);
						var r = "function" == typeof this.config.placement ? this.config.placement.call(this, n, this.element) : this.config
							.placement,
							s = this._getAttachment(r);
						this.addAttachmentClass(s);
						var o = !1 === this.config.container ? document.body : $o(this.config.container);
						$o(n).data(this.constructor.DATA_KEY, this), $o.contains(this.element.ownerDocument.documentElement, this.tip) ||
							$o(n).appendTo(o), $o(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Ln(this.element,
								n, {
									placement: s,
									modifiers: {
										offset: {
								...
								}), $o(n).addClass(Qo), "ontouchstart" in document.documentElement && $o(document.body).children().on(
								"mouseover", null, $o.noop);
						var a = function() {
					...
					var t = this,
						...
						o = function() {
							t._hoverState !== Xo && e.parentNode && e.parentNode.removeChild(e), t._cleanTipClass(), t.element.removeAttribute(
									"aria-describedby"), $o(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(),
								a && a()
						};
					if ($o(this.element).trigger(n), !n.isDefaultPrevented()) {
						if ($o(e).removeClass(Qo), "ontouchstart" in document.documentElement && $o(document.body).children().off(
								"mouseover", null, $o.noop), this._activeTrigger[ti] = !1, this._activeTrigger[ei] = !1, this._activeTrigger[
								Jo] = !1, $o(this.tip).hasClass(Ko)) {
					...
					"object" == typeof t && (t.nodeType || t.jquery) ? e ? $o(t).parent().is(a) || a.empty().append(t) : a.text($o(t)
						.text()) : a[e ? "html" : "text"](t)
				}, n.getTitle = function() {
					...
					(this.element.getAttribute("title") || "string" != e) && (this.element.setAttribute("data-original-title", this.element
						.getAttribute("title") || ""), this.element.setAttribute("title", ""))
				}, n._enter = function(a, t) {
					var o = this.constructor.DATA_KEY;
					(t = t || $o(a.currentTarget).data(o)) || (t = new this.constructor(a.currentTarget, this._getDelegateConfig()),
						$o(a.currentTarget).data(o, t)), a && (t._activeTrigger["focusin" === a.type ? ei : Jo] = !0), $o(t.getTipElement())
						.hasClass(Qo) || t._hoverState === Xo ? t._hoverState = Xo : (clearTimeout(t._timeout), t._hoverState = Xo, t.config
							.delay && t.config.delay.show ? t._timeout = setTimeout(function() {
								t._hoverState === Xo && t.show()
							}, t.config.delay.show) : t.show())
				}, n._leave = function(a, t) {
					var o = this.constructor.DATA_KEY;
					(t = t || $o(a.currentTarget).data(o)) || (t = new this.constructor(a.currentTarget, this._getDelegateConfig()),
						$o(a.currentTarget).data(o, t)), a && (t._activeTrigger["focusout" === a.type ? ei : Jo] = !1), t._isWithActiveTrigger() ||
						(clearTimeout(t._timeout), t._hoverState = Uo, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(
							function() {
					...
					return "number" == typeof(e = o({}, this.constructor.Default, $o(this.element).data(), "object" == typeof e && e ?
						e : {})).delay && (e.delay = {
						show: e.delay,
						hide: e.delay
					}), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content =
						e.content.toString()), Hn.typeCheckConfig(Ho, e, this.constructor.DefaultType), e
					...
					null === n.getAttribute("x-placement") && ($o(n).removeClass(Ko), this.config.animation = !1, this.hide(), this.show(),
						this.config.animation = t)
				}, e._jQueryInterface = function(a) {
					return this.each(function() {
						var n = $o(this).data(Wo);
						if ((n || !/dispose|hide/.test(a)) && (n || (n = new e(this, "object" == typeof a && a), $o(this).data(Wo, n)),
								"string" == typeof a)) {
		...
		In = (ii = "popover", ri = "." + (si = "bs.popover"), li = (oi = t).fn[ii], di = "bs-popover", ci = new RegExp(
			"(^|\\s)" + di + "\\S+", "g"), pi = o({}, wn.Default, {
			placement: "right",
			trigger: "click",
			content: "",
			...
			return s.isWithContent = function() {
				...
				"function" == typeof t && (t = t.call(this.element)), this.setElementContent(n.find(hi), t), n.removeClass(gi +
					" " + fi)
		...
		Dn = (xi = "scrollspy", wi = "." + (_i = "bs.scrollspy"), Ci = (vi = t).fn[xi], Ti = {
			...
			function a(a, t) {
				var e = this;
				this._element = a, this._scrollElement = "BODY" === a.tagName ? window : a, this._config = this._getConfig(t),
					this._selector = this._config.target + " " + Ii.NAV_LINKS + "," + this._config.target + " " + Ii.LIST_ITEMS +
					"," + this._config.target + " " + Ii.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget =
					null, this._scrollHeight = 0, vi(this._scrollElement).on(Si.SCROLL, function(n) {
						return e._process(n)
			...
			return e.refresh = function() {
				...
				this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), vi.makeArray(vi(this._selector))
					.map(function(o) {
				...
				vi.removeData(this._element, _i), vi(this._scrollElement).off(wi), this._element = null, this._scrollElement =
				...
				if (this._scrollHeight !== t && this.refresh(), e <= a) {
					...
					if (this._activeTarget && a < this._offsets[0] && 0 < this._offsets[0]) return this._activeTarget = null, void this
						._clear();
					for (var o = this._offsets.length; o--;) this._activeTarget !== this._targets[o] && a >= this._offsets[o] && (
						"undefined" == typeof this._offsets[o + 1] || a < this._offsets[o + 1]) && this._activate(this._targets[o])
				}
				...
				var o = vi(e.join(","));
				o.hasClass(ki) ? (o.closest(Ii.DROPDOWN).find(Ii.DROPDOWN_TOGGLE).addClass(Ai), o.addClass(Ai)) : (o.addClass(Ai),
					o.parents(Ii.NAV_LIST_GROUP).prev(Ii.NAV_LINKS + ", " + Ii.LIST_ITEMS).addClass(Ai), o.parents(Ii.NAV_LIST_GROUP)
					.prev(Ii.NAV_ITEMS).children(Ii.NAV_LINKS).addClass(Ai)), vi(this._scrollElement).trigger(Si.ACTIVATE, {
					relatedTarget: a
				})
			}, e._clear = function() {
		...
		kn = (ji = "." + (Ni = "bs.tab"), $i = (Oi = t).fn.tab, Hi = {
			...
			}, Wi = "dropdown-menu", Ri = "active", zi = "disabled", Mi = "fade", Fi = "show", Bi = ".dropdown", qi =
			".nav, .list-group", Yi = ".active", Xi = "> li > .active", Ui =
			...
			"> .dropdown-menu .active", Qi = function() {
				...
				return e.show = function() {
					var d = this;
					if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Oi(this._element).hasClass(
							Ri) || Oi(this._element).hasClass(zi))) {
					...
					if (Oi(a).addClass(Ri), "tab" === a.getAttribute("role") && a.setAttribute("aria-selected", !0), Hn.reflow(a),
						Oi(a).addClass(Fi), a.parentNode && Oi(a.parentNode).hasClass(Wi)) {
		...
		Pn, On, Nn, Wn, Rn, zn, Mn, Fn, Bn, qn, Yn, Xn, Un, Vn, Kn, Qn, Gn, Zn, Jn, ea, ta, na, aa, oa, ia, sa, ra, la, da,
		ca, pa, ua, ga, fa, ma, ha, ba, ya, va, xa, _a, wa, Ca, Ta, Ea, Sa, ka, Aa, Ia, Da, La, Pa, Oa, Na, ja, $a, Ha, Wa,
		Ra, za, Ma, Fa, Ba, qa, Ya, Xa, Ua, Va, Ka, Qa, Ga, Za, Ja, eo, to, no, ao, oo, io, so, ro, lo, co, po, uo, go, fo,
		mo, ho, bo, yo, vo, xo, _o, wo, Co, To, Eo, So, ko, Ao, Io, Do, Lo, Po, Oo, No, jo, $o, Ho, Wo, Ro, zo, Mo, Fo, Bo,
		qo, Yo, Xo, Uo, Vo, Ko, Qo, Go, Zo, Jo, ei, ti, ni, ai, oi, ii, si, ri, li, di, ci, pi, ui, gi, fi, mi, hi, bi, yi,
		vi, xi, _i, wi, Ci, Ti, Ei, Si, ki, Ai, Ii, Di, Li, Pi, Oi, Ni, ji, $i, Hi, Wi, Ri, zi, Mi, Fi, Bi, qi, Yi, Xi, Ui,
		Vi, Ki, Qi;
	! function(n) {
	...
	}(t), xn.Util = Hn, xn.Alert = i, xn.Button = h, xn.Carousel = Cn, xn.Collapse = An, xn.Dropdown = bn, xn.Modal = Sn,
		xn.Popover = In, xn.Scrollspy = Dn, xn.Tab = kn, xn.Tooltip = wn, Object.defineProperty(xn, "__esModule", {
			value: !0
		})
});
var $jscomp = {
...
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(t, e, n) {
	...
	t || (t = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol("iterator")), "function" != typeof Array.prototype[t] &&
...
(function(t, e) {
	"function" == typeof define && define.amd ? define([], e) : "object" == typeof module && module.exports ? module.exports =
		e() : t.anime = e()
})(this, function() {
	function t(e) {
		if (!W.col(e)) try {
	...
	function n(e) {
		return W.arr(e) ? e : (W.str(e) && (e = t(e) || e), e instanceof NodeList || e instanceof HTMLCollection ? [].slice.call(
			e) : [e])
	}
	...
	function u(e) {
		function t(e, t, n) {
			return 0 > n && (n += 1), 1 < n && --n, n < 1 / 6 ? e + 6 * (t - e) * n : .5 > n ? t : n < 2 / 3 ? e + 6 * ((t - e) *
				(2 / 3 - n)) : e
		}
		var o = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(e) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(
			e);
		e = parseInt(o[1]) / 360;
	...
	function m(e) {
		return -1 < e.indexOf("translate") || "perspective" === e ? "px" : -1 < e.indexOf("rotate") || -1 < e.indexOf("skew") ?
			"deg" : void 0
	}
	...
	function f(e, t) {
		if (t in e.style) return getComputedStyle(e).getPropertyValue(t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()) ||
			"0"
	}

	function x(e, t) {
		return W.dom(e) && i(S, t) ? "transform" : W.dom(e) && (e.getAttribute(t) || W.svg(e) && e[t]) ? "attribute" : W.dom(
			e) && "transform" !== t && f(e, t) ? "css" : null == e[t] ? void 0 : "object"
	}
	...
	function E(e, t) {
		var n = /-?\d*\.?\d+/g,
			a;
		if (a = W.pth(e) ? e.totalLength : e, !W.col(a)) o = (o = g(a)) ? a.substr(0, a.length - o.length) : a, a = t && !
			/\s/g.test(a) ? o + t : o;
		else if (W.rgb(a)) {
	...
	function P(t, n) {
		...
		return t.tweens.map(function(o) {
			...
			var i = o.value,
				...
				l = C(W.arr(i) ? i[1] : i, r),
				s = g(l) || g(r) || g(s);
			return o.from = E(r, s), o.to = E(l, s), o.start = a ? a.end : t.offset, o.end = o.start + o.delay + o.duration,
				o.easing = L(o.easing), o.elasticity = (1E3 - Math.min(Math.max(o.elasticity, 1), 999)) / 1E3, o.isPath = W.pth(
					i), o.isColor = W.col(o.from.original), o.isColor && (o.round = 1), a = o
		})
	}
	...
	function R(n) {
		...
		function d(i) {
			for (var s = 0, r = {}, c = T.animations, u = c.length; s < u;) {
				...
				for (var y = Math.min(Math.max(i - _.start - _.delay, 0), _.duration) / _.duration, C = isNaN(y) ? 1 : _.easing(y,
						_.elasticity), y = _.to.strings, E = _.round, v = [], S = void 0, S = _.to.numbers.length, k = 0; k < S; k++) {
					var A = void 0,
						A = _.to.numbers[k],
						I = _.from.numbers[k],
			...
			if (s = Object.keys(r).length)
				for (c = 0; c < s; c++) X || (X = f(document.body, "transform") ? "transform" : "-webkit-transform"), T.animatables[
					c].target.style[X] = r[c].join(" ");
		...
		function e(e) {
			...
			if (T.children.length) {
				...
				if (l >= T.currentTime)
					...
					for (; u--;) p[u].seek(l)
			}(l >= n || !t) && (T.began || (T.began = !0, c("begin")), c("run")), l > a && l < t ? d(l) : (l <= a && 0 !== o &&
				(d(0), r && b()), l >= t && o !== t || !t) && (d(t), r || b()), c("update"), e >= t && (T.remaining ? (E = g,
				"alternate" === T.direction && (T.reversed = !T.reversed)) : (T.pause(), T.completed || (T.completed = !0, c(
				"complete"), "Promise" in window && (_(), C = i()))), y = 0)
		}
		n = void 0 === n ? {} : n;
		var y = 0,
			_ = null,
		...
		return T.reset = function() {
			var e = T.direction,
				t = T.loop;
			for (T.currentTime = 0, T.progress = 0, T.paused = !0, T.began = !1, T.completed = !1, T.reversed = "reverse" ===
				e, T.remaining = "alternate" === e && 1 === t ? 2 : t, d(0), e = T.children.length; e--;) T.children[e].reset()
		}, T.tick = function(t) {
	...
	var z = {
			...
			return function(a, o, i, s) {
				if (0 <= a && 1 >= a && 0 <= i && 1 >= i) {
					...
					return function(e) {
						...
						if (.001 <= p) {
							for (d = 0; 4 > d && (p = 3 * (1 - 3 * i + 3 * a) * c * c + 2 * (3 * i - 6 * a) * c + 3 * a, 0 != p); ++d) var
								u = t(c, a, i) - e,
								c = c - u / p;
							e = c
						} else if (0 == p) e = c;
		...
		A = function() {
			function t(e, t) {
				return 0 === e || 1 === e ? e : -Math.pow(2, 10 * (e - 1)) * Math.sin(2 * (e - 1 - t / (2 * Math.PI) * Math.asin(1)) *
					Math.PI / t)
			}
	...
	return R.version = "2.2.0", R.speed = 1, R.running = q, R.remove = function(e) {
		...
		for (var t = q.length; t--;)
			for (var n = q[t], o = n.animations, s = o.length; s--;) i(e, o[s].animatable.target) && (o.splice(s, 1), o.length ||
				n.pause())
		...
		return a.pause(), a.duration = 0, a.add = function(e) {
			return a.children.forEach(function(e) {
				...
				var i = o.offset;
				o.autoplay = !1, o.direction = a.direction, o.offset = W.und(i) ? n : C(i, n), a.began = !0, a.completed = !0,
					a.seek(o.offset), o = R(o), o.began = !0, o.completed = !0, o.duration > n && (a.duration = o.duration), a.children
					.push(o)
	...
	"function" == typeof define && define.amd ? define("ev-emitter/ev-emitter", e) : "object" == typeof module && module.exports ?
		module.exports = e() : n.EvEmitter = e()
	...
	return e.on = function(a, e) {
		...
		if (l && l.length) {
			var i = 0,
				d = l[i];
			e = e || [];
			for (var c = this._onceEvents && this._onceEvents[a], r; d;) r = c && c[d], r && (this.off(a, d), delete c[d]), d.apply(
				this, e), i += r ? 0 : 1, d = l[i];
			return this
		}
...
function(n, e) {
	...
	"function" == typeof define && define.amd ? define(["ev-emitter/ev-emitter"], function(t) {
		return e(n, t)
	}) : "object" == typeof module && module.exports ? module.exports = e(n, require("ev-emitter")) : n.imagesLoaded = e(
		n, n.EvEmitter)
	...
	function n(a, o, t) {
		return this instanceof n ? ("string" == typeof a && (a = document.querySelectorAll(a)), this.elements = i(a), this.options =
			c({}, this.options), "function" == typeof o ? t = o : c(this.options, o), t && this.on("always", t), this.getImages(),
			s && (this.jqDeferred = new s.Deferred), void setTimeout(function() {
				this.check()
	...
	return n.prototype.addElementBackgroundImages = function(a) {
		...
		if (e)
			for (var t = /url\((['"])?(.*?)\1\)/gi, i = t.exec(e.backgroundImage), s; null !== i;) s = i && i[2], s && this.addBackground(
				s, a), i = t.exec(e.backgroundImage)
		...
		this.progressedCount++, this.hasAnyBroken = this.hasAnyBroken || !n.isLoaded, this.emitEvent("progress", [this, n,
				e
			]), this.jqDeferred && this.jqDeferred.notify && this.jqDeferred.notify(this, n), this.progressedCount == this.images
			.length && this.complete(), this.options.debug && p && p.log("progress: " + t, n, e)
		...
		return t ? void this.confirm(0 !== this.img.naturalWidth, "naturalWidth") : (this.proxyImage = new Image, this.proxyImage
	...
	if (_.getElementsByClassName) {
		...
		var L = function() {
				var n = /^img$/i,
					...
					R = function(e) {
						return null == de && (de = "hidden" == m(_.body, "visibility")), de || "hidden" != m(e.parentNode, "visibility") &&
					...
					S = function(e, t) {
						var n = e,
							a = R(e),
							o;
						for (ie -= t, le += t, se -= t, re += t; a && (n = n.offsetParent) && n != _.body && n != b;)(a = 0 < (m(n,
							"opacity") || 1)) && "visible" != m(n, "overflow") && (o = n.getBoundingClientRect(), a = re > o.left && se <
							o.right && le > o.top - 1 && ie < o.bottom + 1);
						return a
					},
					a = function() {
						var e = C.elements,
						...
						if ((te = A.loadMode) && 8 > L && (o = e.length)) {
							for (i = 0, N++, w = !A.expand || 1 > A.expand ? 500 < b.clientHeight && 500 < b.clientWidth ? 500 : 370 : A.expand,
								C._defEx = w, T = w * A.expFactor, I = A.hFac, de = null, E < T && 1 > L && 2 < N && 2 < te && !_.hidden ? (E =
									T, N = 0) : E = 1 < te && 1 < N && 6 > L ? w : 0; i < o; i++)
								if (e[i] && !e[i]._lazyRace)
									if (!c) U(e[i]);
									else if (!((v = e[i].getAttribute("data-expand")) && (g = 1 * v) || (g = E), x !== g && (ae = innerWidth + g *
									I, oe = innerHeight + g, y = -1 * g, x = g), l = e[i].getBoundingClientRect(), (le = l.bottom) >= y && (ie =
									l.top) <= oe && (re = l.right) >= y * I && (se = l.left) <= ae && (le || re || se || ie) && (A.loadHidden ||
									R(e[i])) && (Z && 3 > L && !v && (3 > te || 4 > N) || S(e[i], g)))) !u && Z && !d && 4 > L && 4 > N && 2 < te &&
								(K[0] || A.preloadAfterLoad) && (K[0] || !v && (le || re || se || ie || "auto" != e[i].getAttribute(A.sizesAttr))) &&
								(d = K[0] || e[i]);
					...
					M = function(e) {
						var n = e.target;
						return n._lazyCache ? void delete n._lazyCache : void(z(e), r(n, A.loadedClass), s(n, A.loadingClass), t(n, B),
							u(n, "lazyloaded"))
					},
					W = x(M),
					B = function(e) {
					...
					Y = function(e) {
						var t = e.getAttribute(A.srcsetAttr),
							n;
						(n = A.customMedia[e.getAttribute("data-media") || e.getAttribute("media")]) && e.setAttribute("media", n), t &&
							e.setAttribute("srcset", t)
					},
					X = x(function(n, a, i, c, e) {
						var f, m, b, x, _, w;
						(_ = u(n, "lazybeforeunveil", a)).defaultPrevented || (c && (i ? r(n, A.autosizesClass) : n.setAttribute(
								"sizes", c)), m = n.getAttribute(A.srcsetAttr), f = n.getAttribute(A.srcAttr), e && (b = n.parentNode, x = b &&
								k.test(b.nodeName || "")), w = a.firesLoad || "src" in n && (m || f || x), _ = {
								target: n
							}, r(n, A.loadingClass), w && (clearTimeout(ee), ee = T(z, 2500), t(n, B, !0)), x && I.call(b.getElementsByTagName(
								"source"), Y), m ? n.setAttribute("srcset", m) : f && !x && (d.test(n.nodeName) ? q(n, f) : n.src = f), e &&
							(m || x) && v(n, {
								src: f
					...
					U = function(t) {
						var a = n.test(t.nodeName),
							...
							e = "auto" == o,
							i;
						(e || !Z) && a && (t.getAttribute("src") || t.srcset) && !t.complete && !p(t, A.errorClass) && p(t, A.lazyClass) ||
							(i = u(t, "lazyunveilread").detail, e && D.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, L++, X(t, i, e,
								o, a))
					},
					V = function() {
						if (!Z) {
				...
				return {
					_: function() {
						ne = h.now(), C.elements = _.getElementsByClassName(A.lazyClass), K = _.getElementsByClassName(A.lazyClass +
								" " + A.preloadClass), e("scroll", j, !0), e("resize", j, !0), i.MutationObserver ? new MutationObserver(j).observe(
								b, {
									childList: !0,
									subtree: !0,
									attributes: !0
								}) : (b.addEventListener("DOMNodeInserted", j, !0), b.addEventListener("DOMAttrModified", j, !0), setInterval(
								j, 999)), e("hashchange", j, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend",
								"webkitAnimationEnd"
							].forEach(function(e) {
								_.addEventListener(e, j, !0)
							}), /d$|^c/.test(_.readyState) ? V() : (e("load", V), _.addEventListener("DOMContentLoaded", j), T(V, 2e4)), C
							.elements.length ? (a(), y._lsFlush()) : j()
					},
					checkElems: j,
					unveil: U
				}
	...
	function s(e, n) {
		this.settings = null, this.options = t.extend({}, s.Defaults, n), this.$element = t(e), this._handlers = {}, this._plugins = {},
	...
	s.Defaults = {
		...
		run: function(t) {
			...
			for (t.items = {
					merge: !1,
					width: n
				}; o--;) a = this._mergers[o], a = this.settings.mergeFit && Math.min(a, this.settings.items) || a, t.items.merge =
				1 < a || t.items.merge, e[o] = i ? n * a : this._items[o].width();
			this._widths = e
		}
	}, {
		filter: ["items", "settings"],
		run: function() {
			var n = [],
				...
				l = "",
				d = "";
			for (r /= 2; 0 < r;) n.push(this.normalize(n.length / 2, !0)), l += a[n[n.length - 1]][0].outerHTML, n.push(this.normalize(
				a.length - 1 - (n.length - 1) / 2, !0)), d = a[n[n.length - 1]][0].outerHTML + d, r -= 1;
			this._clones = n, t(l).addClass("cloned").appendTo(this.$stage), t(d).addClass("cloned").prependTo(this.$stage)
		}
	}, {
		filter: ["width", "items", "settings"],
		run: function() {
			for (var t = this.settings.rtl ? 1 : -1, n = this._clones.length + this._items.length, a = -1, o = 0, i = 0, s = []; ++
				a < n;) o = s[a - 1] || 0, i = this._widths[this.relative(a)] + this.settings.margin, s.push(o + i * t);
			this._coordinates = s
		}
	}, {
		filter: ["width", "items", "settings"],
		...
		filter: ["width", "items", "settings"],
		run: function(e) {
			e.current = e.current ? this.$stage.children().index(e.current) : 0, e.current = Math.max(this.minimum(), Math.min(
				this.maximum(), e.current)), this.reset(e.current)
		}
	}, {
		filter: ["position"],
		run: function() {
		...
		run: function() {
			var t = this.settings.rtl ? 1 : -1,
				...
				s = [],
				i, r, l, p;
			for (l = 0, p = this._coordinates.length; l < p; l++) i = this._coordinates[l - 1] || 0, r = Math.abs(this._coordinates[
				l]) + e * t, (this.op(i, "<=", n) && this.op(i, ">", o) || this.op(r, "<", n) && this.op(r, ">", o)) && s.push(
				l);
			this.$stage.children(".active").removeClass("active"), this.$stage.children(":eq(" + s.join("), :eq(") + ")").addClass(
		...
		this.$stage = this.$element.find("." + this.settings.stageClass), this.$stage.length || (this.$element.addClass(this
			.options.loadingClass), this.$stage = t("<" + this.settings.stageElement + ">", {
		...
		return e.length ? (this._items = e.get().map(function(e) {
			...
			return 1
		}), void this.refresh()) : void(this.replace(this.$element.children().not(this.$stage.parent())), this.isVisible() ?
			this.refresh() : this.invalidate("width"), this.$element.removeClass(this.options.loadingClass).addClass(this.options
				.loadedClass))
		...
		if (this.enter("initializing"), this.trigger("initialize"), this.$element.toggleClass(this.settings.rtlClass, this.settings
			...
			var e, t, n;
			e = this.$element.find("img"), t = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector : o, n =
				this.$element.children(t).width(), e.length && 0 >= n && this.preloadAutoWidthImages(e)
		}
		...
		a ? (t.each(a, function(e) {
				e <= n && e > o && (o = +e)
			}), i = t.extend({}, this.options, a[o]), "function" == typeof i.stagePadding && (i.stagePadding = i.stagePadding()),
			delete i.responsive, i.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp(
				"(" + this.options.responsiveClass + "-)\\S+\\s", "g"), "$1" + o))) : i = t.extend({}, this.options), this.trigger(
			"change", {
				property: {
					name: "settings",
					value: i
		...
		for (var n = 0, a = this._pipe.length, o = t.proxy(function(e) {
				return this[e]
			}, this._invalidated), i = {}; n < a;)(this._invalidated.all || 0 < t.grep(this._pipe[n].filter, o).length) && this
			._pipe[n].run(i), n++;
		...
		return !!this._items.length && this._width !== this.$element.width() && !!this.isVisible() && (this.enter("resizing"),
			this.trigger("resize").isDefaultPrevented() ? (this.leave("resizing"), !1) : (this.invalidate("width"), this.refresh(),
				this.leave("resizing"), void this.trigger("resized")))
	}, s.prototype.registerEventHandlers = function() {
		t.support.transition && this.$stage.on(t.support.transition.end + ".owl.core", t.proxy(this.onTransitionEnd, this)),
			!1 !== this.settings.responsive && this.on(n, "resize", this._handlers.onThrottledResize), this.settings.mouseDrag &&
			(this.$element.addClass(this.options.dragClass), this.$stage.on("mousedown.owl.core", t.proxy(this.onDragStart,
				this)), this.$stage.on("dragstart.owl.core selectstart.owl.core", function() {
				return !1
			})), this.settings.touchDrag && (this.$stage.on("touchstart.owl.core", t.proxy(this.onDragStart, this)), this.$stage
				.on("touchcancel.owl.core", t.proxy(this.onDragEnd, this)))
		...
		3 !== e.which && (t.support.transform ? (n = this.$stage.css("transform").replace(/.*\(|\)| /g, "").split(","), n = {
				...
				y: n.top
			}), this.is("animating") && (t.support.transform ? this.animate(n.x) : this.$stage.stop(), this.invalidate(
				"position")), this.$element.toggleClass(this.options.grabClass, "mousedown" === e.type), this.speed(0), this._drag
			.time = new Date().getTime(), this._drag.target = t(e.target), this._drag.stage.start = n, this._drag.stage.current =
			n, this._drag.pointer = this.pointer(e), t(a).on("mouseup.owl.core touchend.owl.core", t.proxy(this.onDragEnd,
				this)), t(a).one("mousemove.owl.core touchmove.owl.core", t.proxy(function(e) {
				var n = this.difference(this._drag.pointer, this.pointer(e));
				t(a).on("mousemove.owl.core touchmove.owl.core", t.proxy(this.onDragMove, this)), Math.abs(n.x) < Math.abs(n.y) &&
					this.is("valid") || (e.preventDefault(), this.enter("dragging"), this.trigger("drag"))
			}, this)))
		...
		this.is("dragging") && (t.preventDefault(), this.settings.loop ? (n = this.coordinates(this.minimum()), a = this.coordinates(
				this.maximum() + 1) - n, e.x = ((e.x - n) % a + a) % a + n) : (n = this.settings.rtl ? this.coordinates(this.maximum()) :
				this.coordinates(this.minimum()), a = this.settings.rtl ? this.coordinates(this.minimum()) : this.coordinates(
					this.maximum()), o = this.settings.pullDrag ? -1 * i.x / 5 : 0, e.x = Math.max(Math.min(e.x, n + o), a + o)),
			this._drag.stage.current = e, this.animate(e.x))
		...
		t(a).off(".owl.core"), this.$element.removeClass(this.options.grabClass), (0 !== o.x && this.is("dragging") || !this
			.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(this.closest(i.x,
			0 === o.x ? this._drag.direction : e)), this.invalidate("position"), this.update(), this._drag.direction = e, (3 <
			Math.abs(o.x) || 300 < new Date().getTime() - this._drag.time) && this._drag.target.one("click.owl.core",
			function() {
				return !1
		...
		return this.settings.freeDrag || t.each(d, t.proxy(function(e, t) {
			return "left" === s && n > t - 30 && n < t + 30 ? r = e : "right" === s && n > t - l - 30 && n < t - l + 30 ? r =
				e + 1 : this.op(n, "<", t) && this.op(n, ">", d[e + 1] === o ? t - l : d[e + 1]) && (r = "left" === s ? e + 1 :
					e), -1 === r
		}, this)), this.settings.loop || (this.op(n, ">", d[this.minimum()]) ? r = n = this.minimum() : this.op(n, "<", d[
			this.maximum()]) && (r = n = this.maximum())), r
	}, s.prototype.animate = function(e) {
		var n = 0 < this.speed();
		this.is("animating") && this.onTransitionEnd(), n && (this.enter("animating"), this.trigger("translate")), t.support
			.transform3d && t.support.transition ? this.$stage.css({
		...
		if (e = this.normalize(e), this._current !== e) {
			...
			t.data !== o && (e = this.normalize(t.data)), this._current = e, this.invalidate("position"), this.trigger(
				"changed", {
					property: {
						name: "position",
						value: this._current
		...
		return "string" === t.type(e) && (this._invalidated[e] = !0, this.is("valid") && this.leave("valid")), t.map(this._invalidated,
			function(e, t) {
				return t
			})
	}, s.prototype.reset = function(e) {
		(e = this.normalize(e)) !== o && (this._speed = 0, this._current = e, this.suppress(["translate", "translated"]),
		...
		if (n.loop) e = this._clones.length / 2 + this._items.length - 1;
			...
			if (a = this._items.length)
				for (o = this._items[--a].width(), i = this.$element.width(); a-- && !((o += this._items[a].width() + this.settings
						.margin) > i););
			e = a + 1
		...
		}, this)) : (this.settings.center ? (this.settings.rtl && (a = -1, i = n + 1), s = this._coordinates[n], s += (this
			.width() - s + (this._coordinates[i] || 0)) / 2 * a) : s = this._coordinates[i] || 0, s = Math.ceil(s))
		...
		var o = this.current(),
			...
			u = this.minimum(),
			g = this.maximum();
		this.settings.loop ? (!this.settings.rewind && Math.abs(r) > p / 2 && (r += -1 * l * p), t = o + r, (s = ((t - u) %
				p + p) % p + u) !== t && s - r <= g && 0 < s - r && (o = s - r, t = s, this.reset(o))) : this.settings.rewind ? (g +=
				1, t = (t % g + g) % g) : t = Math.max(u, Math.min(g, t)), this.speed(this.duration(o, t, n)), this.current(t),
		...
		return !(e !== o && (e.stopPropagation(), (e.target || e.srcElement || e.originalTarget) !== this.$stage.get(0))) &&
			void(this.leave("animating"), this.trigger("translated"))
	}, s.prototype.viewport = function() {
		var e;
		return this.options.responsiveBaseElement === n ? n.innerWidth ? e = n.innerWidth : a.documentElement && a.documentElement
			.clientWidth ? e = a.documentElement.clientWidth : console.warn("Can not detect viewport width.") : e = t(this.options
				.responsiveBaseElement).width(), e
		...
		this.$stage.empty(), this._items = [], e && (e = e instanceof jQuery ? e : t(e)), this.settings.nestedItemSelector &&
			(e = e.find("." + this.settings.nestedItemSelector)), e.filter(function() {
				...
				t = this.prepare(t), this.$stage.append(t), this._items.push(t), this._mergers.push(1 * t.find("[data-merge]").addBack(
		...
		a = a === o ? this._items.length : this.normalize(a, !0), n = n instanceof jQuery ? n : t(n), this.trigger("add", {
				content: n,
				position: a
			}), n = this.prepare(n), 0 === this._items.length || a === this._items.length ? (0 === this._items.length && this.$stage
				.append(n), 0 !== this._items.length && this._items[a - 1].after(n), this._items.push(n), this._mergers.push(1 * n
					.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)) : (this._items[a].before(n), this._items.splice(
				a, 0, n), this._mergers.splice(a, 0, 1 * n.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)),
		...
		(e = this.normalize(e, !0)) !== o && (this.trigger("remove", {
			...
			position: e
		}), this._items[e].remove(), this._items.splice(e, 1), this._mergers.splice(e, 1), this.invalidate("items"), this.trigger(
			"removed", {
				content: null,
				position: e
			}))
		...
		e.each(t.proxy(function(e, n) {
			this.enter("pre-loading"), n = t(n), t(new Image).one("load", t.proxy(function(e) {
				n.attr("src", e.target.src), n.css("opacity", 1), this.leave("pre-loading"), this.is("pre-loading") || this.is(
					"initializing") || this.refresh()
			}, this)).attr("src", n.attr("src") || n.attr("data-src") || n.attr("data-src-retina"))
		}, this))
	}, s.prototype.destroy = function() {
		for (var e in this.$element.off(".owl.core"), this.$stage.off(".owl.core"), t(a).off(".owl.core"), !1 !== this.settings
				.responsive && (n.clearTimeout(this.resizeTimer), this.off(n, "resize", this._handlers.onThrottledResize)), this._plugins)
		...
		return this._supress[e] || (t.each(this._plugins, function(e, t) {
			...
			type: s.Type.Event,
			name: e
		}), this.$element.trigger(i), this.settings && "function" == typeof this.settings[r] && this.settings[r].call(this,
			i)), i
		...
		if (!(e.type === s.Type.Event)) e.type === s.Type.State && (this._states.tags[e.name] = this._states.tags[e.name] ?
			this._states.tags[e.name].concat(e.tags) : e.tags, this._states.tags[e.name] = t.grep(this._states.tags[e.name], t
				.proxy(function(n, a) {
			...
			t.event.special[e.name]._default = function(e) {
				return n && n.apply && (!e.namespace || -1 === e.namespace.indexOf("owl")) ? n.apply(this, arguments) : e.namespace &&
		...
		return e = e.originalEvent || e || n.event, e = e.touches && e.touches.length ? e.touches[0] : e.changedTouches && e
			.changedTouches.length ? e.changedTouches[0] : e, e.pageX ? (t.x = e.pageX, t.y = e.pageY) : (t.x = e.clientX, t.y =
				e.clientY), t
		...
		return this.each(function() {
			...
			o || (o = new s(this, "object" == typeof e && e), a.data("owl.carousel", o), t.each(["next", "prev", "to",
				...
				o.register({
					...
					e.namespace && e.relatedTarget !== this && (this.suppress([n]), o[n].apply(this, [].slice.call(arguments,
						1)), this.release([n]))
				}, o))
...
function(t, n) {
	...
	a.Defaults = {
		...
		this._interval || (this._visible = this._core.isVisible(), this._interval = n.setInterval(t.proxy(this.refresh, this),
	...
	var i = function(e) {
		this._core = e, this._loaded = [], this._handlers = {
			"initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function(n) {
				if (n.namespace && this._core.settings && this._core.settings.lazyLoad && (n.property && "position" == n.property
						.name || "initialized" == n.type)) {
					...
					for (0 < a.lazyLoadEager && (s += a.lazyLoadEager, a.loop && (l -= a.lazyLoadEager, s++)); r++ < s;) this.load(
						d / 2 + this._core.relative(l)), d && t.each(this._core.clones(this._core.relative(l)), c), l++
				}
			}, this)
...
function(t, n) {
	var a = function(e) {
		this._core = e, this._previousHeight = null, this._handlers = {
				...
				"loaded.owl.lazy": t.proxy(function(e) {
					e.namespace && this._core.settings.autoHeight && e.element.closest("." + this._core.settings.itemClass).index() ===
						this._core.current() && this.update()
				}, this)
			}, this._core.options = t.extend({}, a.Defaults, this._core.options), this._core.$element.on(this._handlers), this._intervalId =
			null;
		var o = this;
		t(n).on("load", function() {
			o._core.settings.autoHeight && o.update()
		}), t(n).resize(function() {
			o._core.settings.autoHeight && (null != o._intervalId && clearTimeout(o._intervalId), o._intervalId = setTimeout(
				function() {
					o.update()
				}, 250))
		})
	...
	a.Defaults = {
		...
		t.each(i, function(n, a) {
				e.push(t(a).height())
			}), s = Math.max.apply(null, e), 1 >= s && o && this._previousHeight && (s = this._previousHeight), this._previousHeight =
			s, this._core.$stage.parent().height(s).addClass(this._core.settings.autoHeightClass)
	}, a.prototype.destroy = function() {
		var e, t;
...
function(t, n, a) {
	var o = function(e) {
		this._core = e, this._videos = {}, this._playing = null, this._handlers = {
			...
			}, this._core.options = t.extend({}, o.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core
			.$element.on("click.owl.video", ".owl-video-play-icon", t.proxy(function(e) {
				this.play(e)
			}, this))
	};
	o.Defaults = {
		...
		return (n.wrap(t("<div/>", {
				...
				style: o
			})), this._core.settings.lazyLoad && (r = "data-src", p = "owl-lazy"), s.length) ? (c(s.attr(r)), s.remove(), !1) :
			void("youtube" === a.type ? (m = "//img.youtube.com/vi/" + a.id + "/hqdefault.jpg", c(m)) : "vimeo" === a.type ? t.ajax({
				type: "GET",
		...
		var a = t(n.target),
			...
			l;
		this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), o = this._core.items(this._core
			.relative(o.index())), this._core.reset(o.index()), l = t(
			"<iframe frameborder=\"0\" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>"), l.attr("height",
			r), l.attr("width", s), "youtube" === i.type ? l.attr("src", "//www.youtube.com/embed/" + i.id +
			"?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? l.attr("src", "//player.vimeo.com/video/" + i.id +
			"?autoplay=1") : "vzaar" === i.type && l.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), t(l).wrap(
			"<div class=\"owl-video-frame\" />").insertAfter(o.find(".owl-video")), this._playing = o.addClass(
			"owl-video-playing"))
...
function(t, n, a, o) {
	var i = function(e) {
		this.core = e, this.core.options = t.extend({}, i.Defaults, this.core.options), this.swapping = !0, this.previous =
			o, this.next = o, this.handlers = {
	...
	i.Defaults = {
		...
		if (1 === this.core.settings.items && t.support.animation && t.support.transition) {
			...
			var n = t.proxy(this.clear, this),
				...
				s;
			this.core.current() !== this.previous && (i && (s = this.core.coordinates(this.previous) - this.core.coordinates(
				this.next), a.one(t.support.animation.end, n).css({
				left: s + "px"
			}).addClass("animated owl-animated-out").addClass(i)), e && o.one(t.support.animation.end, n).addClass(
				"animated owl-animated-in").addClass(e))
		}
...
function(t, n, a) {
	var o = function(e) {
		this._core = e, this._call = null, this._time = 0, this._timeout = 0, this._paused = !0, this._handlers = {
			"changed.owl.carousel": t.proxy(function(e) {
				e.namespace && "settings" === e.property.name ? this._core.settings.autoplay ? this.play() : this.stop() : e.namespace &&
					"position" === e.property.name && this._paused && (this._time = 0)
			}, this),
			"initialized.owl.carousel": t.proxy(function(e) {
	...
	o.Defaults = {
		...
		this._call = n.setTimeout(t.proxy(this._next, this, e), this._timeout * (Math.round(this.read() / this._timeout) + 1) -
			this.read()), this._core.is("interacting") || a.hidden || this._core.next(e || this._core.settings.autoplaySpeed)
	}, o.prototype.read = function() {
		return new Date().getTime() - this._time
	}, o.prototype.play = function(a, o) {
		var i;
		this._core.is("rotating") || this._core.enter("rotating"), a = a || this._core.settings.autoplayTimeout, i = Math.min(
			this._time % (this._timeout || a), a), this._paused ? (this._time = this.read(), this._paused = !1) : n.clearTimeout(
			this._call), this._time += this.read() % a - i, this._timeout = a, this._call = n.setTimeout(t.proxy(this._next,
			this, o), a - i)
	}, o.prototype.stop = function() {
		this._core.is("rotating") && (this._time = 0, this._paused = !0, n.clearTimeout(this._call), this._core.leave(
			"rotating"))
...
function(t) {
	"use strict";
	var n = function(e) {
		this._core = e, this._initialized = !1, this._pages = [], this._controls = {}, this._templates = [], this.$element =
			this._core.$element, this._overrides = {
				...
				"prepared.owl.carousel": t.proxy(function(e) {
					e.namespace && this._core.settings.dotsData && this._templates.push("<div class=\"" + this._core.settings.dotClass +
						"\">" + t(e.content).find("[data-dot]").addBack("[data-dot]").attr("data-dot") + "</div>")
				}, this),
				...
				"initialized.owl.carousel": t.proxy(function(e) {
					e.namespace && !this._initialized && (this._core.trigger("initialize", null, "navigation"), this.initialize(),
						this.update(), this.draw(), this._initialized = !0, this._core.trigger("initialized", null, "navigation"))
				}, this),
				"refreshed.owl.carousel": t.proxy(function(e) {
					e.namespace && this._initialized && (this._core.trigger("refresh", null, "navigation"), this.update(), this.draw(),
	...
	n.Defaults = {
		...
		var e = this._core.settings,
			n;
		for (n in this._controls.$relative = (e.navContainer ? t(e.navContainer) : t("<div>").addClass(e.navContainerClass).appendTo(
				this.$element)).addClass("disabled"), this._controls.$previous = t("<" + e.navElement + ">").addClass(e.navClass[0])
			.html(e.navText[0]).prependTo(this._controls.$relative).on("click", t.proxy(function() {
				this.prev(e.navSpeed)
			}, this)), this._controls.$next = t("<" + e.navElement + ">").addClass(e.navClass[1]).html(e.navText[1]).appendTo(
				this._controls.$relative).on("click", t.proxy(function() {
				this.next(e.navSpeed)
			}, this)), e.dotsData || (this._templates = [t("<button role=\"button\">").addClass(e.dotClass).append(t("<span>"))
				.prop("outerHTML")
			]), this._controls.$absolute = (e.dotsContainer ? t(e.dotsContainer) : t("<div>").addClass(e.dotsClass).appendTo(
				this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "button", t.proxy(function(n) {
		...
		var n = this._core.settings,
			...
			e = n.loop || n.rewind,
			i;
		this._controls.$relative.toggleClass("disabled", !n.nav || a), n.nav && (this._controls.$previous.toggleClass(
			"disabled", !e && o <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !e && o >= this._core
			.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !n.dots || a), n.dots && (i = this._pages.length -
			this._controls.$absolute.children().length, n.dotsData && 0 !== i ? this._controls.$absolute.html(this._templates.join(
				"")) : 0 < i ? this._controls.$absolute.append(Array(i + 1).join(this._templates[0])) : 0 > i && this._controls.$absolute
			.children().slice(i).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute
			.children().eq(t.inArray(this.current(), this._pages)).addClass("active"))
		...
		var a = this._core.settings,
			e, o;
		return "page" == a.slideBy ? (e = t.inArray(this.current(), this._pages), o = this._pages.length, n ? ++e : --e, e =
			this._pages[(e % o + o) % o].start) : (e = this._core.relative(this._core.current()), o = this._core.items().length,
			n ? e += a.slideBy : e -= a.slideBy), e
		...
		var i;
		!o && this._pages.length ? (i = this._pages.length, t.proxy(this._overrides.to, this._core)(this._pages[(n % i + i) %
			i].start, a)) : t.proxy(this._overrides.to, this._core)(n, a)
...
function(t, n, a, o) {
	...
	var i = function(e) {
		...
		}, this._core.options = t.extend({}, i.Defaults, this._core.options), this.$element.on(this._handlers), t(n).on(
			"hashchange.owl.navigation", t.proxy(function() {
...
function(t, n, a, o) {
	...
	i.csstransitions() && (t.support.transition = new String(e("transition")), t.support.transition.end = d.transition.end[
		t.support.transition]), i.cssanimations() && (t.support.animation = new String(e("animation")), t.support.animation.end =
		d.animation.end[t.support.animation]), i.csstransforms() && (t.support.transform = new String(e("transform")), t.support
		.transform3d = i.csstransforms3d())
	...
	function s(c, t, e, i, p) {
		...
		var d = c.element;
		c.reach[s] = null, 1 > d[o] && (c.reach[s] = "start"), d[o] > c[g] - c[n] - 1 && (c.reach[s] = "end"), t && (d.dispatchEvent(
				a("ps-scroll-" + s)), 0 > t ? d.dispatchEvent(a("ps-scroll-" + m)) : 0 < t && d.dispatchEvent(a("ps-scroll-" + u)),
			i && E(c, s)), c.reach[s] && (t || p) && d.dispatchEvent(a("ps-" + s + "-reach-" + c.reach[s]))
	}
	...
	function t(e) {
		return C(e, "input,[contenteditable]") || C(e, "select,[contenteditable]") || C(e, "textarea,[contenteditable]") ||
			C(e, "button,[contenteditable]")
	}
	...
	function l(n, t) {
		return n.settings.minScrollbarLength && (t = Math.max(t, n.settings.minScrollbarLength)), n.settings.maxScrollbarLength &&
			(t = Math.min(t, n.settings.maxScrollbarLength)), t
	}
	...
	function c(e, t) {
		...
		a.left = t.isRtl ? t.negativeScrollAdjustment + e.scrollLeft + t.containerWidth - t.contentWidth : e.scrollLeft, t.isScrollbarXUsingBottom ?
			a.bottom = t.scrollbarXBottom - o : a.top = t.scrollbarXTop + o, _(t.scrollbarXRail, a);
		var i = {
			top: o,
			height: t.railYHeight
		};
		t.isScrollbarYUsingRight ? t.isRtl ? i.right = t.contentWidth - (t.negativeScrollAdjustment + e.scrollLeft) - t.scrollbarYRight -
			t.scrollbarYOuterWidth : i.right = t.scrollbarYRight - e.scrollLeft : t.isRtl ? i.left = t.negativeScrollAdjustment +
			e.scrollLeft + 2 * t.containerWidth - t.contentWidth - t.scrollbarYLeft - t.scrollbarYOuterWidth : i.left = t.scrollbarYLeft +
			e.scrollLeft, _(t.scrollbarYRail, i), _(t.scrollbarX, {
	...
	function p(s, t) {
		...
		s.event.bind(s[e], "mousedown", function(t) {
			h = p[u], b = t[y], x = (s[l] - s[r]) / (s[a] - s[c]), s.event.bind(s.ownerDocument, "mousemove", m), s.event.once(
				s.ownerDocument, "mouseup", i), s[f].classList.add(g.state.clicking), t.stopPropagation(), t.preventDefault()
		})
	}
	var u = "undefined" != typeof Element && (Element.prototype.matches || Element.prototype.webkitMatchesSelector ||
	...
	m.prototype.bind = function(n, t) {
		void 0 === this.handlers[n] && (this.handlers[n] = []), this.handlers[n].push(t), this.element.addEventListener(n,
			t, !1)
	...
	var y = function(a, t, e, o, i) {
		...
		v = {
			...
			supportsTouch: "undefined" != typeof window && ("ontouchstart" in window || window.DocumentTouch && document instanceof window
				.DocumentTouch),
		...
		w = function(n) {
			...
			n.containerWidth = t.clientWidth, n.containerHeight = t.clientHeight, n.contentWidth = t.scrollWidth, n.contentHeight =
				t.scrollHeight, t.contains(n.scrollbarXRail) || (r(t, g.element.rail("x")).forEach(function(e) {
					return i(e)
				}), t.appendChild(n.scrollbarXRail)), t.contains(n.scrollbarYRail) || (r(t, g.element.rail("y")).forEach(function(
					e) {
					return i(e)
				}), t.appendChild(n.scrollbarYRail)), !n.settings.suppressScrollX && n.containerWidth + n.settings.scrollXMarginOffset <
				n.contentWidth ? (n.scrollbarXActive = !0, n.railXWidth = n.containerWidth - n.railXMarginWidth, n.railXRatio = n.containerWidth /
					n.railXWidth, n.scrollbarXWidth = l(n, S(n.railXWidth * n.containerWidth / n.contentWidth)), n.scrollbarXLeft = S(
						(n.negativeScrollAdjustment + t.scrollLeft) * (n.railXWidth - n.scrollbarXWidth) / (n.contentWidth - n.containerWidth)
					)) : n.scrollbarXActive = !1, !n.settings.suppressScrollY && n.containerHeight + n.settings.scrollYMarginOffset <
				n.contentHeight ? (n.scrollbarYActive = !0, n.railYHeight = n.containerHeight - n.railYMarginHeight, n.railYRatio =
					n.containerHeight / n.railYHeight, n.scrollbarYHeight = l(n, S(n.railYHeight * n.containerHeight / n.contentHeight)),
					n.scrollbarYTop = S(e * (n.railYHeight - n.scrollbarYHeight) / (n.contentHeight - n.containerHeight))) : n.scrollbarYActive = !
				1, n.scrollbarXLeft >= n.railXWidth - n.scrollbarXWidth && (n.scrollbarXLeft = n.railXWidth - n.scrollbarXWidth),
				n.scrollbarYTop >= n.railYHeight - n.scrollbarYHeight && (n.scrollbarYTop = n.railYHeight - n.scrollbarYHeight), c(
					t, n), n.scrollbarXActive ? t.classList.add(g.state.active("x")) : (t.classList.remove(g.state.active("x")), n.scrollbarXWidth =
					0, n.scrollbarXLeft = 0, t.scrollLeft = 0), n.scrollbarYActive ? t.classList.add(g.state.active("y")) : (t.classList
					.remove(g.state.active("y")), n.scrollbarYHeight = 0, n.scrollbarYTop = 0, t.scrollTop = 0)
		},
		k = {
			"click-rail": function(n) {
				n.event.bind(n.scrollbarY, "mousedown", function(e) {
					...
					var e = t.pageX - window.pageXOffset - n.scrollbarXRail.getBoundingClientRect().left > n.scrollbarXLeft ? 1 :
						-1;
					n.element.scrollLeft += e * n.containerWidth, w(n), t.stopPropagation()
				})
			},
			"drag-thumb": function(e) {
				p(e, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x",
					"scrollbarXRail"
				]), p(e, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight",
					"scrollTop", "y", "scrollbarYRail"
				])
			},
			keyboard: function(d) {
				function c(t, e) {
				...
				d.event.bind(d.ownerDocument, "keydown", function(n) {
					if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (e() || i())) {
						...
						d.settings.suppressScrollX && 0 !== l || d.settings.suppressScrollY && 0 !== u || (p.scrollTop -= u, p.scrollLeft +=
							l, w(d), c(l, u) && n.preventDefault())
					}
				})
			},
			wheel: function(d) {
				...
				function i(n) {
					var t = n.deltaX,
						a = -1 * n.deltaY;
					return void 0 !== t && void 0 !== a || (t = -1 * n.wheelDeltaX / 6, a = n.wheelDeltaY / 6), n.deltaMode && 1 ===
						n.deltaMode && (t *= 10, a *= 10), t !== t && a !== a && (t = 0, a = n.wheelDelta), n.shiftKey ? [-a, -t] : [t,
							a
						]
				}
				...
				function t(o) {
					...
					if (!r(o.target, n, s)) {
						var a = !1;
						d.settings.useBothWheelAxes ? d.scrollbarYActive && !d.scrollbarXActive ? (s ? p.scrollTop -= s * d.settings.wheelSpeed :
							p.scrollTop += n * d.settings.wheelSpeed, a = !0) : d.scrollbarXActive && !d.scrollbarYActive && (n ? p.scrollLeft +=
							n * d.settings.wheelSpeed : p.scrollLeft -= s * d.settings.wheelSpeed, a = !0) : (p.scrollTop -= s * d.settings
							.wheelSpeed, p.scrollLeft += n * d.settings.wheelSpeed), w(d), (a = a || e(n, s)) && !o.ctrlKey && (o.stopPropagation(),
							o.preventDefault())
					}
				}
				var p = d.element;
				void 0 === window.onwheel ? void 0 !== window.onmousewheel && d.event.bind(p, "mousewheel", t) : d.event.bind(p,
					"wheel", t)
			},
			touch: function(m) {
				function b(e, t) {
					var a = Math.floor(c.scrollTop),
						...
						n = Math.abs(t);
					if (n > s) {
						if (0 > t && a === m.contentHeight - m.containerHeight || 0 < t && 0 === a) return 0 === window.scrollY && 0 <
							t && v.isChrome;
				...
				function l(e) {
					return (!e.pointerType || "pen" !== e.pointerType || 0 !== e.buttons) && (e.targetTouches && 1 === e.targetTouches
						.length || e.pointerType && "mouse" !== e.pointerType && e.pointerType !== e.MSPOINTER_TYPE_MOUSE)
				}
				...
				function a() {
					m.settings.swipeEasing && (clearInterval(o), o = setInterval(function() {
						m.isInitialized ? clearInterval(o) : _.x || _.y ? .01 > Math.abs(_.x) && .01 > Math.abs(_.y) ? clearInterval(
							o) : (i(30 * _.x, 30 * _.y), _.x *= .8, _.y *= .8) : clearInterval(o)
					}, 10))
				}
				if (v.supportsTouch || v.supportsIePointer) {
					var c = m.element,
						...
						_ = {},
						o = null;
					v.supportsTouch ? (m.event.bind(c, "touchstart", e), m.event.bind(c, "touchmove", t), m.event.bind(c, "touchend",
						a)) : v.supportsIePointer && (window.PointerEvent ? (m.event.bind(c, "pointerdown", e), m.event.bind(c,
						"pointermove", t), m.event.bind(c, "pointerup", a)) : window.MSPointerEvent && (m.event.bind(c,
						"MSPointerDown", e), m.event.bind(c, "MSPointerMove", t), m.event.bind(c, "MSPointerUp", a)))
				}
			}
		},
		T = function(i, t) {
			var p = this;
			if (void 0 === t && (t = {}), "string" == typeof i && (i = document.querySelector(i)), !i || !i.nodeName) throw new Error(
			...
			this.isRtl = "rtl" === x(i).direction, this.isNegativeScroll = function() {
				...
				}(), this.negativeScrollAdjustment = this.isNegativeScroll ? i.scrollWidth - i.clientWidth : 0, this.event = new b,
				this.ownerDocument = i.ownerDocument || document, this.scrollbarXRail = e(g.element.rail("x")), i.appendChild(this
					.scrollbarXRail), this.scrollbarX = e(g.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX),
				this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", o), this.event.bind(this.scrollbarX,
					"blur", s), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
			...
			this.scrollbarXBottom = parseInt(a.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1,
					this.scrollbarXTop = S(a.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = S(a.borderLeftWidth) +
				S(a.borderRightWidth), _(this.scrollbarXRail, {
					display: "block"
				}), this.railXMarginWidth = S(a.marginLeft) + S(a.marginRight), _(this.scrollbarXRail, {
					display: ""
				}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = e(g.element.rail("y")), i.appendChild(
					this.scrollbarYRail), this.scrollbarY = e(g.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY),
				this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", o), this.event.bind(this.scrollbarY,
					"blur", s), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
			var c = x(this.scrollbarYRail);
			this.scrollbarYRight = parseInt(c.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this
					.scrollbarYLeft = S(c.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? d(this.scrollbarY) :
				null, this.railBorderYWidth = S(c.borderTopWidth) + S(c.borderBottomWidth), _(this.scrollbarYRail, {
					display: "block"
					...
					return k[e](p)
				}), this.lastScrollTop = Math.floor(i.scrollTop), this.lastScrollLeft = i.scrollLeft, this.event.bind(this.element,
					"scroll",
					function(e) {
						return p.onScroll(e)
					}), w(this)
	...
	return T.prototype.update = function() {
		this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth :
			0, _(this.scrollbarXRail, {
				display: "block"
			}), _(this.scrollbarYRail, {
				display: "block"
			}), this.railXMarginWidth = S(x(this.scrollbarXRail).marginLeft) + S(x(this.scrollbarXRail).marginRight), this.railYMarginHeight =
			S(x(this.scrollbarYRail).marginTop) + S(x(this.scrollbarYRail).marginBottom), _(this.scrollbarXRail, {
				display: "none"
			}), _(this.scrollbarYRail, {
				display: "none"
		...
		this.isAlive && (w(this), y(this, "top", this.element.scrollTop - this.lastScrollTop), y(this, "left", this.element
				.scrollLeft - this.lastScrollLeft), this.lastScrollTop = Math.floor(this.element.scrollTop), this.lastScrollLeft =
			this.element.scrollLeft)
	}, T.prototype.destroy = function() {
		this.isAlive && (this.event.unbindAll(), i(this.scrollbarX), i(this.scrollbarY), i(this.scrollbarXRail), i(this.scrollbarYRail),
			this.removePsClasses(), this.element = null, this.scrollbarX = null, this.scrollbarY = null, this.scrollbarXRail =
			null, this.scrollbarYRail = null, this.isAlive = !1)
	...
	var g = "undefined" != typeof window && window.navigator && window.navigator.platform &&
		...
		e = function() {
			setTimeout(function() {
				void 0 !== v && (document.body.style.paddingRight = v, v = void 0), void 0 !== y && (document.body.style.overflow =
					y, y = void 0)
			})
		},
		y, v;
	o.disableBodyScroll = function(a, n) {
		...
		g ? a && !f.includes(a) && (f = [].concat(function(n) {
			...
			var e, r, l, d;
			1 === s.targetTouches.length && (r = a, d = (e = s).targetTouches[0].clientY - h, r && 0 === r.scrollTop && 0 <
				d ? b(e) : (l = r) && l.scrollHeight - l.scrollTop <= l.clientHeight && 0 > d ? b(e) : e.stopPropagation())
	...
	function n(n, t) {
		var l = [],
			d = 0,
			c, u, g;
		n && n.isDefaultPrevented() || (n.preventDefault(), t = t || {}, n && n.data && (t = p(n.data.options, t)), c = t.$target ||
			v(n.currentTarget).trigger("blur"), g = v.fancybox.getInstance(), g && g.$trigger && g.$trigger.is(c) || (t.selector ?
				l = v(t.selector) : (u = c.attr("data-fancybox") || "", u ? (l = n.data ? n.data.items : [], l = l.length ? l.filter(
					"[data-fancybox=\"" + u + "\"]") : v("[data-fancybox=\"" + u + "\"]")) : l = [c]), d = v(l).index(c), 0 > d && (d =
					0), g = v.fancybox.open(l, t, d), g.$trigger = c))
	}
	if (m.console = m.console || {
		...
		var e = {
			...
			w = function() {
				return m.requestAnimationFrame || m.webkitRequestAnimationFrame || m.mozRequestAnimationFrame || m.oRequestAnimationFrame ||
					function(t) {
						return m.setTimeout(t, 1e3 / 60)
					}
			}(),
			o = function() {
				return m.cancelAnimationFrame || m.webkitCancelAnimationFrame || m.mozCancelAnimationFrame || m.oCancelAnimationFrame ||
					function(t) {
						m.clearTimeout(t)
					}
			}(),
			...
			r = function(n, t, e) {
				...
				o.opts = p({
						index: e
					}, v.fancybox.defaults), v.isPlainObject(t) && (o.opts = p(o.opts, t)), v.fancybox.isMobile && (o.opts = p(o.opts,
						o.opts.mobile)), o.id = o.opts.id || ++i, o.currIndex = parseInt(o.opts.index, 10) || 0, o.prevIndex = null, o.prevPos =
					null, o.currPos = 0, o.firstRun = !0, o.group = [], o.slides = {}, o.addContent(n), o.group.length && o.init()
			};
		v.extend(r.prototype, {
				init: function() {
					var e = this,
						...
						n = t.opts,
						i, s;
					n.closeExisting && v.fancybox.close(!0), v("body").addClass("fancybox-active"), v.fancybox.getInstance() || !1 ===
						n.hideScrollbar || v.fancybox.isMobile || !(y.body.scrollHeight > m.innerHeight) || (v("head").append(
							"<style id=\"fancybox-style-noscroll\" type=\"text/css\">.compensate-for-scrollbar{margin-right:" + (m.innerWidth -
								y.documentElement.clientWidth) + "px;}</style>"), v("body").addClass("compensate-for-scrollbar")), s = "", v.each(
							n.buttons,
							function(a, t) {
								s += n.btnTpl[t] || ""
							}), i = v(e.translate(e, n.baseTpl.replace("{{buttons}}", s).replace("{{arrows}}", n.btnTpl.arrowLeft + n.btnTpl
							.arrowRight))).attr("id", "fancybox-container-" + e.id).addClass(n.baseClass).data("FancyBox", e).appendTo(n.parentEl),
						e.$refs = {
							container: i
				...
				addContent: function(n) {
					...
					v.each(t, function(n, t) {
						var e = {},
							a = {},
							g, f, m, h, b;
						v.isPlainObject(t) ? (e = t, a = t.opts || t) : "object" === v.type(t) && v(t).length ? (g = v(t), a = g.data() ||
								{}, a = v.extend(!0, {}, a, a.options), a.$orig = g, e.src = o.opts.src || a.src || g.attr("href"), e.type ||
								e.src || (e.type = "inline", e.src = t)) : e = {
								type: "html",
								src: t + ""
							}, e.opts = v.extend(!0, {}, o.opts, a), v.isArray(a.buttons) && (e.opts.buttons = a.buttons), v.fancybox.isMobile &&
							e.opts.mobile && (e.opts = p(e.opts, e.opts.mobile)), f = e.type || e.opts.type, h = e.src || "", !f && h &&
							((m = h.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (f = "video", e.opts.video.format || (e.opts.video.format =
								"video/" + ("ogv" === m[1] ? "ogg" : m[1]))) : h.match(
								/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? f = "image" : h.match(
								/\.(pdf)((\?|#).*)?$/i) ? (f = "iframe", e = v.extend(!0, e, {
								contentType: "pdf",
								opts: {
									iframe: {
										preload: !1
							...
							(e.contentType = -1 < v.inArray(e.type, ["html", "inline", "ajax"]) ? "html" : e.type), e.index = o.group.length,
							"auto" == e.opts.smallBtn && (e.opts.smallBtn = -1 < v.inArray(e.type, ["html", "inline", "ajax"])), "auto" ===
							e.opts.toolbar && (e.opts.toolbar = !e.opts.smallBtn), e.$thumb = e.opts.$thumb || null, e.opts.$trigger &&
							e.index === o.opts.index && (e.$thumb = e.opts.$trigger.find("img:first"), e.$thumb.length && (e.opts.$orig =
								e.opts.$trigger)), e.$thumb && e.$thumb.length || !e.opts.$orig || (e.$thumb = e.opts.$orig.find(
								"img:first")), e.$thumb && !e.$thumb.length && (e.$thumb = null), e.thumb = e.opts.thumb || (e.$thumb ? e.$thumb[
								0].src : null), "function" === v.type(e.opts.caption) && (e.opts.caption = e.opts.caption.apply(t, [o, e])),
							"function" === v.type(o.opts.caption) && (e.opts.caption = o.opts.caption.apply(t, [o, e])), e.opts.caption instanceof v ||
							(e.opts.caption = e.opts.caption === x ? "" : e.opts.caption + ""), "ajax" === e.type && (b = h.split(/\s+/,
								2), 1 < b.length && (e.src = b.shift(), e.opts.filter = b.shift())), e.opts.modal && (e.opts = v.extend(!0,
								e.opts, {
									trapFocus: !0,
									infobar: 0,
									toolbar: 0,
				...
				addEvents: function() {
					...
					n.removeEvents(), n.$refs.container.on("click.fb-close", "[data-fancybox-close]", function(e) {
						...
						e && e.originalEvent && "resize" === e.originalEvent.type ? (n.requestId && o(n.requestId), n.requestId = w(
							function() {
								n.update(e)
						...
						var t = v.fancybox ? v.fancybox.getInstance() : null,
							o = t.current,
							a = e.keyCode || e.which;
						return 9 == a ? void(o.opts.trapFocus && n.focus(e)) : !o.opts.keyboard || e.ctrlKey || e.altKey || e.shiftKey ||
							v(e.target).is("input") || v(e.target).is("textarea") ? void 0 : 8 === a || 27 === a ? (e.preventDefault(),
								void n.close(e)) : 37 === a || 38 === a ? (e.preventDefault(), void n.previous()) : 39 === a || 40 === a ?
							(e.preventDefault(), void n.next()) : void n.trigger("afterKeydown", e, a)
						...
						n.idleSecondsCounter++, n.idleSecondsCounter >= n.group[n.currIndex].opts.idleTime && !n.isDragging && (n.isIdle = !
							0, n.idleSecondsCounter = 0, n.hideControls())
					}, 1e3))
				},
				removeEvents: function() {
					var t = this;
					a.off("orientationchange.fb resize.fb"), _.off("keydown.fb .fb-idle"), this.$refs.container.off(
						".fb-close .fb-prev .fb-next"), t.idleInterval && (m.clearInterval(t.idleInterval), t.idleInterval = null)
				},
				previous: function(e) {
				...
				jumpTo: function(n, p) {
					...
					if (!(m.isDragging || m.isClosing || m.isAnimating && m.firstRun)) {
						...
						if (g = m.firstRun = !Object.keys(m.slides).length, _ = m.current, m.prevIndex = m.currIndex, m.prevPos = m.currPos,
							y = m.createSlide(n), 1 < o && ((b || y.index < o - 1) && m.createSlide(n + 1), (b || 0 < y.index) && m.createSlide(
								n - 1)), m.current = y, m.currIndex = y.index, m.currPos = y.pos, m.trigger("beforeShow", g), m.updateControls(),
							y.forcedDuration = x, v.isNumeric(p) ? y.forcedDuration = p : p = y.opts[g ? "animationDuration" :
								"transitionDuration"], p = parseInt(p, 10), h = m.isMoved(y), y.$slide.addClass("fancybox-slide--current"), g
						) return y.opts.animationEffect && p && m.$refs.container.css("transition-duration", p + "ms"), m.$refs.container
							.addClass("fancybox-is-open").trigger("focus"), m.loadSlide(y), void m.preload("image");
						w = v.fancybox.getTranslate(_.$slide), T = v.fancybox.getTranslate(m.$refs.stage), v.each(m.slides, function(n,
							t) {
							v.fancybox.stop(t.$slide, !0)
						}), _.pos !== y.pos && (_.isComplete = !1), _.$slide.removeClass(
							"fancybox-slide--complete fancybox-slide--current"), h ? (S = w.left - (_.pos * w.width + _.pos * _.opts.gutter),
							v.each(m.slides, function(e, t) {
								...
								v.fancybox.setTranslate(t.$slide, {
										top: 0,
										left: n - T.left + S
									}), t.pos !== y.pos && t.$slide.addClass("fancybox-slide--" + (t.pos > y.pos ? "next" : "previous")), C(t.$slide),
							...
							})) : p && y.opts.transitionEffect && (E = "fancybox-animated fancybox-fx-" + y.opts.transitionEffect, _.$slide
							.addClass("fancybox-slide--" + (_.pos > y.pos ? "next" : "previous")), v.fancybox.animate(_.$slide, E, p,
								function() {
				...
				createSlide: function(n) {
					var t = this,
						a, i;
					return i = n % t.group.length, i = 0 > i ? t.group.length + i : i, !t.slides[n] && t.group[i] && (a = v(
						"<div class=\"fancybox-slide\"></div>").appendTo(t.$refs.stage), t.slides[n] = v.extend(!0, {}, t.group[i], {
						pos: n,
						$slide: a,
						isLoaded: !1
				...
				scaleToActual: function(n, o, m) {
					var a = this,
						...
						g = d.height,
						b, y, _, w, C;
					a.isAnimating || a.isMoved() || !u || "image" != d.type || !d.isLoaded || d.hasError || (a.isAnimating = !0, v.fancybox
						.stop(u), n = n === x ? .5 * f : n, o = o === x ? .5 * p : o, b = v.fancybox.getTranslate(u), b.top -= v.fancybox
						.getTranslate(d.$slide).top, b.left -= v.fancybox.getTranslate(d.$slide).left, w = h / b.width, C = g / b.height,
						y = .5 * f - .5 * h, _ = .5 * p - .5 * g, h > f && (y = b.left * w - (n * w - n), 0 < y && (y = 0), y < f - h &&
							(y = f - h)), g > p && (_ = b.top * C - (o * C - o), 0 < _ && (_ = 0), _ < p - g && (_ = p - g)), a.updateCursor(
							h, g), v.fancybox.animate(u, {
							top: _,
							left: y,
							scaleX: w,
							scaleY: C
				...
				scaleToFit: function(n) {
					var t = this,
						...
						a = o.$content,
						i;
					t.isAnimating || t.isMoved() || !a || "image" != o.type || !o.isLoaded || o.hasError || (t.isAnimating = !0, v.fancybox
						.stop(a), i = t.getFitPos(o), t.updateCursor(i.width, i.height), v.fancybox.animate(a, {
							top: i.top,
							left: i.left,
				...
				getFitPos: function(n) {
					var t = this,
						...
						g = {},
						u, f, m, h;
					return !!(n.isLoaded && s && s.length) && (u = v.fancybox.getTranslate(t.$refs.stage).width, f = v.fancybox.getTranslate(
							t.$refs.stage).height, u -= parseFloat(r.css("paddingLeft")) + parseFloat(r.css("paddingRight")) + parseFloat(
							s.css("marginLeft")) + parseFloat(s.css("marginRight")), f -= parseFloat(r.css("paddingTop")) + parseFloat(r.css(
							"paddingBottom")) + parseFloat(s.css("marginTop")) + parseFloat(s.css("marginBottom")), c && p || (c = u, p =
							f), m = Math.min(1, u / c, f / p), c = m * c, p = m * p, c > u - .5 && (c = u), p > f - .5 && (p = f),
						"image" === n.type ? (g.top = Math.floor(.5 * (f - p)) + parseFloat(r.css("paddingTop")), g.left = Math.floor(
							.5 * (u - c)) + parseFloat(r.css("paddingLeft"))) : "video" === n.contentType && (h = n.opts.width && n.opts.height ?
							c / p : n.opts.ratio || 16 / 9, p > c / h ? p = c / h : c > p * h && (c = p * h)), g.width = c, g.height = p,
						g)
				},
				update: function(a) {
					var t = this;
				...
				updateSlide: function(n, t) {
					var e = this,
						...
						s = n.$slide;
					e.adjustCaption(n), o && (a || i || "video" === n.contentType) && !n.hasError && (v.fancybox.stop(o), v.fancybox
							.setTranslate(o, e.getFitPos(n)), n.pos === e.currPos && (e.isAnimating = !1, e.updateCursor())), e.adjustLayout(
							n), s.length && (s.trigger("refresh"), n.pos === e.currPos && e.$refs.toolbar.add(e.$refs.navigation.find(
							".fancybox-button--arrow_right")).toggleClass("compensate-for-scrollbar", s.get(0).scrollHeight > s.get(0).clientHeight)),
				...
				isMoved: function(n) {
					var t = n || this.current,
						a, i;
					return !!t && (i = v.fancybox.getTranslate(this.$refs.stage), a = v.fancybox.getTranslate(t.$slide), !t.$slide.hasClass(
						"fancybox-animated") && (.5 < Math.abs(a.top - i.top) || .5 < Math.abs(a.left - i.left)))
				},
				updateCursor: function(n, t) {
					...
					i && !e.isClosing && e.Guestures && (s.removeClass(
						"fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"), r = e.canPan(
						n, t), l = !!r || e.isZoomable(), s.toggleClass("fancybox-is-zoomable", l), v("[data-fancybox-zoom]").prop(
						"disabled", !l), r ? s.addClass("fancybox-can-pan") : l && ("zoom" === i.opts.clickContent || v.isFunction(i.opts
						.clickContent) && "zoom" == i.opts.clickContent(i)) ? s.addClass("fancybox-can-zoomIn") : i.opts.touch && (i.opts
						.touch.vertical || 1 < e.group.length) && "video" !== i.contentType && s.addClass("fancybox-can-swipe"))
				},
				isZoomable: function() {
					var a = this,
						e = a.current,
				...
				isScaledDown: function(n, t) {
					var e = this,
						...
						o = e.current,
						s = o.$content;
					return n !== x && t !== x ? a = n < o.width && t < o.height : s && (a = v.fancybox.getTranslate(s), a = a.width <
						o.width && a.height < o.height), a
				},
				canPan: function(n, t) {
					var e = this,
						a = e.current,
						o = null,
						i = !1;
					return "image" === a.type && (a.isComplete || n && t) && !a.hasError && (i = e.getFitPos(a), n !== x && t !== x ?
						o = {
							width: n,
							height: t
						} : a.isComplete && (o = v.fancybox.getTranslate(a.$content)), o && i && (i = 1.5 < Math.abs(o.width - i.width) ||
							1.5 < Math.abs(o.height - i.height))), i
				},
					...
					if (!s.isLoading && !s.isLoaded) {
						...
						switch (n = s.type, i = s.$slide, i.off("refresh").trigger("onReset").addClass(s.opts.slideClass), n) {
							...
							case "html":
								...
								break;
							case "video":
								t.setContent(s, s.opts.video.tpl.replace(/\{\{src\}\}/gi, s.src).replace("{{format}}", s.opts.videoFormat ||
									s.opts.video.format || "").replace("{{poster}}", s.thumb || ""));
								break;
							case "inline":
				...
				setImage: function(n) {
					...
					setTimeout(function() {
						...
						}, 50), t.checkSrcset(n), n.$content = v("<div class=\"fancybox-content\"></div>").addClass(
							"fancybox-is-hidden").appendTo(n.$slide.addClass("fancybox-slide--image")), !1 !== n.opts.preload && n.opts.width &&
						n.opts.height && n.thumb && (n.width = n.opts.width, n.height = n.opts.height, e = y.createElement("img"), e.onerror =
							function() {
					...
					if (e) {
						...
						for (var u = 0, g; u < l.length; u++)
							if (g = l[u], "w" === g.postfix && g.value >= p || "x" === g.postfix && g.value >= d) {
								s = g;
								break
							}! s && l.length && (s = l[l.length - 1]), s && (t.src = s.url, t.width && t.height && "w" == s.postfix && (t.height =
							t.width / t.height * s.value, t.width = s.value), t.opts.srcset = e)
					}
				},
				setBigImage: function(n) {
					...
					n.$image = o.one("error", function() {
							...
							var i;
							n.$ghost || (t.resolveImageSlideSize(n, this.naturalWidth, this.naturalHeight), t.afterLoad(n)), t.isClosing ||
								(n.opts.srcset && (i = n.opts.sizes, i && "auto" !== i || (i = (1 < n.width / n.height && 1 < a.width() / a.height() ?
										"100" : Math.round(100 * (n.width / n.height))) + "vw"), o.attr("sizes", i).attr("srcset", n.opts.srcset)),
									n.$ghost && setTimeout(function() {
										n.$ghost && !t.isClosing && n.$ghost.hide()
									}, Math.min(300, Math.max(1e3, n.height / 1600))), t.hideLoading(n))
						}).addClass("fancybox-image").attr("src", n.src).appendTo(n.$content), (e.complete || "complete" == e.readyState) &&
						o.naturalWidth && o.naturalHeight ? o.trigger("load") : e.error && o.trigger("error")
				},
				resolveImageSlideSize: function(i, t, e) {
					var n = parseInt(i.opts.width, 10),
						o = parseInt(i.opts.height, 10);
					i.width = t, i.height = e, 0 < n && (i.width = n, i.height = Math.floor(n * e / t)), 0 < o && (i.width = Math.floor(
						o * t / e), i.height = o)
				},
				setIframe: function(o) {
					var t = this,
						...
						i = o.$slide,
						s;
					v.fancybox.isMobile && (d.css.overflow = "scroll"), o.$content = v("<div class=\"fancybox-content" + (d.preload ?
							" fancybox-is-hidden" : "") + "\"></div>").css(d.css).appendTo(i), i.addClass("fancybox-slide--" + o.contentType),
						o.$iframe = s = v(d.tpl.replace(/\{rnd\}/g, new Date().getTime())).attr(d.attr).appendTo(o.$content), d.preload ?
						(t.showLoading(o), s.on("load.fb error.fb", function() {
							...
							if (1 === s[0].isReady) {
								...
								u && u.length && u.children().length && (i.css("overflow", "visible"), e.css({
									...
									"max-width": "100%",
									height: "9999px"
								}), t === x && (t = Math.ceil(Math.max(u[0].clientWidth, u.outerWidth(!0)))), e.css("width", t ? t : "").css(
									"max-width", ""), r === x && (r = Math.ceil(Math.max(u[0].clientHeight, u.outerHeight(!0)))), e.css(
									"height", r ? r : ""), i.css("overflow", "auto")), e.removeClass("fancybox-is-hidden")
							}
				...
				setContent: function(n, t) {
					var a = this;
					a.isClosing || (a.hideLoading(n), n.$content && v.fancybox.stop(n.$content), n.$slide.empty(), s(t) && t.parent()
						.length ? ((t.hasClass("fancybox-content") || t.parent().hasClass("fancybox-content")) && t.parents(
							".fancybox-slide").trigger("onReset"), n.$placeholder = v("<div>").hide().insertAfter(t), t.css("display",
							"inline-block")) : n.hasError || ("string" === v.type(t) && (t = v("<div>").append(v.trim(t)).contents()), n.opts
							.filter && (t = v("<div>").html(t).find(n.opts.filter))), n.$slide.one("onReset", function() {
							v(this).find("video,audio").trigger("pause"), n.$placeholder && (n.$placeholder.after(t.removeClass(
								"fancybox-content").hide()).remove(), n.$placeholder = null), n.$smallBtn && (n.$smallBtn.remove(), n.$smallBtn =
								null), n.hasError || (v(this).empty(), n.isLoaded = !1, n.isRevealed = !1)
						}), v(t).appendTo(n.$slide), v(t).is("video,audio") && (v(t).addClass("fancybox-video"), v(t).wrap(
								"<div></div>"), n.contentType = "video", n.opts.width = n.opts.width || v(t).attr("width"), n.opts.height =
							n.opts.height || v(t).attr("height")), n.$content = n.$slide.children().filter(
							"div,form,main,video,audio,article,.fancybox-content").first(), n.$content.siblings().hide(), n.$content.length ||
						(n.$content = n.$slide.wrapInner("<div></div>").children().first()), n.$content.addClass("fancybox-content"),
						n.$slide.addClass("fancybox-slide--" + n.contentType), a.afterLoad(n))
				},
				setError: function(e) {
					e.hasError = !0, e.$slide.trigger("onReset").removeClass("fancybox-slide--" + e.contentType).addClass(
							"fancybox-slide--error"), e.contentType = "html", this.setContent(e, this.translate(e, e.opts.errorTpl)), e.pos ===
						this.currPos && (this.isAnimating = !1)
				},
				showLoading: function(n) {
					var a = this;
					n = n || a.current, n && !n.$spinner && (n.$spinner = v(a.translate(a, a.opts.spinnerTpl)).appendTo(n.$slide).hide()
						.fadeIn("fast"))
				},
				...
				afterLoad: function(n) {
					var t = this;
					t.isClosing || (n.isLoading = !1, n.isLoaded = !0, t.trigger("afterLoad", n), t.hideLoading(n), !n.opts.smallBtn ||
						n.$smallBtn && n.$smallBtn.length || (n.$smallBtn = v(t.translate(n, n.opts.btnTpl.smallBtn)).appendTo(n.$content)),
						n.opts.protect && n.$content && !n.hasError && (n.$content.on("contextmenu.fb", function(e) {
							return 2 == e.button && e.preventDefault(), !0
						}), "image" === n.type && v("<div class=\"fancybox-spaceball\"></div>").appendTo(n.$content)), t.adjustCaption(
							n), t.adjustLayout(n), n.pos === t.currPos && t.updateCursor(), t.revealContent(n))
				},
				adjustCaption: function(s) {
					var t = this,
						...
						o = t.$refs.caption,
						r = !1;
					e.opts.preventCaptionOverlap && n && n.length && (e.pos === t.currPos ? t.$caption && (r = t.$caption.outerHeight(
							!0)) : (o = o.clone().empty().appendTo(o.parent()), o.html(n), r = o.outerHeight(!0), o.empty().remove()), e.$slide
				...
				adjustLayout: function(r) {
					...
					i.isLoaded && !0 !== i.opts.disableLayoutFix && (i.$content.css("margin-bottom", ""), i.$content.outerHeight() >
						i.$slide.height() + .5 && (d = i.$slide[0].style["padding-bottom"], c = i.$slide.css("padding-bottom"), 0 <
							parseFloat(c) && (s = i.$slide[0].scrollHeight, i.$slide.css("padding-bottom", 0), 1 > Math.abs(s - i.$slide[
								0].scrollHeight) && (l = c), i.$slide.css("padding-bottom", d))), i.$content.css("margin-bottom", l))
				},
				revealContent: function(n) {
					var t = this,
						...
						u = n.isRevealed,
						g, f, m, h;
					return n.isRevealed = !0, g = n.opts[t.firstRun ? "animationEffect" : "transitionEffect"], m = n.opts[t.firstRun ?
							"animationDuration" : "transitionDuration"], m = parseInt(n.forcedDuration === x ? m : n.forcedDuration, 10),
						!p && n.pos === t.currPos && m || (g = !1), "zoom" === g && (n.pos === t.currPos && m && "image" === n.type &&
							!n.hasError && (c = t.getThumbPos(n)) ? r = t.getFitPos(n) : g = "fade"), "zoom" === g ? (t.isAnimating = !0,
							r.scaleX = r.width / c.width, r.scaleY = r.height / c.height, h = n.opts.zoomOpacity, "auto" == h && (h = .1 <
								Math.abs(n.width / n.height - c.width / c.height)), h && (c.opacity = .1, r.opacity = 1), v.fancybox.setTranslate(
								n.$content.removeClass("fancybox-is-hidden"), c), C(n.$content), void v.fancybox.animate(n.$content, r, m,
								function() {
									t.isAnimating = !1, t.complete()
								})) : (t.updateSlide(n), g ? (v.fancybox.stop(o), f = "fancybox-slide--" + (n.pos >= t.prevPos ? "next" :
								"previous") + " fancybox-animated fancybox-fx-" + g, o.addClass(f).removeClass("fancybox-slide--current"), n
							.$content.removeClass("fancybox-is-hidden"), C(o), "image" !== n.type && n.$content.hide().show(0), void v.fancybox
							.animate(o, "fancybox-slide--current", m, function() {
								o.removeClass(f).css({
									transform: "",
									opacity: ""
								}), n.pos === t.currPos && t.complete()
							}, !0)) : (n.$content.removeClass("fancybox-is-hidden"), u || !p || "image" !== n.type || n.hasError || n.$content
							.hide().fadeIn("fast"), void(n.pos === t.currPos && t.complete())))
				},
				getThumbPos: function(n) {
					var t = !1,
						l = n.$thumb,
						c, p, u, g, f;
					return l && d(l[0]) && (c = v.fancybox.getTranslate(l), p = parseFloat(l.css("border-top-width") || 0), u =
						parseFloat(l.css("border-right-width") || 0), g = parseFloat(l.css("border-bottom-width") || 0), f =
						parseFloat(l.css("border-left-width") || 0), t = {
							top: c.top + p,
							left: c.left + f,
							width: c.width - u - f,
							height: c.height - p - g,
				...
				complete: function() {
					var n = this,
						...
						i = {},
						a;
					!n.isMoved() && e.isLoaded && (e.isComplete || (e.isComplete = !0, e.$slide.siblings().trigger("onReset"), n.preload(
							"inline"), C(e.$slide), e.$slide.addClass("fancybox-slide--complete"), v.each(n.slides, function(e, t) {
							t.pos >= n.currPos - 1 && t.pos <= n.currPos + 1 ? i[t.pos] = t : t && (v.fancybox.stop(t.$slide), t.$slide
								.off().remove())
						...
						.find("video,audio").filter(":visible:first").trigger("play").one("ended", function() {
							...
							"input[autofocus]:enabled:visible:first"), a.length ? a.trigger("focus") : n.focus(null, !0)), e.$slide.scrollTop(
							0).scrollLeft(0))
				},
				preload: function(a) {
					var t = this,
						o, i;
					2 > t.group.length || (i = t.slides[t.currPos + 1], o = t.slides[t.currPos - 1], o && o.type === a && t.loadSlide(
						o), i && i.type === a && t.loadSlide(i))
				},
				focus: function(e, t) {
					var n = this,
						o, s;
					n.isClosing || (o = !e && n.current && n.current.isComplete ? n.current.$slide.find("*:visible" + (t ?
						":not(.fancybox-close-small)" : "")) : n.$refs.container.find("*:visible"), o = o.filter(
					...
					}), o.length ? (s = o.index(y.activeElement), e && e.shiftKey ? (0 > s || 0 == s) && (e.preventDefault(), o.eq(
						o.length - 1).trigger("focus")) : (0 > s || s == o.length - 1) && (e && e.preventDefault(), o.eq(0).trigger(
						"focus"))) : n.$refs.container.trigger("focus"))
				},
				activate: function() {
					var n = this;
				...
				close: function(n, t) {
					...
					return !e.isClosing && (e.isClosing = !0, !1 === e.trigger("beforeClose", n) ? (e.isClosing = !1, w(function() {
						e.update()
					}), !1) : (e.removeEvents(), f = d.$content, u = d.opts.animationEffect, g = v.isNumeric(t) ? t : u ? d.opts.animationDuration :
						0, d.$slide.removeClass(
							"fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), !0 === n ? u = !
						1 : v.fancybox.stop(d.$slide), d.$slide.siblings().trigger("onReset").remove(), g && e.$refs.container.removeClass(
							"fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", g + "ms"), e.hideLoading(d),
						e.hideControls(!0), e.updateCursor(), "zoom" !== u || f && g && "image" === d.type && !e.isMoved() && !d.hasError &&
						(y = e.getThumbPos(d)) || (u = "fade"), "zoom" === u ? (v.fancybox.stop(f), m = v.fancybox.getTranslate(f), b = {
								top: m.top,
								left: m.left,
								...
								width: y.width,
								height: y.height
							}, h = d.opts.zoomOpacity, "auto" == h && (h = .1 < Math.abs(d.width / d.height - y.width / y.height)), h &&
							(y.opacity = 0), v.fancybox.setTranslate(f, b), C(f), v.fancybox.animate(f, y, g, p), !0) : (u && g ? v.fancybox
							.animate(d.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"),
								"fancybox-animated fancybox-fx-" + u, g, p) : !0 === n ? setTimeout(p, g) : p(), !0)))
				},
				cleanUp: function(t) {
					var e = this,
						n = e.current.opts.$orig,
						s, l, d;
					e.current.$slide.trigger("onReset"), e.$refs.container.empty().remove(), e.trigger("afterClose", t), e.current.opts
						.backFocus && (n && n.length && n.is(":visible") || (n = e.$trigger), n && n.length && (l = m.scrollX, d = m.scrollY,
							n.trigger("focus"), v("html, body").scrollTop(d).scrollLeft(l))), e.current = null, s = v.fancybox.getInstance(),
						s ? s.activate() : (v("body").removeClass("fancybox-active compensate-for-scrollbar"), v(
				...
				trigger: function(n, t) {
					var e = Array.prototype.slice.call(arguments, 1),
						...
						r;
					return i ? e.unshift(i) : i = a, e.unshift(a), v.isFunction(i.opts[n]) && (r = i.opts[n].apply(i, e)), !1 === r ?
						r : void("afterClose" !== n && a.$refs ? a.$refs.container.trigger(n + ".fb", e) : _.trigger(n + ".fb", e))
				},
				updateControls: function() {
					var e = this,
						...
						o = e.$refs.caption,
						i = t.opts.caption;
					t.$slide.trigger("refresh"), e.$caption = i && i.length ? o.html(i) : null, e.hasHiddenControls || e.isIdle || e
						.showControls(), a.find("[data-fancybox-count]").html(e.group.length), a.find("[data-fancybox-index]").html(n +
							1), a.find("[data-fancybox-prev]").prop("disabled", !t.opts.loop && 0 >= n), a.find("[data-fancybox-next]").prop(
							"disabled", !t.opts.loop && n >= e.group.length - 1), "image" === t.type ? a.find("[data-fancybox-zoom]").show()
						.end().find("[data-fancybox-download]").attr("href", t.opts.image.src || t.src).show() : t.opts.toolbar && a.find(
							"[data-fancybox-download],[data-fancybox-zoom]").hide(), v(y.activeElement).is(":hidden,[disabled]") && e.$refs
						.container.trigger("focus")
				},
				hideControls: function(a) {
					var t = this,
						e = ["infobar", "toolbar", "nav"];
					!a && t.current.opts.preventCaptionOverlap || e.push("caption"), this.$refs.container.removeClass(e.map(function(
						e) {
				...
				showControls: function() {
					var a = this,
						...
						e = a.$refs.container;
					a.hasHiddenControls = !1, a.idleSecondsCounter = 0, e.toggleClass("fancybox-show-toolbar", t.toolbar && t.buttons)
						.toggleClass("fancybox-show-infobar", !!(t.infobar && 1 < a.group.length)).toggleClass("fancybox-show-caption",
							!!a.$caption).toggleClass("fancybox-show-nav", !!(t.arrows && 1 < a.group.length)).toggleClass(
				...
				getInstance: function(n) {
					...
					return t instanceof r && ("string" === v.type(n) ? t[n].apply(t, e) : "function" === v.type(n) && n.apply(t, e),
						t)
				},
				open: function(a, t, e) {
					return new r(a, t, e)
				...
				use3d: function() {
					...
					return m.getComputedStyle && m.getComputedStyle(e) && m.getComputedStyle(e).getPropertyValue("transform") && !(y.documentMode &&
						11 > y.documentMode)
				}(),
				...
				setTranslate: function(o, t) {
					var e = "",
						i = {};
					if (o && t) return t.left === x && t.top === x || (e = (t.left === x ? o.position().left : t.left) + "px, " + (t.top ===
							x ? o.position().top : t.top) + "px", e = this.use3d ? "translate3d(" + e + ", 0px)" : "translate(" + e + ")"),
						t.scaleX !== x && t.scaleY !== x ? e += " scale(" + t.scaleX + ", " + t.scaleY + ")" : t.scaleX !== x && (e +=
							" scaleX(" + t.scaleX + ")"), e.length && (i.transform = e), t.opacity !== x && (i.opacity = t.opacity), t.width !==
						x && (i.width = t.width), t.height !== x && (i.height = t.height), o.css(i)
				},
				animate: function(n, t, e, o, d) {
					var s = this,
						c;
					v.isFunction(e) && (o = e, e = null), s.stop(n), c = s.getTranslate(n), n.on(l, function(a) {
						a && a.originalEvent && (!n.is(a.originalEvent.target) || "z-index" == a.originalEvent.propertyName) || (s.stop(
								n), v.isNumeric(e) && n.css("transition-duration", ""), v.isPlainObject(t) ? t.scaleX !== x && t.scaleY !==
							x && s.setTranslate(n, {
								top: t.top,
								left: t.left,
					...
					}), v.isNumeric(e) && n.css("transition-duration", e + "ms"), v.isPlainObject(t) ? (t.scaleX !== x && t.scaleY !==
						x && (delete t.width, delete t.height, n.parent().hasClass("fancybox-slide--image") && n.parent().addClass(
							"fancybox-is-scaling")), v.fancybox.setTranslate(n, t)) : n.addClass(t), n.data("timer", setTimeout(function() {
						n.trigger(l)
					}, e + 33))
				},
				stop: function(n, t) {
					n && n.length && (clearTimeout(n.data("timer")), t && n.trigger(l), n.off(l).css("transition-duration", ""), n.parent()
				...
				v("[data-fancybox=\"" + v(this).attr("data-fancybox-trigger") + "\"]").eq(v(this).attr("data-fancybox-index") || 0)
				...
				_.on("mousedown mouseup focus blur", ".fancybox-button", function(t) {
					switch (t.type) {
						...
						case "mouseup":
							...
							break;
						case "focusin":
							v(".fancybox-button").removeClass("fancybox-focus"), v(this).is(e) || v(this).is("[disabled]") || v(this).addClass(
								"fancybox-focus");
							break;
						case "focusout":
			...
			gmap_place: {
				...
				url: function(e) {
					return "//maps.google." + e[2] + "/?ll=" + (e[9] ? e[9] + "&z=" + Math.floor(e[10]) + (e[12] ? e[12].replace(
						/^\//, "&") : "") : e[12] + "").replace(/\?/, "&") + "&output=" + (e[12] && 0 < e[12].indexOf("layer=c") ?
						"svembed" : "embed")
				}
			},
			gmap_search: {
		...
		a = g.extend(!0, {}, t, m.opts.media), g.each(a, function(t, e) {
			if (v = i.match(e.matcher)) {
				if (b = e.type, C = t, w = {}, e.paramPlace && v[e.paramPlace]) {
					...
					for (var n = 0, o; n < _.length; ++n) o = _[n].split("=", 2), 2 == o.length && (w[o[0]] = decodeURIComponent(o[
						1].replace(/\+/g, " ")))
				}
				return x = g.extend(!0, {}, e.params, m.opts[t], w), i = "function" === g.type(e.url) ? e.url.call(this, v, x,
						m) : r(e.url, v, x), y = "function" === g.type(e.thumb) ? e.thumb.call(this, v, x, m) : r(e.thumb, v),
					"youtube" === t ? i = i.replace(/&t=((\d+)m)?(\d+)s/, function(a, t, e, n) {
						return "&start=" + ((e ? 60 * parseInt(e, 10) : 0) + parseInt(n, 10))
					}) : "vimeo" == t && (i = i.replace("&%23", "#")), !1
			}
		}), b ? (m.opts.thumb || m.opts.$thumb && m.opts.$thumb.length || (m.opts.thumb = y), "iframe" === b && (m.opts =
			g.extend(!0, m.opts, {
				iframe: {
					preload: !1,
					attr: {
	...
	var a = {
		...
		load: function(a) {
			...
			return this[a].loaded ? void setTimeout(function() {
				t.done(a)
			}) : void(this[a].loading || (this[a].loading = !0, n = document.createElement("script"), n.type =
				"text/javascript", n.src = this[a].src, "youtube" === a ? window.onYouTubeIframeAPIReady = function() {
			...
			var e, i, s;
			"youtube" === t && delete window.onYouTubeIframeAPIReady, e = g.fancybox.getInstance(), e && (i = e.current.$content
				.find("iframe"), "youtube" === t && void 0 !== YT && YT ? s = new YT.Player(i.attr("id"), {
					events: {
...
function(_, g, w) {
	"use strict";
	var n = function() {
			return _.requestAnimationFrame || _.webkitRequestAnimationFrame || _.mozRequestAnimationFrame || _.oRequestAnimationFrame ||
				function(t) {
					return _.setTimeout(t, 1e3 / 60)
				}
		}(),
		C = function() {
			return _.cancelAnimationFrame || _.webkitCancelAnimationFrame || _.mozCancelAnimationFrame || _.oCancelAnimationFrame ||
				function(t) {
					_.clearTimeout(t)
				}
		}(),
		m = function(t) {
			var a = [];
			for (var n in t = t.originalEvent || t || _.e, t = t.touches && t.touches.length ? t.touches : t.changedTouches && t
					.changedTouches.length ? t.changedTouches : [t], t) t[n].pageX ? a.push({
				x: t[n].pageX,
				y: t[n].pageY
			}) : t[n].clientX && a.push({
				x: t[n].clientX,
		...
		T = function(a, t, e) {
			return t && a ? "x" === e ? a.x - t.x : "y" === e ? a.y - t.y : Math.sqrt(Math.pow(a.x - t.x, 2) + Math.pow(a.y - t.y,
				2)) : 0
		},
		e = function(n) {
			if (n.is("a,area,button,[role=\"button\"],input,label,select,summary,textarea,video,audio,iframe") || w.isFunction(n
					.get(0).onclick) || n.data("selectable")) return !0;
		...
		o = function(n) {
			var t = this;
			t.instance = n, t.$bg = n.$refs.bg, t.$stage = n.$refs.stage, t.$container = n.$refs.container, t.destroy(), t.$container
				.on("touchstart.fb.touch mousedown.fb.touch", w.proxy(t, "ontouchstart"))
		};
	o.prototype.destroy = function() {
		var e = this;
		e.$container.off(".fb.touch"), w(g).off(".fb.touch"), e.requestId && (C(e.requestId), e.requestId = null), e.tapped &&
			(clearTimeout(e.tapped), e.tapped = null)
		...
		var o = this,
			...
			l = s.$content,
			d = "touchstart" == n.type;
		if (d && o.$container.off("mousedown.fb.touch"), (!n.originalEvent || 2 != n.originalEvent.button) && r.length && a.length &&
			!e(a) && !e(a.parent()) && (a.is("img") || !(n.originalEvent.clientX > a[0].clientWidth + a.offset().left))) {
			if (!s || i.isAnimating || s.$slide.hasClass("fancybox-animated")) return n.stopPropagation(), void n.preventDefault();
			o.realPoints = o.startPoints = m(n), o.startPoints.length && (s.touch && n.stopPropagation(), o.startEvent = n, o.canTap = !
				0, o.$target = a, o.$content = l, o.opts = s.opts.touch, o.isPanning = !1, o.isSwiping = !1, o.isZooming = !1, o.isScrolling = !
				1, o.canPan = i.canPan(), o.startTime = new Date().getTime(), o.distanceX = o.distanceY = o.distance = 0, o.canvasWidth =
				Math.round(r[0].clientWidth), o.canvasHeight = Math.round(r[0].clientHeight), o.contentLastPos = null, o.contentStartPos =
				w.fancybox.getTranslate(o.$content) || {
					top: 0,
					left: 0
				}, o.sliderStartPos = w.fancybox.getTranslate(r), o.stagePos = w.fancybox.getTranslate(i.$refs.stage), o.sliderStartPos
				.top -= o.stagePos.top, o.sliderStartPos.left -= o.stagePos.left, o.contentStartPos.top -= o.stagePos.top, o.contentStartPos
				.left -= o.stagePos.left, w(g).off(".fb.touch").on(d ? "touchend.fb.touch touchcancel.fb.touch" :
					"mouseup.fb.touch mouseleave.fb.touch", w.proxy(o, "ontouchend")).on(d ? "touchmove.fb.touch" :
					"mousemove.fb.touch", w.proxy(o, "ontouchmove")), w.fancybox.isMobile && g.addEventListener("scroll", o.onscroll,
					!0), ((o.opts || o.canPan) && (a.is(o.$stage) || o.$stage.find(a).length) || (a.is(".fancybox-image") && n.preventDefault(),
					w.fancybox.isMobile && a.hasClass("fancybox-caption"))) && (o.isScrollable = t(a) || t(a.parent()), w.fancybox.isMobile &&
					o.isScrollable || n.preventDefault(), (1 === o.startPoints.length || s.hasError) && (o.canPan ? (w.fancybox.stop(
						o.$content), o.isPanning = !0) : o.isSwiping = !0, o.$container.addClass("fancybox-is-grabbing")), 2 === o.startPoints
					.length && "image" === s.type && (s.isLoaded || s.$ghost) && (o.canTap = !1, o.isSwiping = !1, o.isPanning = !1,
						o.isZooming = !0, w.fancybox.stop(o.$content), o.centerPointStartX = .5 * (o.startPoints[0].x + o.startPoints[1]
							.x) - w(_).scrollLeft(), o.centerPointStartY = .5 * (o.startPoints[0].y + o.startPoints[1].y) - w(_).scrollTop(),
						o.percentageOfImageAtPinchPointX = (o.centerPointStartX - o.contentStartPos.left) / o.contentStartPos.width, o.percentageOfImageAtPinchPointY =
						(o.centerPointStartY - o.contentStartPos.top) / o.contentStartPos.height, o.startDistanceBetweenFingers = T(o.startPoints[
							0], o.startPoints[1]))))
		}
		...
		var t = this;
		return void 0 !== n.originalEvent.buttons && 0 === n.originalEvent.buttons ? void t.ontouchend(n) : t.isScrolling ?
			void(t.canTap = !1) : (t.newPoints = m(n), void((t.opts || t.canPan) && t.newPoints.length && t.newPoints.length &&
				(t.isSwiping && !0 === t.isSwiping || n.preventDefault(), t.distanceX = T(t.newPoints[0], t.startPoints[0], "x"),
					t.distanceY = T(t.newPoints[0], t.startPoints[0], "y"), t.distance = T(t.newPoints[0], t.startPoints[0]), 0 < t.distance &&
					(t.isSwiping ? t.onSwipe(n) : t.isPanning ? t.onPan() : t.isZooming && t.onZoom()))))
		...
		var d = this,
			...
			a;
		if (!0 !== e) "x" == e && (0 < d.distanceX && (2 > d.instance.group.length || 0 === d.instance.current.index && !d.instance
				.current.opts.loop) ? t += Math.pow(d.distanceX, .8) : 0 > d.distanceX && (2 > d.instance.group.length || d.instance
				.current.index === d.instance.group.length - 1 && !d.instance.current.opts.loop) ? t -= Math.pow(-d.distanceX, .8) :
			t += d.distanceX), d.sliderLastPos = {
			...
			if (d.canTap = !1, 2 > s.group.length && d.opts.vertical ? d.isSwiping = "y" : s.isDragging || !1 === d.opts.vertical ||
				"auto" === d.opts.vertical && 800 < w(_).width() ? d.isSwiping = "x" : (a = Math.abs(180 * Math.atan2(d.distanceY,
					d.distanceX) / Math.PI), d.isSwiping = 45 < a && 135 > a ? "y" : "x"), "y" === d.isSwiping && w.fancybox.isMobile &&
				d.isScrollable) return void(d.isScrolling = !0);
			s.isDragging = d.isSwiping, d.startPoints = d.newPoints, w.each(s.slides, function(n, t) {
				var e, i;
				w.fancybox.stop(t.$slide), e = w.fancybox.getTranslate(t.$slide), i = w.fancybox.getTranslate(s.$refs.stage), t.$slide
					.css({
						transform: "",
						opacity: "",
						"transition-duration": ""
						...
						return (t.match(/(^|\s)fancybox-fx-\S+/g) || []).join(" ")
					}), t.pos === s.current.pos && (d.sliderStartPos.top = e.top - i.top, d.sliderStartPos.left = e.left - i.left),
					w.fancybox.setTranslate(t.$slide, {
						top: e.top - i.top,
						left: e.left - i.left
					})
		...
		var e = this;
		return T(e.newPoints[0], e.realPoints[0]) < (w.fancybox.isMobile ? 10 : 5) ? void(e.startPoints = e.newPoints) : (e.canTap = !
			1, e.contentLastPos = e.limitMovement(), e.requestId && C(e.requestId), void(e.requestId = n(function() {
		...
		var m = this,
			...
			h = d.height,
			g, b, y, v, x, _;
		return x = p > s ? u + c : u, _ = f + l, g = Math.max(0, .5 * s - .5 * p), b = Math.max(0, .5 * r - .5 * h), y =
			Math.min(s - p, .5 * s - .5 * p), v = Math.min(r - h, .5 * r - .5 * h), 0 < c && x > g && (x = g - 1 + Math.pow(-g +
				u + c, .8) || 0), 0 > c && x < y && (x = y + 1 - Math.pow(y - u - c, .8) || 0), 0 < l && _ > b && (_ = b - 1 +
				Math.pow(-b + f + l, .8) || 0), 0 > l && _ < v && (_ = v + 1 - Math.pow(v - f - l, .8) || 0), {
				top: _,
				left: x
			}
		...
		var o = this,
			a = o.canvasWidth,
			i = o.canvasHeight;
		return d > a ? (r = 0 < r ? 0 : r, r = r < a - d ? a - d : r) : r = Math.max(0, a / 2 - d / 2), n > i ? (l = 0 < l ?
			0 : l, l = l < i - n ? i - n : l) : l = Math.max(0, i / 2 - n / 2), {
			top: l,
			left: r
		}
		...
		var t = this,
			...
			o = t.isZooming,
			i = t.isScrolling;
		return t.endPoints = m(e), t.dMs = Math.max(new Date().getTime() - t.startTime, 1), t.$container.removeClass(
				"fancybox-is-grabbing"), w(g).off(".fb.touch"), g.removeEventListener("scroll", t.onscroll, !0), t.requestId && (C(
				t.requestId), t.requestId = null), t.isSwiping = !1, t.isPanning = !1, t.isZooming = !1, t.isScrolling = !1, t.instance
			.isDragging = !1, t.canTap ? t.onTap(e) : (t.speed = 100, t.velocityX = .5 * (t.distanceX / t.dMs), t.velocityY =
				.5 * (t.distanceY / t.dMs), void(a ? t.endPanning() : o ? t.endZooming() : t.endSwiping(n, i)))
		...
		e.sliderLastPos = null, "y" == n && !t && 50 < Math.abs(e.distanceY) ? (w.fancybox.animate(e.instance.current.$slide, {
				...
				opacity: 0
			}, 200), o = e.instance.close(!0, 250)) : s && 0 < e.distanceX ? o = e.instance.previous(300) : s && 0 > e.distanceX &&
			(o = e.instance.next(300)), !1 !== o || "x" != n && "y" != n || e.instance.centerSlide(200), e.$container.removeClass(
				"fancybox-is-sliding")
	}, o.prototype.endPanning = function() {
		var n = this,
			a, i, s;
		n.contentLastPos && (!1 === n.opts.momentum || 350 < n.dMs ? (a = n.contentLastPos.left, i = n.contentLastPos.top) :
			(a = n.contentLastPos.left + 500 * n.velocityX, i = n.contentLastPos.top + 500 * n.velocityY), s = n.limitPosition(
				a, i, n.contentStartPos.width, n.contentStartPos.height), s.width = n.contentStartPos.width, s.height = n.contentStartPos
			.height, w.fancybox.animate(n.$content, s, 330))
		...
		n.contentLastPos && (l = n.contentLastPos.left, d = n.contentLastPos.top, p = {
				...
				scaleX: 1,
				scaleY: 1
			}, w.fancybox.setTranslate(n.$content, p), s < n.canvasWidth && r < n.canvasHeight ? n.instance.scaleToFit(150) :
			s > i.width || r > i.height ? n.instance.scaleToActual(n.centerPointStartX, n.centerPointStartY, 150) : (c = n.limitPosition(
				l, d, s, r), w.fancybox.animate(n.$content, c, 150)))
		...
		var e = this,
			...
			d = function(s) {
				var t = i.opts[s];
				(w.isFunction(t) && (t = t.apply(a, [i, n])), t) && ("close" === t ? a.close(e.startEvent) : "toggleControls" ===
					t ? a.toggleControls() : "next" === t ? a.next() : "nextOrClose" === t ? 1 < a.group.length ? a.next() : a.close(
						e.startEvent) : "zoom" === t ? "image" == i.type && (i.isLoaded || i.$ghost) && (a.canPan() ? a.scaleToFit() : a
						.isScaledDown() ? a.scaleToActual(r, l) : 2 > a.group.length && a.close(e.startEvent)) : void 0)
			},
			c;
		if ((!n.originalEvent || 2 != n.originalEvent.button) && (t.is("img") || !(r > t[0].clientWidth + t.offset().left))) {
			...
			if (e.tapped) {
				...
				d("dblclick" + c)
			} else e.tapX = r, e.tapY = l, i.opts["dblclick" + c] && i.opts["dblclick" + c] !== i.opts["click" + c] ? e.tapped =
				setTimeout(function() {
	...
	d.extend(a.prototype, {
		...
		set: function(e) {
			var t = this,
				n = t.instance,
				o = n.current;
			o && (!0 === e || o.opts.loop || n.currIndex < n.group.length - 1) ? t.isActive && "video" !== o.contentType && (
				t.$progress && d.fancybox.animate(t.$progress.show(), {
					scaleX: 1
		...
		start: function() {
			...
			t && (n.$button.attr("title", (t.opts.i18n[t.opts.lang] || t.opts.i18n.en).PLAY_STOP).removeClass(
					"fancybox-button--play").addClass("fancybox-button--pause"), n.isActive = !0, t.isComplete && n.set(!0), n.instance
				.trigger("onSlideShowChange", !0))
		},
		stop: function() {
			var n = this,
				t = n.instance.current;
			n.clear(), n.$button.attr("title", (t.opts.i18n[t.opts.lang] || t.opts.i18n.en).PLAY_START).removeClass(
				"fancybox-button--pause").addClass("fancybox-button--play"), n.isActive = !1, n.instance.trigger(
				"onSlideShowChange", !1), n.$progress && n.$progress.removeAttr("style").hide()
		},
		toggle: function() {
			var e = this;
		...
		"afterKeydown.fb": function(e, t, n, a, o) {
			var i = t && t.SlideShow;
			i && n.opts.slideShow && (80 === o || 32 === o) && !d(l.activeElement).is("button,a,input") && (a.preventDefault(),
				i.toggle())
		},
...
function(s, a) {
	...
	if (i) {
		...
		a.extend(!0, a.fancybox.defaults, {
			...
			t && (t.current && "image" === t.current.type && t.isAnimating && (t.current.$content.css("transition", "none"), t
				.isAnimating = !1, t.update(!0, !0, 0)), t.trigger("onFullscreenChange", e), t.$refs.container.toggleClass(
				"fancybox-is-fullscreen", e), t.$refs.toolbar.find("[data-fancybox-fullscreen]").toggleClass(
				"fancybox-button--fsenter", !e).toggleClass("fancybox-button--fsexit", e))
		})
	}
	a(s).on({
		"onInit.fb": function(n, t) {
			var e;
			return i ? void(t && t.group[t.currIndex].opts.fullScreen ? (e = t.$refs.container, e.on("click.fb-fullscreen",
					"[data-fancybox-fullscreen]",
					function(e) {
						e.stopPropagation(), e.preventDefault(), r.toggle()
					}), t.opts.fullScreen && !0 === t.opts.fullScreen.autoStart && r.request(), t.FullScreen = r) : t && t.$refs.toolbar
				.find("[data-fancybox-fullscreen]").hide()) : void t.$refs.toolbar.find("[data-fancybox-fullscreen]").remove()
		},
	...
	r.extend(o.prototype, {
		...
		init: function(s) {
			var t = this,
				e = s.group,
				n = 0;
			t.instance = s, t.opts = e[s.currIndex].opts.thumbs, s.Thumbs = t, t.$button = s.$refs.toolbar.find(
		...
		create: function() {
			var e = this,
				...
				o = [],
				i;
			e.$grid || (e.$grid = r("<div class=\"fancybox-thumbs fancybox-thumbs-" + e.opts.axis + "\"></div>").appendTo(n.$refs
				.container.find(a).addBack().filter(a)), e.$grid.on("click", "a", function() {
				n.jumpTo(r(this).attr("data-index"))
			})), e.$list || (e.$list = r("<div class=\"fancybox-thumbs__list\">").appendTo(e.$grid)), r.each(n.group,
				function(t, e) {
					i = e.thumb, i || "image" !== e.type || (i = e.src), o.push(
						"<a href=\"javascript:;\" tabindex=\"0\" data-index=\"" + t + "\"" + (i && i.length ?
							" style=\"background-image:url(" + i + ")\"" : "class=\"fancybox-thumbs-missing\"") + "></a>")
				}), e.$list[0].innerHTML = o.join(""), "x" === e.opts.axis && e.$list.width(parseInt(e.$grid.css(
				"padding-right"), 10) + n.group.length * e.$list.children().eq(0).outerWidth(!0))
		},
		focus: function(o) {
			var t = this,
				a = t.$list,
				i = t.$grid,
				s, r;
			t.instance.current && (s = a.children().removeClass("fancybox-thumbs-active").filter("[data-index=\"" + t.instance
					.current.index + "\"]").addClass("fancybox-thumbs-active"), r = s.position(), "y" === t.opts.axis && (0 > r.top ||
					r.top > a.height() - s.outerHeight()) ? a.stop().animate({
					scrollTop: a.scrollTop() + r.top
				}, o) : "x" === t.opts.axis && (r.left < i.scrollLeft() || r.left > i.scrollLeft() + (i.width() - s.outerWidth())) &&
		...
		update: function() {
			var e = this;
			e.instance.$refs.container.toggleClass("fancybox-show-thumbs", this.isVisible), e.isVisible ? (e.$grid || e.create(),
				e.instance.trigger("onThumbsShow"), e.focus(0)) : e.$grid && e.instance.trigger("onThumbsHide"), e.instance.update()
		},
		hide: function() {
...
function(a, s) {
	...
	s.extend(!0, s.fancybox.defaults, {
		...
		var n = s.fancybox.getInstance(),
			a = n.current || null,
			i, r;
		a && ("function" === s.type(a.opts.share.url) && (i = a.opts.share.url.apply(a, [n, a])), r = a.opts.share.tpl.replace(
			/\{\{media\}\}/g, "image" === a.type ? encodeURIComponent(a.src) : "").replace(/\{\{url\}\}/g,
			encodeURIComponent(i)).replace(/\{\{url_raw\}\}/g, e(i)).replace(/\{\{descr\}\}/g, n.$caption ?
			encodeURIComponent(n.$caption.text()) : ""), s.fancybox.open({
			src: n.translate(n, r),
			type: "html",
			opts: {
				touch: !1,
...
function(l, t, s) {
	...
	function d(a) {
		var t, o;
		return !!a && (t = a.current ? a.current.opts : a.opts, o = t.hash || (t.$orig ? t.$orig.data("fancybox") || t.$orig.data(
			"fancybox-trigger") : ""), "" !== o && o)
	}
	s.escapeSelector || (s.escapeSelector = function(n) {
		...
		!1 !== s.fancybox.defaults.hash && (s(t).on({
			"onInit.fb": function(o, t) {
				var e, i;
				!1 !== t.group[t.currIndex].opts.hash && (e = r(), i = d(t), i && e.gallery && i == e.gallery && (t.currIndex =
					e.index - 1))
			},
			"beforeShow.fb": function(e, n, o, a) {
				var i;
				o && !1 !== o.opts.hash && (i = d(n), i && (n.currentHash = i + (1 < n.group.length ? "-" + (o.index + 1) :
					""), l.location.hash !== "#" + n.currentHash && (a && !n.origHash && (n.origHash = l.location.hash), n.hashTimer &&
					clearTimeout(n.hashTimer), n.hashTimer = setTimeout(function() {
						"replaceState" in l.history ? (l.history[a ? "pushState" : "replaceState"]({}, t.title, l.location.pathname +
								l.location.search + "#" + n.currentHash), a && (n.hasCreatedHistory = !0)) : l.location.hash = n.currentHash,
							n.hashTimer = null
					}, 300))))
			},
			"beforeClose.fb": function(e, n, o) {
				!1 !== o.opts.hash && (clearTimeout(n.hashTimer), n.currentHash && n.hasCreatedHistory ? l.history.back() : n
					.currentHash && ("replaceState" in l.history ? l.history.replaceState({}, t.title, l.location.pathname + l.location
						.search + (n.origHash || "")) : l.location.hash = n.origHash), n.currentHash = null)
			}
			...
			}), i ? i.currentHash === a.gallery + "-" + a.index || 1 === a.index && i.currentHash == a.gallery || (i.currentHash =
				null, i.close()) : "" !== a.gallery && n(a)
		}), setTimeout(function() {
	...
	t(a).on({
		"onInit.fb": function(n, s) {
			s.$refs.stage.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function(e) {
				var n = s.current,
					o = new Date().getTime();
				2 > s.group.length || !1 === n.opts.wheel || "auto" === n.opts.wheel && "image" !== n.type || (e.preventDefault(),
					e.stopPropagation(), n.$slide.hasClass("fancybox-animated") || (e = e.originalEvent || e, 250 > o - i || (i =
						o, s[0 > (-e.deltaY || -e.deltaX || e.wheelDelta || -e.detail) ? "next" : "previous"]())))
			})
		}
	})
}(document, jQuery), ! function(a) {
	var e;
	if ("function" == typeof define && define.amd && (define(a), e = !0), "object" == typeof exports && (module.exports =
			a(), e = !0), !e) {
	...
	return function e(s) {
		...
		function r(e, r, l) {
			if ("undefined" != typeof document) {
				"number" == typeof(l = a({
					path: "/"
				}, o.defaults, l)).expires && (l.expires = new Date(1 * new Date + 864e5 * l.expires)), l.expires = l.expires ? l
					.expires.toUTCString() : "";
				try {
				...
				r = s.write ? s.write(r, e) : encodeURIComponent(r + "").replace(
						/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent), e = encodeURIComponent(e + "")
					.replace(/%(23|24|26|2B|5E|60|7C)/g, decodeURIComponent).replace(/[\(\)]/g, escape);
				var c = "";
...
(function(e) {
	"use strict";
	"function" == typeof define && define.amd ? define(["jquery"], e) : "undefined" != typeof module && module.exports ?
			...
			if (null !== n) {
				...
				o.each(p.axis.split(""), function(e, t) {
					var a = "x" === t ? "Left" : "Top",
						...
						l = _[i](),
						c = s.max(x, t);
					C ? (w[i] = C[o] + (b ? 0 : l - _.offset()[o]), p.margin && (w[i] -= parseInt(r.css("margin" + a), 10) || 0,
							w[i] -= parseInt(r.css("border" + a + "Width"), 10) || 0), w[i] += T[o] || 0, p.over[o] && (w[i] += r["x" ===
							t ? "width" : "height"]() * p.over[o])) : (a = r[o], w[i] = a.slice && "%" === a.slice(-1) ? parseFloat(a) /
							100 * c : a), p.limit && /^\d+$/.test(w[i]) && (w[i] = 0 >= w[i] ? 0 : Math.min(w[i], c)), !e && 1 < p.axis
						.length && (l === w[i] ? w = {} : y && (u(p.onAfterFirst), w = {}))
				}), u(p.onAfter)
			}
		})
	}, s.max = function(e, t) {
	...
	return e.lib = e.prototype = {
		...
		constructor: e,
		init: function(e) {
			return e || (e = {}), this.options = {}, this.options.text = e.text || "Data missing", this.options.type = e.type ||
				"info", this.options.duration = e.duration || 5e3, this.options.selector = e.selector, this.options.callback = e
				.callback || function() {}, this.options.destination = e.destination, this.options.newWindow = e.newWindow || !1,
				this.options.close = e.close || !1, this.options.gravity = e.gravity || "bottom", this.options.position = e.position ||
				"center", this.options.backgroundColor = e.backgroundColor, this.options.className = e.className || "", this
		},
		buildToast: function() {
			if (!this.options) throw "Toastify is not initialized";
			var e = document.createElement("div");
			if (e.className = "toast on " + this.options.className, e.className += " toast-" + this.options.gravity, e.className +=
				" toast-" + this.options.position, e.className += " toast-" + this.options.type, this.options.backgroundColor &&
				(e.style.background = this.options.backgroundColor), e.innerHTML = n[this.options.type] + this.options.text, !0 ===
				this.options.close) {
			...
			return void 0 !== this.options.destination && e.addEventListener("click", function(e) {
				e.stopPropagation(), !0 === this.options.newWindow ? window.open(this.options.destination, "_blank") : window.location =
		...
		showToast: function() {
			var n = this.buildToast(),
				a;
			if (!(a = void 0 === this.options.selector ? document.body : document.getElementById(this.options.selector)))
		...
		for (var s = {
			...
			d = d.substr(6, d.length - 1), 360 >= (0 < window.innerWidth ? window.innerWidth : screen.width) ? (n[e].style[d] =
				i[d] + "px", i[d] += c + 15) : !0 === r(n[e], "toast-left") ? (n[e].style[d] = s[d] + "px", s[d] += c + 15) : (n[
				e].style[d] = o[d] + "px", o[d] += c + 15)
		}
		return this
		...
		function() {
			for (var e = {}, t = window.pageContext, n = {
					...
					0 < i.indexOf("#") && (i = i.substring(0, i.indexOf("#"))), $.ajax({
						url: i + (0 <= i.indexOf("?") ? "&" : "?") + "mode=async&function=get_block&block_id=" + t + (o ? "&" + $.param(
							o) : ""),
						type: "GET",
						cache: !1,
						beforeSend: function() {
					...
					t && t.server_error && (o = t.server_error), e.ajaxForm({
						...
						success: function(t, s, l) {
							if (!(0 <= l.getResponseHeader("Content-Type").indexOf("application/json"))) 0 <= l.getResponseHeader(
								"Content-Type").indexOf("text/html") ? n && n.success ? n.success(e, t) : "message" == $(t).attr(
								"data-fancybox") || $(t).find("[data-fancybox=\"message\"]").exists() ? $.fancybox($(t), {
								topRatio: .3,
								...
								for (var d = "", c = 0; c < t.errors.length; c++) {
									...
									if (u) {
										var f = e.find("[name=\"" + u + "\"]");
										if (f.exists() || (f = e.find("[data-name=\"" + u + "\"] [type=\"text\"]")), f.exists() || (f = e.find(
												"[data-name=\"" + u + "\"] select")), f.exists()) {
											f.parents(".form-group").addClass("error"), f.parents(".file-control").find("[type=\"text\"]").addClass(
												"error");
									...
									if (d += p.message + "<br>", e.find(".alert-danger").html(d).fadeIn(), "code" == u && "required" != g) {
										...
										h.exists() && (h.attr("src", h.attr("src").replace(/rand=\d+/, "rand=" + new Date().getTime())), e.find(
											".captcha-control .textfield").val(""))
									}
								}
								"object" == typeof grecaptcha && grecaptcha.reset(), n && n.error && n.error(e), r(e, 0)
							} else if ("success" != t.status) e.find(".alert-danger").html(o).fadeIn(), r(e, 0), n && n.error && n.error(
								e);
						...
						var e = $(this),
							t = function() {
								e.parents(".form-group").removeClass("error"), e.parents(".file-control").find("[type=\"text\"]").removeClass(
									"error")
							};
						e.change(t), ("textarea" == e.get(0).tagName.toLowerCase() || "text" == e.get(0).type || "password" == e.get(
							0).type) && e.keypress(t)
						...
						t.find("[type=\"text\"]").focus(function() {
							...
							t.find(".list-selector-popup").exists() ? (t.find(".list-selector-popup").show(), t.find(
								...
								success: function(n) {
									for (var s = [], r = [], l = "", d = $("<div class=\"list-selector-popup\">" + n + "</div>"), c = d.find(
											"[name=\"filter\"]"), p = 0, u; p < o.length; p++)
										if (u = o[p].trim(), u) {
										...
										if (l.html()) {
											var c = n.prop("value");
											if (n.prop("checked")) s.push(c), r.push(l.html()), t.append($("<input type=\"hidden\" name=\"" +
												a + "[]\" value=\"" + c + "\"/>"));
											else {
										...
										if (o.html()) {
											var i = n.prop("value");
											n.prop("checked") && (t.find("input[type=\"hidden\"][name=\"" + a + "[]\"]").remove(), s[0] = i,
												r[0] = o.html(), t.append($("<input type=\"hidden\" name=\"" + a + "[]\" value=\"" + i +
													"\"/>")));
											var l = r[0];
						...
						if (t) {
							...
							}), e.removeClass("expand").addClass("collapse")) : (n.slideUp(400, function() {}), e.removeClass(
						...
						$(this).click(function() {
							if (!$(this).hasClass("disabled")) {
								...
								if (e.find("[data-action=\"choose\"] [type=\"radio\"]").prop("checked", !1), t.prop("checked", !0), t.prop(
									...
									n.exists() && ("payment_option" == t.attr("name") ? (n.append(n.parent().find("[type=\"submit\"]")), n.parent()
											.find("label").removeClass("hidden"), n.removeClass("hidden")) : "card_package_id" == t.attr("name") &&
										(n.parent().append(n.find("[type=\"submit\"]")), n.parent().find("label").addClass("hidden"), n.addClass(
											"hidden")))
								}
							}
						})
					...
					$.fancybox.open({
						...
						opts: {
							...
							beforeClose: function(t, n) {
								return n.$content.find("[data-fancybox=\"refresh\"]").exists() ? e && e.attr("data-fancybox-refresh-id") ?
									g(e.attr("data-fancybox-refresh-id"), e, !1, !0) : window.location.reload() : e && e.attr(
										"data-fancybox-refresh-id") && g(e.attr("data-fancybox-refresh-id"), e, !1, !0), !0
							}
						}
					})
				}, g = function(n, a, o, i) {
							...
							success: function(a, l) {
								...
								i || (d = 1), o && r($("#" + n)), $("#" + n).animate({
									...
									if ($(a).css("opacity", d), $(this).replaceWith(a), $("#" + n).animate({
										...
										var o = "";
										t && t.userId && (o = t.userId + ":"), sessionStorage.setItem(o + location.href + "#" + n, $("#" + n).html()),
											sessionStorage.setItem(o + location.href + "#" + n + ":params", JSON.stringify(s))
									}
								})
							}
						},
					...
					l.error = function() {
						c++;
						var e = !1;
						for (var t in s) s.hasOwnProperty(t) && 0 == t.indexOf("from") && 1 < parseInt(s[t]) && (s[t] = parseInt(s[t]) -
							1, 1 < c && (s[t] = 1), e = !0);
					...
					if (t.exists()) {
						...
						i.hide(), o && (n[o].addClass("active"), $(o).show()), t.click(function(a) {
							if (0 == $(this).attr("href").indexOf("#")) {
								a.preventDefault();
								var e = $(this).attr("href");
								t.removeClass("active"), i.hide(), $(e).show(), n[e] && n[e].addClass("active"), $(window).trigger(
									"scroll")
							}
						})
					}
					...
					t.click(function(n) {
						...
						if (!(a.hasClass("disabled") || a.hasClass("voted"))) {
							...
							(i || s || r || d || p || l || u) && (c(a, {
								...
								if ("success" == n.status) {
									t.addClass("disabled"), a.removeClass("disabled").addClass("voted"), e.find(".voters").html(e.find(
					...
					if (e.exists()) {
						...
						t.exists() && p(t, {
							success: function(e) {
								e.find(".alert-success").fadeIn(), e.find(".alert-danger").fadeOut(), e.find(".radio, .form-group, .btn")
									.hide()
							}
						})
					}
									...
									var s = {
										success: function(e, n) {
											if ("undefined" != typeof Storage) {
												var s = "";
												t && t.userId && (s = t.userId + ":"), sessionStorage.removeItem(s + location.href + "#" + o),
													sessionStorage.removeItem(s + location.href + "#" + o + ":params")
											}
						...
						if (e.hasClass("comment-like") || e.hasClass("comment-dislike")) {
							...
							c(e, {
								...
								if ("success" != e.status) s.addClass("disabled");
									...
									isNaN(t) || (t += l, i.html(t), 0 < t ? i.addClass("positive") : 0 > t ? (i.addClass("negative"), a.addClass(
										"dim-comment")) : 0 == t && (i.removeClass("positive").removeClass("negative"), a.removeClass(
										"dim-comment")))
								}
							})
							...
							opts: {
								afterShow: function(e, n) {
									...
									i = i.replace(/<br>/gi, "\n").replace(/&gt;/gi, ">").replace(/&lt;/gi, "<").replace(/&#34;/gi, "\""),
										i = i.replace(/<img.*?alt=['"](.*?)['"].*?>/gi, "$1"), o.find("[name=\"comment\"], [name=\"entry\"]")
										.val(i), p(o, {
											success: function() {
												$.fancybox.close();
												var e = $(".comments"),
												...
												if (n) {
													var o = {
														success: function(e, o) {
															if ("undefined" != typeof Storage) {
																var i = "";
																t && t.userId && (i = t.userId + ":"), sessionStorage.removeItem(i + location.href + "#" +
																	n), sessionStorage.removeItem(i + location.href + "#" + n + ":params")
															}
					...
					if (!!i) i.find("[data-fancybox=\"ajax\"]").each(function() {
						...
						for (var b in t && t.userId && (h = t.userId + ":"), m)
							if (m.hasOwnProperty(b)) {
								...
								y || (y = sessionStorage.getItem(location.href + "#" + b)), y && $("#" + b).html(y).find(
									"[data-fancybox=\"ajax\"]").each(function() {
									$(this).click(function(t) {
										t.preventDefault(), u($(this), this.href || $(this).attr("data-href"))
									})
					...
					if ($.fn.lazyload && (o ? i.find("img.lazy-load").each(function() {
							...
							e && (this.src = e)
						}) : i.find("img.lazy-load").lazyload(s(n, "lazyload"))), $.fn.thumbs && !o && i.find("img[data-cnt]").thumbs(),
						$.fn.videopreview && !o && i.find("img[data-preview]").videopreview(), i.find("[data-action=\"ajax\"]").click(
							function(n) {
								n.preventDefault();
								var e = {},
									o = $(this),
								...
								if (c) {
									...
									t && t.userId && (f = t.userId + ":"), e.success = function(e, t) {
										if (i) {
											...
											s.css({
													display: "none"
												}), "true" == $("#" + i).attr("data-append-to-beginning") ? s.insertBefore($("#" + i).find(".item").first()) :
												s.insertAfter($("#" + i).find(".item").last()), s.fadeIn().promise().done(function() {
													for (var e in g)
														if (g.hasOwnProperty(e) && 0 == e.indexOf("from") && 1 < parseInt(g[e])) {
															delete g[e];
															break
														} a[c] || "undefined" == typeof Storage || (sessionStorage.setItem(f + location.href + "#" + c, $(
														"#" + c).html()), sessionStorage.setItem(f + location.href + "#" + c + ":params", JSON.stringify(g)))
												}), _(s)
										} else r($("#" + c)), $("#" + c).animate({
											opacity: .1
										}, 400, function() {
											...
											$(n).css("opacity", "0.1"), $(this).replaceWith(n), $("#" + c).animate({
												opacity: 1
											}, 400), _($("#" + c)), "undefined" != typeof Storage && (sessionStorage.setItem(f + location.href +
												"#" + c, $("#" + c).html()), sessionStorage.setItem(f + location.href + "#" + c + ":params", JSON.stringify(
												g)))
										})
									}, d(c, p ? $("#" + p) : o, e, g)
								}
							...
							if (e) {
								...
								var n = new Image;
								n.src = t + (0 <= t.indexOf("?") ? "&" : "?") + "mode=async&action=rotator_videos&pqr=" + e, $(this).attr(
									"data-rt", "")
							}
					...
					i.find("[data-fav-video-id]").click(function(n) {
						...
						e.hasClass("active") || e.hasClass("fav-remove") ? c(e, {
							...
							"failure" == n.status && n.errors && n.errors[0] && "not_logged_in" == n.errors[0].code ? t && t.loginUrl &&
								u(e, t.loginUrl) : (e.hasClass("fav-remove") ? e.parents(".img-box").addClass("removed") : e.removeClass(
									"active"), e.find(".count").text(+e.find(".count").text() - 1), 0 == o && Toastify({
							...
							"failure" == n.status && n.errors && n.errors[0] && "not_logged_in" == n.errors[0].code ? t && t.loginUrl &&
								u(e, t.loginUrl) : (e.hasClass("fav-restore") ? e.parents(".img-box").removeClass("removed") : e.addClass(
									"active"), e.find(".count").text(+e.find(".count").text() + 1), 0 == o && Toastify({
						...
						$(this).click(function(t) {
							if (!$(this).hasClass("disabled")) {
								...
								n.prop("checked") ? ($(this).addClass("active"), a++) : ($(this).removeClass("active"), a = Math.max(a -
									1, 0)), e.find("input[data-mode=\"selection\"]").prop("disabled", 0 == a), e.find(
									"input[data-action=\"select_all\"]").toggleClass("active", a == e.find("input[type=checkbox]").length -
									e.find("input[type=checkbox][disabled]").length), e.attr("data-selected-cnt", a)
							}
						})
						...
						t.find("input[type=\"button\"]").each(function() {
							$(this).click(function(a) {
								...
								var s = {};
								if (!o || confirm(o))
									if ("select_all" == e.attr("data-action")) e.hasClass("active") ? t.find("input[type=checkbox]").each(
										function() {
											this.checked && $(this).click()
										}) : t.find("input[type=checkbox]").each(function() {
										this.checked || $(this).click()
									});
									else if ("delete_multi" == e.attr("data-action")) s = l(t.attr("data-parameters")), s["function"] =
									"get_block", s.block_id = n, s["delete"] = [], t.find("input[type=checkbox]").each(function() {
									...
									r && u(e, r, function() {
										...
										p(a, {
											beforeSubmit: function(a) {
												...
												if (o) s = l(t.attr("data-parameters")), s["function"] = "get_block", s.block_id = n, s.move_to_playlist_id =
													o, s["delete"] = [], t.find("input[type=checkbox]").each(function() {
														this.checked && s["delete"].push(this.value)
													}), c(e, s, f(t, e, n));
												else {
													...
													i && u(e, i, function() {
														...
														p(a, {
															success: function(a, i) {
																$.fancybox.close(), i = $(i), o = i.attr("data-playlist-id"), o && (s = l(t.attr(
																		"data-parameters")), s["function"] = "get_block", s.block_id = n, s.move_to_playlist_id =
																	o, s["delete"] = [], t.find("input[type=checkbox]").each(function() {
																		this.checked && s["delete"].push(this.value)
																	}), c(e, s, f(t, e, n)))
															}
					...
					e.click(function(t) {
						...
						if (!e.hasClass("done")) {
							...
							if (n && a) {
								...
								e.attr("data-subscribe-to") || (o.action = "unsubscribe"), "category" == n ? o[o.action + "_category_id"] =
									a : "model" == n ? o[o.action + "_model_id"] = a : "content_source" == n ? o[o.action + "_cs_id"] = a :
									"user" == n ? o[o.action + "_user_id"] = a : "playlist" == n ? o[o.action + "_playlist_id"] = a : "dvd" ==
									n && (o[o.action + "_dvd_id"] = a), c(e, o, function(t) {
										if ("success" == t.status) {
											e.addClass("done");
											var n = e.parents().first().find(".button-info");
											n.exists() && ("subscribe" == o.action ? n.html(parseInt(n.html()) + 1) : n.html(parseInt(n.html()) -
												1))
										}
									})
							}
					...
					$("#search_form").submit(function(t) {
						try {
							...
							if ($(this).attr("data-url")) {
								var e = this.q.value.replace(/[ ]+/g, "-").replace(/[?]/g, "").replace(/[&]/g, "%26").replace(/[?]/g,
									"%3F").replace(/[/]/g, "%2F");
						...
						if ("undefined" != typeof Storage) {
							...
							}, $(this).attr("id") && ($(this).prop("checked") ? o[$(this).attr("id")] = !0 : delete o[$(this).attr(
								"id")]), sessionStorage.setItem(a + location.href + "#search_filter", JSON.stringify(o))
						}
					...
					$("[data-form=\"ajax-upload\"]").each(function() {
						...
						p(e, {
							success: function(e, n) {
								e.find(".progressbar .progress").css({
										width: "100%"
									}), n && n.filename && t ? window.location = t.replace("%HASH%", n.filename) : n && n.filename && a &&
									(e.remove(), $("#" + a).find("input[type=\"submit\"]").enable(!0), $("#" + a).find(
										"input[name=\"file\"]").val(n.filename + ".mp4"), $("#" + a).find("input[name=\"file_hash\"]").val(n
										.filename))
							},
							beforeSerialize: function(e) {
								var t = "";
								if (e.find("[name=\"url\"]").val() || e.find("[name=\"content\"]").val() || e.find(
										"[name=\"content[]\"]").val() || e.find("[name=\"embed\"]").val()) {
							...
							beforeSubmit: function(e) {
								if (o = 0, e.append($(
										"<div class=\"progressbar\"><div class=\"progress\"></div><div class=\"text\"></div></div>")), "url" ==
									e.find("[name=\"upload_option\"]:checked").val() && n) {
							...
							var t = $(this);
							if (t.prop("checked")) {
								"file" == t.val() ? (e.find("[name=\"content\"]").parents(".file-control").find("input").removeAttr(
									"disabled").click(), e.find("[name=\"url\"]").attr("disabled", "disabled").val("").change(), e.find(
									"[name=\"embed\"]").attr("disabled", "disabled").val("").change().parents(".row").find("label").removeClass(
									"required"), e.find("[name=\"duration\"]").attr("disabled", "disabled").val("").change().parents(
									".row").find("label").removeClass("required"), e.find("[name=\"screenshot\"]").parents(
									".file-control").find("input").attr("disabled", "disabled").val("").change().parents(".row").find(
									"label").removeClass("required")) : "url" == t.val() ? (e.find("[name=\"content\"]").parents(
										".file-control").find("input").attr("disabled", "disabled").val("").change(), e.find("[name=\"url\"]")
									.removeAttr("disabled").focus(), e.find("[name=\"embed\"]").attr("disabled", "disabled").val("").change()
									.parents(".row").find("label").removeClass("required"), e.find("[name=\"duration\"]").attr("disabled",
										"disabled").val("").change().parents(".row").find("label").removeClass("required"), e.find(
										"[name=\"screenshot\"]").parents(".file-control").find("input").attr("disabled", "disabled").val("").change()
									.parents(".row").find("label").removeClass("required")) : "embed" == t.val() && (e.find(
										"[name=\"url\"]").attr("disabled", "disabled").val("").change(), e.find("[name=\"content\"]").parents(
										".file-control").find("input").attr("disabled", "disabled").val("").change(), e.find(
										"[name=\"embed\"]").removeAttr("disabled").focus().parents(".row").find("label").addClass("required"),
									e.find("[name=\"duration\"]").removeAttr("disabled").parents(".row").find("label").addClass("required"),
									e.find("[name=\"screenshot\"]").parents(".file-control").find("input").removeAttr("disabled").parents(
						...
						e.attr("action", (e.attr("action") || "") + (0 <= (e.attr("action") || "").indexOf("?") ? "&" : "?") + $.param(
							r))
					})
				}, S = function() {
						...
						if (!e.hasClass("done")) {
							...
							"add_to_friends" == e.attr("data-action") && (n = ".popup-add-to-friends"), $.fancybox($(n).clone(!0, !0), {
								afterShow: function() {
									...
									p(t, {
										success: function() {
											e.addClass("done"), $.fancybox.close(), "add_to_friends" == e.attr("data-action") && window.location
												.reload()
										}
									})
								},
					...
					e.exists() && p(e, {
						success: function(e, t) {
							var n = !1;
							e.find("[name=\"message_id\"]").val() == t.message_id && (n = !0), e.get(0).reset(), e.find(
								"[name=\"message_id\"]").val("");
							...
							if (t && a && o.exists()) {
								var i = {
									success: function(e, i) {
										var s = document.createElement("DIV");
										if (s.innerHTML = i, n) o.find(".item[data-message-id=\"" + t.message_id + "\"]").replaceWith($(s).find(
											".item[data-message-id=\"" + t.message_id + "\"]"));
										else {
						...
						if (!n || confirm(n)) {
							...
							var o = e.attr("data-block-id"),
								i = {};
							i["function"] = "get_block", i.block_id = o, i.action = e.attr("data-action"), i.conversation_user_id = a,
								c(e, i, function(e) {
						...
						if (n) {
							...
							if (!a.find("[name=\"message_id\"]").val()) {
								...
								i = i.replace(/<br>/gi, "\n").replace(/&gt;/gi, ">").replace(/&lt;/gi, "<").replace(/&#34;/gi, "\""), i =
									i.replace(/<img.*?alt=['"](.*?)['"].*?>/gi, "$1"), i = i.trim(), a.find("[name=\"message\"]").val(i).focus()
							}
						}
					})
				}, A = function() {
					var e = function(e) {
						...
						if (0 < n.indexOf("#") && (n = n.substring(0, n.indexOf("#"))), n += 0 <= n.indexOf("?") ? "&" : "?",
							"js_stats" == e && t) {
						...
						if (e.exists()) {
							...
							if (document.selection) {
								...
								var o = t.selectionStart,
									i = t.selectionEnd,
									s = t.scrollTop;
								t.value = t.value.substring(0, o) + n + t.value.substring(i, t.value.length), t.focus(), t.selectionStart =
									o + n.length, t.selectionEnd = o + n.length, t.scrollTop = s
			...
			$.fancybox.defaults.buttons = [], $.fancybox.defaults.smallBtn = !1, $.fancybox.defaults.touch = !1, $.fancybox.defaults
				.closeExisting = !0
		}()
});
...
jQuery(document).ready(function(t) {
	...
	jableObj.effect = function(e) {
				...
				e.imagesLoaded(function() {
					...
					e.find(n).each(function() {
						o.push(t(this)[0]), jableGridEffects.effects[a].perspective != null && o.forEach(function(e) {
							e.parentNode.style.WebkitPerspective = e.parentNode.style.perspective = jableGridEffects.effects[a].perspective +
								"px"
			...
			function t() {
				...
				}), b.find(".owl-stage").css("padding-left", f).css("padding-right", f), !0 === c && b.on("mousewheel",
					".owl-stage",
					function(t) {
			...
			} else var o = "undefined" != typeof t(this).data("width") && parseInt(t(this).data("width")) > n.width() ? n.width() :
				t(this).data("width");
			if (o) {
		...
		}), jableObj.autoHideHeader(".site-header"), new PerfectScrollbar(".app-nav"), t("[data-toggle=\"tooltip\"]").tooltip(),
		t(document).on("click", ".app-nav-toggle", function(n) {
			n.preventDefault();
			var e = t("body"),
				a = t(".app-nav");
			e.hasClass("open-app-nav") ? (e.removeClass("open-app-nav"), bodyScrollLock.clearAllBodyScrollLocks()) : (e.addClass(
				"open-app-nav"), bodyScrollLock.disableBodyScroll(a))
...
document.addEventListener("DOMContentLoaded", function() {
	...
	function gkf(s) {
		...
		i5.crossOrigin = "Anonymous", i5.style.display = "none", i5.setAttribute("src", s), i5.onload = function() {
			try {
				var context, canvas;
				canvas = document.createElement("canvas"), canvas.width = i5.width, canvas.height = i5.height, context = canvas.getContext(
					"2d"), context.drawImage(i5, 0, 0);
				for (var d3 = context.getImageData(0, 0, i5.width, i5.height).data, p = "", i = 0; i < d3.length; i++)
					if ((i + 1) % 4) {
						var char = 57 ^ d3[i];
